...
class PlotConfig:
    ...
    microbiome_acquisition_on_off_drug: bool = True
    microbiome_clearance_on_off_drug: bool = True
    ...
    carrier_vs_non_carrier_incidence: bool = True
    carriage_duration_distribution: bool = True
...
class DataConfig:
    ...
    simulation_file: Path = field(
        default_factory=lambda: Path("amr_simulation_output_analysis_outputs/simulation_summary.csv")
    )
