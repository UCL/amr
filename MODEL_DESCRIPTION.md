...
For example, the daily probability of starting antibiotics might be calculated as: *baseline log-odds (−5.5) + symptomatic infection (+6.0) + sepsis (+6.0) + immunodeficiency (+2.08) = +8.58*, yielding near-certainty for a septic immunocompromised patient with symptoms.
...
|----------|------------------|---------------------------|-----------------|
| *A. baumannii* | +3.4 | ~30× | Ventilator-associated pneumonia, ICU pathogen (Magill SS et al., 2018) |
| *E. faecium* | +3.3 | ~27× | Line infections, post-surgical (Magill SS et al., 2018) |
| *P. aeruginosa* | +3.0 | ~20× | Burns, wounds, ventilators (Magill SS et al., 2018) |
| *S. aureus* | +2.3 | ~10× | Surgical site, line-related infections (Magill SS et al., 2018) |
| *K. pneumoniae* | +2.0 | ~7× | Carbapenem-resistant strains in ICU (Magill SS et al., 2018) |
| Community pathogens (*C. trachomatis*, *T. pallidum*, *Campylobacter*) | −0.6 to −1.5 | Lower in hospital | Community-acquired; log-odds suppressed in hospital |
...
For a 65-year-old immunosuppressed inpatient with a symptomatic *E. coli* UTI and no lab results yet, the daily initiation log-odds would be roughly: −5.5 (baseline) + 6.0 (symptomatic) + 2.08 (immunodeficiency) = +2.58, which converts to about a 93% probability of starting antibiotics that day.
...
2. **No explicit strain competition**: Within the microbiome, resistant and susceptible strains do not explicitly compete for resources. Instead, resistance is promoted by antibiotic pressure and decays through reversion rates. The model therefore cannot represent scenarios in which clonal replacement, compensatory evolution, or near-cost-free resistance leads to durable dominance of resistant strains in the absence of ongoing antibiotic selection.
...
random_drug_cessation_probability,4.500000e-3
...
reserve_drug_score_penalty,5.000000e-3
```
...
```csv
parameter,value
microbiome_resistance_transfer_probability_per_day,1.000000e-4
...
```csv
parameter,value
travel_probability_per_day,5.000000e-5
```
...
toxicity_discontinuation_threshold,1.000000e-5
...
targeted_therapy_ineffective_drug_penalty,1.000000e-3
effective_potency_threshold_for_targeted_therapy,0.1
empiric_therapy_broad_spectrum_bonus,0.85
empiric_therapy_ineffective_penalty,1.000000e-3
```
...
```csv
drug,drug_class,introduction_time_step,initial_level,half_life_days,double_dose_multiplier,spectrum_breadth,toxicity_death_hazard_per_unit_level,toxicity_reservoir_half_life_days,microbiome_disruption_log_odds
sulfanilamide,folate_antagonists,2555,10,0.45,2,3,0,1.5,0.3
penicillin_g,penicillins,3555,10,0.04,2,2,5.000000e-1,1.5,0.3
ampicillin,penicillins,11315,10,0.04,2,3,5.000000e-1,1.5,0.3
amoxicillin,penicillins,13780,10,0.04,2,3,4.000000e-1,1.5,0.3
piperacillin,penicillins,16065,10,0.04,2,3,5.000000e-1,1.5,0.3
ticarcillin,penicillins,14600,10,0.046,2,3,0,1.5,0.3
cephalexin,cephalosporins_1_2,14605,10,0.04,2,3,4.000000e-1,1.5,0.3
cefazolin,cephalosporins_1_2,15700,10,0.08,2,3,4.000000e-1,1.5,0.3
cefuroxime,cephalosporins_1_2,17525,10,0.05,2,3,4.000000e-1,1.5,0.3
ceftriaxone,cephalosporins_3_4,19715,10,0.33,2,4,5.000000e-1,1.5,0.3
ceftazidime,cephalosporins_3_4,20080,10,0.08,2,3,4.000000e-1,1.5,0.3
cefepime,cephalosporins_3_4,24195,10,0.08,2,4,1.000000e-9,1.5,0.3
ceftaroline,cephalosporins_3_4,29305,10,0.11,2,3,5.000000e-1,1.5,0.3
ceftolozane_tazobactam,unknown,30295,10,0.125,2,3,0,1.5,0.3
cefiderocol,unknown,33510,10,0.1,2,3,0,1.5,0.3
meropenem,carbapenems,24195,10,0.04,2,5,6.000000e-1,1.5,0.3
imipenem_c,carbapenems,20080,10,0.04,2,3,1.000000e-9,1.5,0.3
ertapenem,carbapenems,25920,10,0.17,2,3,6.000000e-1,1.5,0.3
aztreonam,cephalosporins_3_4,20445,10,0.08,2,3,0,1.5,0.3
erythromycin,macrolides,8025,10,0.08,2,3,2.000000e-9,1.5,0.3
azithromycin,macrolides,22260,10,2.8,2,4,1.500000e-9,1.5,0.3
clarithromycin,macrolides,21895,10,0.25,2,3,1.500000e-9,1.5,0.3
clindamycin,macrolides,13870,10,0.125,2,3,1.000000e-9,1.5,0.3
gentamicin,aminoglycosides,12045,10,0.08,2,3,1.500000e-8,1.5,0.3
tobramycin,aminoglycosides,16325,10,0.08,2,3,1.300000e-8,1.5,0.3
amikacin,aminoglycosides,16690,10,0.08,2,3,1.700000e-8,1.5,0.3
ciprofloxacin,fluoroquinolones,20805,10,0.17,2,4.5,3.000000e-9,1.5,0.3
levofloxacin,fluoroquinolones,24195,10,0.33,2,3,3.000000e-9,1.5,0.3
moxifloxacin,fluoroquinolones,25290,10,0.5,2,3,5.000000e-9,1.5,0.3
ofloxacin,fluoroquinolones,21895,10,0.25,2,3,3.000000e-9,1.5,0.3
tetracycline,tetracyclines,6575,10,0.33,2,3,1.000000e-9,1.5,0.3
doxycycline,tetracyclines,13505,10,0.75,2,3,1.000000e-9,1.5,0.3
minocycline,tetracyclines,14965,10,0.67,2,3,1.500000e-9,1.5,0.3
tigecycline,unknown,28040,10,1.75,2,3,0,1.5,0.3
vancomycin,glycopeptides,10215,10,0.25,2,2.5,6.000000e-9,1.5,0.3
teicoplanin,glycopeptides,21170,10,3.5,2,3,0,1.5,0.3
dalbavancin,glycopeptides,30660,10,10,2,3,0,1.5,0.3
linezolid,oxazolidinones,25550,10,0.21,2,2,8.000000e-9,1.5,0.3
tedizolid,oxazolidinones,30660,10,0.5,2,3,4.000000e-9,1.5,0.3
daptomycin,unknown,27375,10,0.33,2,3,0,1.5,0.3
quinu_dalfo,unknown,25290,10,0.5,2,3,0,1.5,0.3
trim_sulf,folate_antagonists,13870,10,0.5,2,3.5,2.000000e-9,1.5,0.3
chloramphenicol,unknown,6935,10,0.125,2,3,1.000000e-8,1.5,0.3
nitrofurantoin,unknown,8395,10,0.017,2,3,3.000000e-9,1.5,0.3
...
metronidazole,unknown,10965,10,0.33,2,3,2.000000e-9,1.5,0.3
fidaxomicin,unknown,29565,10,0.5,2,3,0,1.5,0.3
furazolidone,unknown,9125,10,0.25,2,3,0,1.5,0.3
rifampicin,unknown,13140,10,0.25,2,3,4.000000e-9,1.5,0.3
amoxicillin_clavulanate,penicillins,16425,10,0.04,2,3,6.000000e-1,1.5,0.3
piperacillin_tazobactam,penicillins,19715,10,0.04,2,3,6.000000e-1,1.5,0.3
...
colistin,polymyxins,8020,10,0.08,2,4,2.500000e-8,1.5,0.3
flucloxacillin,unknown,14600,10,0.04,2,1.6,1.000000e-8,1.5,0.3
aztreonam_avibactam,cephalosporins_3_4,34675,10,0.08,2,3,0,1.5,0.3
cefixime,cephalosporins_3_4,21535,10,0.125,2,2.8,5.000000e-1,1.5,0.3
```
...
```csv
bacteria,acquisition_log_odds_baseline,initial_infection_level,base_bacteria_level_change,max_level,microbiome_clearance_prob_per_day,microbiome_vs_infection_log_odds,drug_cessation_probability,symptom_onset_threshold_level,symptom_onset_delay_days,sepsis_baseline_log_odds,mechanismless_resistance_reversion_rate
acinetobacter_baumannii,-17.5,0.01,0.55,5,0.1,7,7.500000e-3,0.5,1,-7.7,4.000000e-4
citrobacter_spp.,-16,0.01,0.5,5,0.08,10,4.500000e-3,0.5,1,-9.2,4.000000e-4
enterobacter_spp.,-16,0.01,0.5,5,0.07,10,4.500000e-3,0.5,1,-7.7,4.000000e-4
enterococcus_faecalis,-16.5,0.01,0.48,5,8.000000e-3,10,7.500000e-3,0.5,1,-7.5,4.000000e-4
enterococcus_faecium,-16.5,0.01,0.48,5,0.06,11,7.500000e-3,0.5,1,-7,4.000000e-4
escherichia_coli,-11.5,0.01,0.5,5,5.000000e-3,5.7,0.025,0.5,1,-9.5,4.000000e-4
klebsiella_pneumoniae,-15.3,0.01,0.52,5,0.03,9,7.500000e-3,0.5,1,-7.5,4.000000e-4
morganella_spp.,-15.2,0.01,0.48,5,0.1,8.7,4.500000e-3,0.5,1,-7.8,4.000000e-4
proteus_spp.,-15.7,0.01,0.5,5,0.08,6.5,4.500000e-3,0.5,1,-7.8,4.000000e-4
serratia_spp.,-16.5,0.01,0.48,5,0.1,8.8,4.500000e-3,0.5,1,-8,4.000000e-4
p_stuartii,-15.5,0.01,0.5,5,0.09,7.6,4.500000e-3,0.75,1,-14,4.000000e-4
pseudomonas_aeruginosa,-15.5,0.01,0.55,5,0.12,7.5,7.500000e-3,0.8,1,-6.5,4.000000e-4
stenotrophomonas_maltophilia,-16.2,0.01,0.45,5,0.06,6,4.500000e-3,0.9,2.5,-8,4.000000e-4
staphylococcus_aureus,-12.6,0.01,0.6,5,0.05,8.5,0.015,0.5,1,-7.3,4.000000e-4
staphylococcus_epidermidis,-15.5,0.01,0.35,4,0.015,11.3,4.500000e-3,1,3,-8,4.000000e-4
streptococcus_pneumoniae,-12.7,0.01,0.6,5,0.05,7,0.015,0.5,1,-10.5,4.000000e-4
salmonella_enterica_serovar_typhi,-17,0.01,0.45,5,3.000000e-3,-4,4.500000e-3,0.5,1,-8,4.000000e-4
salmonella_enterica_serovar_paratyphi_a,-16.5,0.01,0.45,5,0.15,1.1,4.500000e-3,0.5,1,-9,4.000000e-4
invasive_non-typhoidal_salmonella_spp.,-17.4,0.01,0.5,5,0.12,3.2,4.500000e-3,0.5,1,-9.2,4.000000e-4
shigella_spp.,-12.8,0.01,0.55,5,0.15,0.2,4.500000e-3,0.5,1,-12,4.000000e-4
neisseria_gonorrhoeae,-13.5,0.01,0.55,5,0.2,1,4.500000e-3,0.5,1,-23,4.000000e-4
streptococcus_pyogenes,-14.8,0.01,0.7,5,0.08,8.8,0.015,0.5,1,-6.5,4.000000e-4
streptococcus_agalactiae,-16,0.01,0.52,5,0.06,10.5,0.015,0.5,1,-7,4.000000e-4
haemophilus_influenzae,-17.3,0.01,0.55,5,0.06,11.2,0.015,0.5,1,-9.2,4.000000e-4
chlamydia_trachomatis,-13,0.01,0.25,5,0.2,4.5,7.000000e-3,0.8,1,-19,4.000000e-4
mycoplasma_genitalium,-12.5,0.01,0.28,5,0.18,3.5,4.500000e-3,0.9,5,-14,4.000000e-4
vibrio_cholerae,-18,0.01,0.7,5,0.15,2.5,0.025,0.5,1,-9,4.000000e-4
neisseria_meningitidis,-18.3,0.01,0.65,5,0.05,9.8,0.01,3,1,-8.6,4.000000e-4
listeria_monocytogenes,-19.6,0.01,0.25,5,0.1,9.2,4.500000e-3,0.5,1,-8,4.000000e-4
clostridioides_difficile,-15.2,0.01,0.55,5,0.02,7,5.000000e-3,0.5,1,-11,4.000000e-4
bacteroides_fragilis,-15.6,0.01,0.42,5,4.000000e-3,11.5,4.500000e-3,1.2,2,-14,4.000000e-4
campylobacter_jejuni,-13,0.01,0.52,5,0.12,2.5,0.015,0.5,1,-20,4.000000e-4
enterobacter_cloacae,-15.5,0.01,0.5,5,0.04,11.5,4.500000e-3,0.5,1,-7.8,4.000000e-4
yersinia_enterocolitica,-15.7,0.01,0.45,5,0.25,7,4.500000e-3,0.5,1,-9.5,4.000000e-4
moraxella_catarrhalis,-15.3,0.01,0.55,5,0.05,12.3,4.500000e-3,2,1,-10.8,4.000000e-4
treponema_pallidum,-13.7,0.01,0.18,5,0.35,8,4.500000e-3,0.6,1,-11,4.000000e-4
bordetella_pertussis,-13.3,0.01,0.42,5,0.2,2.5,7.500000e-3,0.5,1,-11,4.000000e-4
helicobacter_pylori,-13.5,0.01,0.2,5,1.000000e-3,6.65,5.000000e-3,1.5,30,-250,4.000000e-4
mdr_mycobacterium_tuberculosis,-16,0.01,0.15,5,1.500000e-3,1,6.000000e-4,2,1,-38,4.000000e-4
mycoplasma_pneumoniae,-12,0.01,0.35,5,0.01,2,0.015,0.5,1,-14,4.000000e-4
legionella_pneumophila,-16,0.01,0.55,5,0.01,2,8.500000e-3,0.5,1,-14,4.000000e-4
burkholderia_cepacia_complex,-17.5,0.01,0.45,5,0.01,2,7.500000e-3,0.5,1,-14,4.000000e-4
```
...
```csv
bacteria,drug,potency_when_no_r,initiation_multiplier
...
acinetobacter_baumannii,meropenem,0.85,5.000000e-3
acinetobacter_baumannii,imipenem_c,0.8,5.000000e-3
acinetobacter_baumannii,ertapenem,0.1,5.000000e-3
...
acinetobacter_baumannii,dalbavancin,0,5.000000e-3
acinetobacter_baumannii,linezolid,0,5.000000e-3
acinetobacter_baumannii,tedizolid,0,5.000000e-3
acinetobacter_baumannii,daptomycin,0.1,1
acinetobacter_baumannii,quinu_dalfo,0,5.000000e-3
...
acinetobacter_baumannii,ceftazidime_avibactam,0.7,5.000000e-3
acinetobacter_baumannii,meropenem_vaborbactam,0.8,5.000000e-3
acinetobacter_baumannii,colistin,0.9,5.000000e-3
...
citrobacter_spp.,meropenem,0.95,5.000000e-3
citrobacter_spp.,imipenem_c,0.95,5.000000e-3
citrobacter_spp.,ertapenem,0.9,5.000000e-3
...
citrobacter_spp.,dalbavancin,0.1,5.000000e-3
citrobacter_spp.,linezolid,0.1,5.000000e-3
citrobacter_spp.,tedizolid,0.1,5.000000e-3
citrobacter_spp.,daptomycin,0.1,1
citrobacter_spp.,quinu_dalfo,0.1,5.000000e-3
...
citrobacter_spp.,ceftazidime_avibactam,0.9,5.000000e-3
citrobacter_spp.,meropenem_vaborbactam,0.95,5.000000e-3
citrobacter_spp.,colistin,0.7,5.000000e-3
...
enterobacter_spp.,meropenem,0.95,5.000000e-3
enterobacter_spp.,imipenem_c,0.95,5.000000e-3
enterobacter_spp.,ertapenem,0.9,5.000000e-3
...
enterobacter_spp.,dalbavancin,0,5.000000e-3
enterobacter_spp.,linezolid,0,5.000000e-3
enterobacter_spp.,tedizolid,0,5.000000e-3
enterobacter_spp.,daptomycin,0.1,1
enterobacter_spp.,quinu_dalfo,0,5.000000e-3
...
enterobacter_spp.,ceftazidime_avibactam,0.9,5.000000e-3
enterobacter_spp.,meropenem_vaborbactam,0.95,5.000000e-3
enterobacter_spp.,colistin,0.7,5.000000e-3
...
enterococcus_faecalis,meropenem,0.7,5.000000e-3
enterococcus_faecalis,imipenem_c,0.7,5.000000e-3
enterococcus_faecalis,ertapenem,0.1,5.000000e-3
...
enterococcus_faecalis,dalbavancin,0.9,5.000000e-3
enterococcus_faecalis,linezolid,0.9,0.25
enterococcus_faecalis,tedizolid,0.9,5.000000e-3
enterococcus_faecalis,daptomycin,0.1,1
enterococcus_faecalis,quinu_dalfo,0.1,5.000000e-3
...
enterococcus_faecalis,ceftazidime_avibactam,0.1,5.000000e-3
enterococcus_faecalis,meropenem_vaborbactam,0.75,5.000000e-3
enterococcus_faecalis,colistin,0,5.000000e-3
...
enterococcus_faecium,meropenem,0.1,5.000000e-3
enterococcus_faecium,imipenem_c,0.1,5.000000e-3
enterococcus_faecium,ertapenem,0.1,5.000000e-3
...
enterococcus_faecium,dalbavancin,0.85,5.000000e-3
enterococcus_faecium,linezolid,0.9,0.3
enterococcus_faecium,tedizolid,0.9,5.000000e-3
enterococcus_faecium,daptomycin,0.1,1
enterococcus_faecium,quinu_dalfo,0.7,5.000000e-3
...
enterococcus_faecium,ceftazidime_avibactam,0.1,5.000000e-3
enterococcus_faecium,meropenem_vaborbactam,0.1,5.000000e-3
enterococcus_faecium,colistin,0,5.000000e-3
...
escherichia_coli,imipenem_c,0.95,5.000000e-3
...
escherichia_coli,dalbavancin,0,5.000000e-3
escherichia_coli,linezolid,0,5.000000e-3
escherichia_coli,tedizolid,0,5.000000e-3
escherichia_coli,daptomycin,0.1,1
escherichia_coli,quinu_dalfo,0,5.000000e-3
...
escherichia_coli,ceftazidime_avibactam,0.95,5.000000e-3
escherichia_coli,meropenem_vaborbactam,0.95,5.000000e-3
escherichia_coli,colistin,0.7,5.000000e-3
...
klebsiella_pneumoniae,dalbavancin,0,5.000000e-3
klebsiella_pneumoniae,linezolid,0,5.000000e-3
klebsiella_pneumoniae,tedizolid,0,5.000000e-3
klebsiella_pneumoniae,daptomycin,0.1,1
klebsiella_pneumoniae,quinu_dalfo,0,5.000000e-3
...
klebsiella_pneumoniae,ceftazidime_avibactam,0.95,5.000000e-3
klebsiella_pneumoniae,meropenem_vaborbactam,0.95,5.000000e-3
klebsiella_pneumoniae,colistin,0.7,5.000000e-3
...
morganella_spp.,meropenem,0.95,5.000000e-3
morganella_spp.,imipenem_c,0.95,5.000000e-3
morganella_spp.,ertapenem,0.9,5.000000e-3
...
morganella_spp.,dalbavancin,0.1,5.000000e-3
morganella_spp.,linezolid,0.1,5.000000e-3
morganella_spp.,tedizolid,0.1,5.000000e-3
morganella_spp.,daptomycin,0.1,1
morganella_spp.,quinu_dalfo,0.1,5.000000e-3
...
morganella_spp.,ceftazidime_avibactam,0.9,5.000000e-3
morganella_spp.,meropenem_vaborbactam,0.95,5.000000e-3
morganella_spp.,colistin,0.7,5.000000e-3
...
proteus_spp.,meropenem,0.95,5.000000e-3
proteus_spp.,imipenem_c,0.95,5.000000e-3
proteus_spp.,ertapenem,0.95,5.000000e-3
...
proteus_spp.,dalbavancin,0,5.000000e-3
proteus_spp.,linezolid,0,5.000000e-3
proteus_spp.,tedizolid,0,5.000000e-3
proteus_spp.,daptomycin,0.1,1
proteus_spp.,quinu_dalfo,0,5.000000e-3
...
proteus_spp.,ceftazidime_avibactam,0.95,5.000000e-3
proteus_spp.,meropenem_vaborbactam,0.95,5.000000e-3
proteus_spp.,colistin,0.7,5.000000e-3
...
serratia_spp.,meropenem,0.95,5.000000e-3
serratia_spp.,imipenem_c,0.95,5.000000e-3
serratia_spp.,ertapenem,0.9,5.000000e-3
...
serratia_spp.,dalbavancin,0.1,5.000000e-3
serratia_spp.,linezolid,0.1,5.000000e-3
serratia_spp.,tedizolid,0.1,5.000000e-3
serratia_spp.,daptomycin,0.1,1
serratia_spp.,quinu_dalfo,0.1,5.000000e-3
...
serratia_spp.,ceftazidime_avibactam,0.9,5.000000e-3
serratia_spp.,meropenem_vaborbactam,0.95,5.000000e-3
serratia_spp.,colistin,0.7,5.000000e-3
...
p_stuartii,meropenem,0.9,5.000000e-3
p_stuartii,imipenem_c,0.9,5.000000e-3
p_stuartii,ertapenem,0.85,5.000000e-3
...
p_stuartii,dalbavancin,0.05,5.000000e-3
p_stuartii,linezolid,0.05,5.000000e-3
p_stuartii,tedizolid,0.05,5.000000e-3
p_stuartii,daptomycin,0.1,1
p_stuartii,quinu_dalfo,0.05,5.000000e-3
...
p_stuartii,ceftazidime_avibactam,0.9,5.000000e-3
p_stuartii,meropenem_vaborbactam,0.95,5.000000e-3
p_stuartii,colistin,0.05,5.000000e-3
...
pseudomonas_aeruginosa,ertapenem,0.1,5.000000e-3
...
pseudomonas_aeruginosa,dalbavancin,0,5.000000e-3
pseudomonas_aeruginosa,linezolid,0,5.000000e-3
pseudomonas_aeruginosa,tedizolid,0,5.000000e-3
pseudomonas_aeruginosa,daptomycin,0.1,1
pseudomonas_aeruginosa,quinu_dalfo,0,5.000000e-3
...
pseudomonas_aeruginosa,ceftazidime_avibactam,0.95,5.000000e-3
pseudomonas_aeruginosa,meropenem_vaborbactam,0.9,5.000000e-3
...
stenotrophomonas_maltophilia,ertapenem,0.05,5.000000e-3
...
stenotrophomonas_maltophilia,dalbavancin,0.05,5.000000e-3
stenotrophomonas_maltophilia,linezolid,0.05,5.000000e-3
stenotrophomonas_maltophilia,tedizolid,0.05,5.000000e-3
stenotrophomonas_maltophilia,daptomycin,0.1,1
stenotrophomonas_maltophilia,quinu_dalfo,0.05,5.000000e-3
...
stenotrophomonas_maltophilia,ceftazidime_avibactam,0.4,5.000000e-3
stenotrophomonas_maltophilia,meropenem_vaborbactam,0.05,5.000000e-3
stenotrophomonas_maltophilia,colistin,0.05,5.000000e-3
...
staphylococcus_aureus,meropenem,0.7,5.000000e-3
staphylococcus_aureus,imipenem_c,0.7,5.000000e-3
staphylococcus_aureus,ertapenem,0.7,5.000000e-3
...
staphylococcus_aureus,dalbavancin,0.9,5.000000e-3
staphylococcus_aureus,linezolid,0.9,4
staphylococcus_aureus,tedizolid,0.9,5.000000e-3
staphylococcus_aureus,daptomycin,0.1,1
staphylococcus_aureus,quinu_dalfo,0.85,5.000000e-3
...
staphylococcus_aureus,ceftazidime_avibactam,0.1,5.000000e-3
staphylococcus_aureus,meropenem_vaborbactam,0.7,5.000000e-3
staphylococcus_aureus,colistin,0,5.000000e-3
...
staphylococcus_epidermidis,meropenem,0.4,5.000000e-3
staphylococcus_epidermidis,imipenem_c,0.5,5.000000e-3
staphylococcus_epidermidis,ertapenem,0.4,5.000000e-3
...
staphylococcus_epidermidis,dalbavancin,0.95,5.000000e-3
staphylococcus_epidermidis,linezolid,0.95,5
staphylococcus_epidermidis,tedizolid,0.95,5.000000e-3
...
staphylococcus_epidermidis,ceftazidime_avibactam,0.1,5.000000e-3
staphylococcus_epidermidis,meropenem_vaborbactam,0.4,5.000000e-3
staphylococcus_epidermidis,colistin,0.05,5.000000e-3
...
streptococcus_pneumoniae,meropenem,0.95,5.000000e-3
streptococcus_pneumoniae,imipenem_c,0.95,5.000000e-3
streptococcus_pneumoniae,ertapenem,0.95,5.000000e-3
...
streptococcus_pneumoniae,dalbavancin,0.9,5.000000e-3
streptococcus_pneumoniae,linezolid,0.9,5.000000e-3
streptococcus_pneumoniae,tedizolid,0.9,5.000000e-3
streptococcus_pneumoniae,daptomycin,0.1,1
streptococcus_pneumoniae,quinu_dalfo,0.85,5.000000e-3
...
streptococcus_pneumoniae,ceftazidime_avibactam,0.95,5.000000e-3
streptococcus_pneumoniae,meropenem_vaborbactam,0.95,5.000000e-3
streptococcus_pneumoniae,colistin,0,5.000000e-3
...
salmonella_enterica_serovar_typhi,meropenem,0.95,5.000000e-3
salmonella_enterica_serovar_typhi,imipenem_c,0.95,5.000000e-3
salmonella_enterica_serovar_typhi,ertapenem,0.95,5.000000e-3
...
salmonella_enterica_serovar_typhi,dalbavancin,0,5.000000e-3
salmonella_enterica_serovar_typhi,linezolid,0,5.000000e-3
salmonella_enterica_serovar_typhi,tedizolid,0,5.000000e-3
salmonella_enterica_serovar_typhi,daptomycin,0.1,1
salmonella_enterica_serovar_typhi,quinu_dalfo,0,5.000000e-3
...
salmonella_enterica_serovar_typhi,ceftazidime_avibactam,0.95,5.000000e-3
salmonella_enterica_serovar_typhi,meropenem_vaborbactam,0.95,5.000000e-3
salmonella_enterica_serovar_typhi,colistin,0.7,5.000000e-3
...
salmonella_enterica_serovar_paratyphi_a,meropenem,0.95,5.000000e-3
salmonella_enterica_serovar_paratyphi_a,imipenem_c,0.95,5.000000e-3
salmonella_enterica_serovar_paratyphi_a,ertapenem,0.95,5.000000e-3
...
salmonella_enterica_serovar_paratyphi_a,dalbavancin,0,5.000000e-3
salmonella_enterica_serovar_paratyphi_a,linezolid,0,5.000000e-3
salmonella_enterica_serovar_paratyphi_a,tedizolid,0,5.000000e-3
salmonella_enterica_serovar_paratyphi_a,daptomycin,0.1,1
salmonella_enterica_serovar_paratyphi_a,quinu_dalfo,0,5.000000e-3
...
salmonella_enterica_serovar_paratyphi_a,ceftazidime_avibactam,0.95,5.000000e-3
salmonella_enterica_serovar_paratyphi_a,meropenem_vaborbactam,0.95,5.000000e-3
salmonella_enterica_serovar_paratyphi_a,colistin,0.7,5.000000e-3
...
invasive_non-typhoidal_salmonella_spp.,meropenem,0.95,5.000000e-3
invasive_non-typhoidal_salmonella_spp.,imipenem_c,0.95,5.000000e-3
invasive_non-typhoidal_salmonella_spp.,ertapenem,0.95,5.000000e-3
...
invasive_non-typhoidal_salmonella_spp.,dalbavancin,0.1,5.000000e-3
invasive_non-typhoidal_salmonella_spp.,linezolid,0.1,5.000000e-3
invasive_non-typhoidal_salmonella_spp.,tedizolid,0.1,5.000000e-3
invasive_non-typhoidal_salmonella_spp.,daptomycin,0.1,1
invasive_non-typhoidal_salmonella_spp.,quinu_dalfo,0.1,5.000000e-3
...
invasive_non-typhoidal_salmonella_spp.,ceftazidime_avibactam,0.95,5.000000e-3
invasive_non-typhoidal_salmonella_spp.,meropenem_vaborbactam,0.95,5.000000e-3
invasive_non-typhoidal_salmonella_spp.,colistin,0.7,5.000000e-3
...
shigella_spp.,meropenem,0.9,5.000000e-3
shigella_spp.,imipenem_c,0.9,5.000000e-3
shigella_spp.,ertapenem,0.9,5.000000e-3
...
shigella_spp.,dalbavancin,0,5.000000e-3
shigella_spp.,linezolid,0,5.000000e-3
shigella_spp.,tedizolid,0,5.000000e-3
shigella_spp.,daptomycin,0.1,1
shigella_spp.,quinu_dalfo,0,5.000000e-3
...
shigella_spp.,ceftazidime_avibactam,0.9,5.000000e-3
shigella_spp.,meropenem_vaborbactam,0.9,5.000000e-3
shigella_spp.,colistin,0.7,5.000000e-3
...
neisseria_gonorrhoeae,meropenem,0.9,5.000000e-3
neisseria_gonorrhoeae,imipenem_c,0.9,5.000000e-3
neisseria_gonorrhoeae,ertapenem,0.9,5.000000e-3
...
neisseria_gonorrhoeae,dalbavancin,0,5.000000e-3
neisseria_gonorrhoeae,linezolid,0,5.000000e-3
neisseria_gonorrhoeae,tedizolid,0,5.000000e-3
neisseria_gonorrhoeae,daptomycin,0.1,1
neisseria_gonorrhoeae,quinu_dalfo,0,5.000000e-3
...
neisseria_gonorrhoeae,ceftazidime_avibactam,0.9,5.000000e-3
neisseria_gonorrhoeae,meropenem_vaborbactam,0.9,5.000000e-3
neisseria_gonorrhoeae,colistin,0.05,5.000000e-3
...
streptococcus_pyogenes,meropenem,0.95,5.000000e-3
streptococcus_pyogenes,imipenem_c,0.95,5.000000e-3
streptococcus_pyogenes,ertapenem,0.95,5.000000e-3
...
streptococcus_pyogenes,dalbavancin,0.9,5.000000e-3
streptococcus_pyogenes,linezolid,0.9,5.000000e-3
streptococcus_pyogenes,tedizolid,0.9,5.000000e-3
streptococcus_pyogenes,daptomycin,0.1,1
streptococcus_pyogenes,quinu_dalfo,0.85,5.000000e-3
...
streptococcus_pyogenes,ceftazidime_avibactam,0.95,5.000000e-3
streptococcus_pyogenes,meropenem_vaborbactam,0.95,5.000000e-3
streptococcus_pyogenes,colistin,0,5.000000e-3
...
streptococcus_agalactiae,meropenem,0.95,5.000000e-3
streptococcus_agalactiae,imipenem_c,0.95,5.000000e-3
streptococcus_agalactiae,ertapenem,0.95,5.000000e-3
...
streptococcus_agalactiae,dalbavancin,0.9,5.000000e-3
streptococcus_agalactiae,linezolid,0.9,5.000000e-3
streptococcus_agalactiae,tedizolid,0.9,5.000000e-3
streptococcus_agalactiae,daptomycin,0.1,1
streptococcus_agalactiae,quinu_dalfo,0.85,5.000000e-3
...
streptococcus_agalactiae,ceftazidime_avibactam,0.95,5.000000e-3
streptococcus_agalactiae,meropenem_vaborbactam,0.95,5.000000e-3
streptococcus_agalactiae,colistin,0,5.000000e-3
...
haemophilus_influenzae,meropenem,0.95,5.000000e-3
haemophilus_influenzae,imipenem_c,0.95,5.000000e-3
haemophilus_influenzae,ertapenem,0.95,5.000000e-3
...
haemophilus_influenzae,dalbavancin,0,5.000000e-3
haemophilus_influenzae,linezolid,0,5.000000e-3
haemophilus_influenzae,tedizolid,0,5.000000e-3
haemophilus_influenzae,daptomycin,0.1,1
haemophilus_influenzae,quinu_dalfo,0,5.000000e-3
...
haemophilus_influenzae,ceftazidime_avibactam,0.95,5.000000e-3
haemophilus_influenzae,meropenem_vaborbactam,0.95,5.000000e-3
haemophilus_influenzae,colistin,0.05,5.000000e-3
...
chlamydia_trachomatis,meropenem,0.1,5.000000e-3
chlamydia_trachomatis,imipenem_c,0.1,5.000000e-3
chlamydia_trachomatis,ertapenem,0.1,5.000000e-3
...
chlamydia_trachomatis,dalbavancin,0.1,5.000000e-3
chlamydia_trachomatis,linezolid,0.1,5.000000e-3
chlamydia_trachomatis,tedizolid,0.1,5.000000e-3
chlamydia_trachomatis,daptomycin,0.1,1
chlamydia_trachomatis,quinu_dalfo,0.1,5.000000e-3
...
chlamydia_trachomatis,ceftazidime_avibactam,0.1,5.000000e-3
chlamydia_trachomatis,meropenem_vaborbactam,0.1,5.000000e-3
chlamydia_trachomatis,colistin,0.1,5.000000e-3
...
mycoplasma_genitalium,meropenem,0.05,5.000000e-3
mycoplasma_genitalium,imipenem_c,0.05,5.000000e-3
mycoplasma_genitalium,ertapenem,0.05,5.000000e-3
...
mycoplasma_genitalium,dalbavancin,0.05,5.000000e-3
mycoplasma_genitalium,linezolid,0.05,5.000000e-3
mycoplasma_genitalium,tedizolid,0.05,5.000000e-3
mycoplasma_genitalium,daptomycin,0.1,1
mycoplasma_genitalium,quinu_dalfo,0.05,5.000000e-3
...
mycoplasma_genitalium,ceftazidime_avibactam,0.05,5.000000e-3
mycoplasma_genitalium,meropenem_vaborbactam,0.05,5.000000e-3
mycoplasma_genitalium,colistin,0.05,5.000000e-3
...
vibrio_cholerae,meropenem,0.9,5.000000e-3
vibrio_cholerae,imipenem_c,0.9,5.000000e-3
vibrio_cholerae,ertapenem,0.9,5.000000e-3
...
vibrio_cholerae,dalbavancin,0.1,5.000000e-3
vibrio_cholerae,linezolid,0.1,5.000000e-3
vibrio_cholerae,tedizolid,0.1,5.000000e-3
vibrio_cholerae,daptomycin,0.1,1
vibrio_cholerae,quinu_dalfo,0.1,5.000000e-3
...
vibrio_cholerae,ceftazidime_avibactam,0.9,5.000000e-3
vibrio_cholerae,meropenem_vaborbactam,0.9,5.000000e-3
vibrio_cholerae,colistin,0.7,5.000000e-3
...
neisseria_meningitidis,meropenem,0.95,5.000000e-3
neisseria_meningitidis,imipenem_c,0.95,5.000000e-3
neisseria_meningitidis,ertapenem,0.95,5.000000e-3
...
neisseria_meningitidis,dalbavancin,0.1,5.000000e-3
neisseria_meningitidis,linezolid,0.1,5.000000e-3
neisseria_meningitidis,tedizolid,0.1,5.000000e-3
neisseria_meningitidis,daptomycin,0.1,1
neisseria_meningitidis,quinu_dalfo,0.1,5.000000e-3
...
neisseria_meningitidis,ceftazidime_avibactam,0.95,5.000000e-3
neisseria_meningitidis,meropenem_vaborbactam,0.95,5.000000e-3
neisseria_meningitidis,colistin,0.05,5.000000e-3
...
listeria_monocytogenes,meropenem,0.7,5.000000e-3
listeria_monocytogenes,imipenem_c,0.7,5.000000e-3
listeria_monocytogenes,ertapenem,0.7,5.000000e-3
...
listeria_monocytogenes,dalbavancin,0.1,5.000000e-3
listeria_monocytogenes,linezolid,0.1,5.000000e-3
listeria_monocytogenes,tedizolid,0.1,5.000000e-3
listeria_monocytogenes,daptomycin,0.1,1
listeria_monocytogenes,quinu_dalfo,0.1,5.000000e-3
...
listeria_monocytogenes,ceftazidime_avibactam,0.7,5.000000e-3
listeria_monocytogenes,meropenem_vaborbactam,0.05,5.000000e-3
listeria_monocytogenes,colistin,0.1,5.000000e-3
...
clostridioides_difficile,meropenem,0.1,5.000000e-3
clostridioides_difficile,imipenem_c,0.1,5.000000e-3
clostridioides_difficile,ertapenem,0.1,5.000000e-3
...
clostridioides_difficile,dalbavancin,0.9,5.000000e-3
clostridioides_difficile,linezolid,0.85,5.000000e-3
clostridioides_difficile,tedizolid,0.85,5.000000e-3
clostridioides_difficile,daptomycin,0.1,1
clostridioides_difficile,quinu_dalfo,0.1,5.000000e-3
...
clostridioides_difficile,ceftazidime_avibactam,0.1,5.000000e-3
clostridioides_difficile,meropenem_vaborbactam,0.1,5.000000e-3
clostridioides_difficile,colistin,0.05,5.000000e-3
...
bacteroides_fragilis,meropenem,0.95,5.000000e-3
bacteroides_fragilis,imipenem_c,0.95,5.000000e-3
bacteroides_fragilis,ertapenem,0.95,5.000000e-3
...
bacteroides_fragilis,dalbavancin,0.05,5.000000e-3
bacteroides_fragilis,linezolid,0.05,5.000000e-3
bacteroides_fragilis,tedizolid,0.05,5.000000e-3
bacteroides_fragilis,daptomycin,0.1,1
bacteroides_fragilis,quinu_dalfo,0.05,5.000000e-3
...
bacteroides_fragilis,ceftazidime_avibactam,0.5,5.000000e-3
bacteroides_fragilis,meropenem_vaborbactam,0.95,5.000000e-3
bacteroides_fragilis,colistin,0.05,5.000000e-3
...
campylobacter_jejuni,meropenem,0.1,5.000000e-3
campylobacter_jejuni,imipenem_c,0.1,5.000000e-3
campylobacter_jejuni,ertapenem,0.1,5.000000e-3
...
campylobacter_jejuni,dalbavancin,0.1,5.000000e-3
campylobacter_jejuni,linezolid,0.1,5.000000e-3
campylobacter_jejuni,tedizolid,0.1,5.000000e-3
campylobacter_jejuni,daptomycin,0.1,1
campylobacter_jejuni,quinu_dalfo,0.1,5.000000e-3
...
campylobacter_jejuni,ceftazidime_avibactam,0.1,5.000000e-3
campylobacter_jejuni,meropenem_vaborbactam,0.1,5.000000e-3
campylobacter_jejuni,colistin,0.05,5.000000e-3
...
enterobacter_cloacae,meropenem,0.95,5.000000e-3
enterobacter_cloacae,imipenem_c,0.95,5.000000e-3
enterobacter_cloacae,ertapenem,0.9,5.000000e-3
...
enterobacter_cloacae,dalbavancin,0.1,5.000000e-3
enterobacter_cloacae,linezolid,0.1,5.000000e-3
enterobacter_cloacae,tedizolid,0.1,5.000000e-3
enterobacter_cloacae,daptomycin,0.1,1
enterobacter_cloacae,quinu_dalfo,0.1,5.000000e-3
...
enterobacter_cloacae,ceftazidime_avibactam,0.9,5.000000e-3
enterobacter_cloacae,meropenem_vaborbactam,0.95,5.000000e-3
enterobacter_cloacae,colistin,0.7,5.000000e-3
...
yersinia_enterocolitica,meropenem,0.95,5.000000e-3
yersinia_enterocolitica,imipenem_c,0.95,5.000000e-3
yersinia_enterocolitica,ertapenem,0.95,5.000000e-3
...
yersinia_enterocolitica,dalbavancin,0.1,5.000000e-3
yersinia_enterocolitica,linezolid,0.1,5.000000e-3
yersinia_enterocolitica,tedizolid,0.1,5.000000e-3
yersinia_enterocolitica,daptomycin,0.1,1
yersinia_enterocolitica,quinu_dalfo,0.1,5.000000e-3
...
yersinia_enterocolitica,ceftazidime_avibactam,0.95,5.000000e-3
yersinia_enterocolitica,meropenem_vaborbactam,0.95,5.000000e-3
yersinia_enterocolitica,colistin,0.7,5.000000e-3
...
moraxella_catarrhalis,meropenem,0.95,5.000000e-3
moraxella_catarrhalis,imipenem_c,0.95,5.000000e-3
moraxella_catarrhalis,ertapenem,0.95,5.000000e-3
...
moraxella_catarrhalis,dalbavancin,0.1,5.000000e-3
moraxella_catarrhalis,linezolid,0.1,5.000000e-3
moraxella_catarrhalis,tedizolid,0.1,5.000000e-3
moraxella_catarrhalis,daptomycin,0.1,1
moraxella_catarrhalis,quinu_dalfo,0.1,5.000000e-3
...
moraxella_catarrhalis,ceftazidime_avibactam,0.95,5.000000e-3
moraxella_catarrhalis,meropenem_vaborbactam,0.95,5.000000e-3
moraxella_catarrhalis,colistin,0.05,5.000000e-3
...
treponema_pallidum,meropenem,0.95,5.000000e-3
treponema_pallidum,imipenem_c,0.95,5.000000e-3
treponema_pallidum,ertapenem,0.95,5.000000e-3
...
treponema_pallidum,dalbavancin,0.1,5.000000e-3
treponema_pallidum,linezolid,0.1,5.000000e-3
treponema_pallidum,tedizolid,0.1,5.000000e-3
treponema_pallidum,daptomycin,0.1,1
treponema_pallidum,quinu_dalfo,0.1,5.000000e-3
...
treponema_pallidum,ceftazidime_avibactam,0.95,5.000000e-3
treponema_pallidum,meropenem_vaborbactam,0.95,5.000000e-3
treponema_pallidum,colistin,0.05,5.000000e-3
...
bordetella_pertussis,meropenem,0.1,5.000000e-3
bordetella_pertussis,imipenem_c,0.1,5.000000e-3
bordetella_pertussis,ertapenem,0.1,5.000000e-3
...
bordetella_pertussis,dalbavancin,0.1,5.000000e-3
bordetella_pertussis,linezolid,0.1,5.000000e-3
bordetella_pertussis,tedizolid,0.1,5.000000e-3
bordetella_pertussis,daptomycin,0.1,1
bordetella_pertussis,quinu_dalfo,0.1,5.000000e-3
...
bordetella_pertussis,ceftazidime_avibactam,0.1,5.000000e-3
bordetella_pertussis,meropenem_vaborbactam,0.1,5.000000e-3
bordetella_pertussis,colistin,0.05,5.000000e-3
...
helicobacter_pylori,meropenem,0.1,5.000000e-3
helicobacter_pylori,imipenem_c,0.1,5.000000e-3
helicobacter_pylori,ertapenem,0.1,5.000000e-3
...
helicobacter_pylori,dalbavancin,0.1,5.000000e-3
helicobacter_pylori,linezolid,0.1,5.000000e-3
helicobacter_pylori,tedizolid,0.1,5.000000e-3
helicobacter_pylori,daptomycin,0.1,1
helicobacter_pylori,quinu_dalfo,0.1,5.000000e-3
...
helicobacter_pylori,ceftazidime_avibactam,0.1,5.000000e-3
helicobacter_pylori,meropenem_vaborbactam,0.1,5.000000e-3
helicobacter_pylori,colistin,0.05,5.000000e-3
...
mdr_mycobacterium_tuberculosis,meropenem,0.2,5.000000e-3
mdr_mycobacterium_tuberculosis,imipenem_c,0.2,5.000000e-3
mdr_mycobacterium_tuberculosis,ertapenem,0.2,5.000000e-3
...
mdr_mycobacterium_tuberculosis,dalbavancin,0.1,5.000000e-3
mdr_mycobacterium_tuberculosis,linezolid,0.1,5.000000e-3
mdr_mycobacterium_tuberculosis,tedizolid,0.1,5.000000e-3
mdr_mycobacterium_tuberculosis,daptomycin,0.1,1
mdr_mycobacterium_tuberculosis,quinu_dalfo,0.1,5.000000e-3
...
mdr_mycobacterium_tuberculosis,ceftazidime_avibactam,0.05,5.000000e-3
mdr_mycobacterium_tuberculosis,meropenem_vaborbactam,0.2,5.000000e-3
mdr_mycobacterium_tuberculosis,colistin,0.2,5.000000e-3
...
mycoplasma_pneumoniae,penicillin_g,0.05,1.000000e-3
mycoplasma_pneumoniae,ampicillin,0.05,1.000000e-3
mycoplasma_pneumoniae,amoxicillin,0.05,1.000000e-3
mycoplasma_pneumoniae,piperacillin,0.05,1
mycoplasma_pneumoniae,ticarcillin,0.05,1
mycoplasma_pneumoniae,cephalexin,0.05,1.000000e-3
mycoplasma_pneumoniae,cefazolin,0.05,1.000000e-3
mycoplasma_pneumoniae,cefuroxime,0.05,1
mycoplasma_pneumoniae,ceftriaxone,0.05,1.000000e-3
...
mycoplasma_pneumoniae,meropenem,0.05,1.000000e-3
mycoplasma_pneumoniae,imipenem_c,0.05,5.000000e-3
mycoplasma_pneumoniae,ertapenem,0.05,1.000000e-3
...
mycoplasma_pneumoniae,dalbavancin,0.05,5.000000e-3
mycoplasma_pneumoniae,linezolid,0.05,5.000000e-3
mycoplasma_pneumoniae,tedizolid,0.05,5.000000e-3
mycoplasma_pneumoniae,daptomycin,0.1,1
mycoplasma_pneumoniae,quinu_dalfo,0.05,5.000000e-3
...
mycoplasma_pneumoniae,ceftazidime_avibactam,0.05,5.000000e-3
mycoplasma_pneumoniae,meropenem_vaborbactam,0.05,5.000000e-3
mycoplasma_pneumoniae,colistin,0.05,5.000000e-3
...
legionella_pneumophila,penicillin_g,0.05,1.000000e-3
legionella_pneumophila,ampicillin,0.05,1.000000e-3
legionella_pneumophila,amoxicillin,0.05,1.000000e-3
legionella_pneumophila,piperacillin,0.05,1
legionella_pneumophila,ticarcillin,0.05,1
legionella_pneumophila,cephalexin,0.05,1.000000e-3
legionella_pneumophila,cefazolin,0.05,1.000000e-3
legionella_pneumophila,cefuroxime,0.05,1
legionella_pneumophila,ceftriaxone,0.05,1.000000e-3
...
legionella_pneumophila,meropenem,0.05,1.000000e-3
legionella_pneumophila,imipenem_c,0.05,5.000000e-3
legionella_pneumophila,ertapenem,0.05,1.000000e-3
...
legionella_pneumophila,dalbavancin,0.05,5.000000e-3
legionella_pneumophila,linezolid,0.05,5.000000e-3
legionella_pneumophila,tedizolid,0.05,5.000000e-3
legionella_pneumophila,daptomycin,0.1,1
legionella_pneumophila,quinu_dalfo,0.05,5.000000e-3
...
legionella_pneumophila,ceftazidime_avibactam,0.05,5.000000e-3
legionella_pneumophila,meropenem_vaborbactam,0.05,5.000000e-3
legionella_pneumophila,colistin,0.05,5.000000e-3
...
burkholderia_cepacia_complex,meropenem,0.8,5.000000e-3
burkholderia_cepacia_complex,imipenem_c,0.8,5.000000e-3
burkholderia_cepacia_complex,ertapenem,0.1,5.000000e-3
...
burkholderia_cepacia_complex,dalbavancin,0,5.000000e-3
burkholderia_cepacia_complex,linezolid,0,5.000000e-3
burkholderia_cepacia_complex,tedizolid,0,5.000000e-3
burkholderia_cepacia_complex,daptomycin,0.1,1
burkholderia_cepacia_complex,quinu_dalfo,0,5.000000e-3
...
burkholderia_cepacia_complex,ceftazidime_avibactam,0.65,5.000000e-3
burkholderia_cepacia_complex,meropenem_vaborbactam,0.75,5.000000e-3
burkholderia_cepacia_complex,colistin,0.8,5.000000e-3
...
```csv
region,travel_multiplier,cessation_multiplier,mortality_log_odds,sepsis_log_odds,sepsis_mortality_multiplier,testing_multiplier,antibiotic_initiation_log_odds,hospitalization_log_odds
...
```csv
region,bacteria,acquisition_log_odds
...
```csv
bacteria,age_category,log_odds
...
```csv
syndrome,drug,penetration_factor
...
temporary_onset_rate_per_day,5.000000e-5
temporary_recovery_rate_per_day,0.01
chronic_onset_rate_per_day,6.000000e-5
chronic_recovery_rate_per_day,1.200000e-3
...
```csv
vaccine,age_category,daily_probability,availability_year
```
...
```csv
mechanism,reversion_rate_per_day
enzyme_esbl_ctx_m,6.000000e-4
enzyme_esbl_tem,6.000000e-4
enzyme_esbl_shv,6.000000e-4
enzyme_kpc,1.000000e-3
enzyme_ndm_vim,1.500000e-3
enzyme_oxa_48,5.000000e-4
enzyme_ampc_cmy,1.000000e-4
enzyme_ampc_dha,6.000000e-4
target_site_pbp2a_meca,9.000000e-4
target_site_van_a,2.000000e-3
target_site_van_b,2.000000e-3
mutation_gyra_primary,1.000000e-4
mutation_gyra_parc_secondary,2.000000e-4
protection_qnr,1.000000e-4
enzyme_16s_rrmt,5.000000e-4
target_site_erm_b,2.000000e-3
target_site_cfr,5.000000e-4
enzyme_cat,5.000000e-4
efflux_acrab_tolc,5.000000e-4
efflux_mexxy_oprm,5.000000e-4
porin_loss_ompk35_36,5.000000e-4
porin_loss_oprd,5.000000e-4
modification_mcr_1,1.500000e-3
global_efflux_pump,5.000000e-4
global_porin_loss,5.000000e-4
mutation_folate_pathway,1.000000e-4
mutation_nitroreductase,3.000000e-4
enzyme_fos_a,5.000000e-4
mutation_mpr_f,1.000000e-3
mutation_rpo_b,2.000000e-3
protection_fus_b,5.000000e-4
protection_tet_m,5.000000e-4
enzyme_aac_aph,1.000000e-4
enzyme_bla_z,1.000000e-4
enzyme_oxa_acinetobacter,1.000000e-4
mutation_23s_rrna,1.000000e-4
efflux_tet_abc,1.000000e-4
mutation_pbp_mosaic,1.000000e-3
efflux_mtr_cde,1.000000e-3
as_yet_unknown,1.000000e-3
```
...
```csv
mechanism,drug_class,enhancement_multiplier
...
```csv
bacteria,mechanism,emergence_rate_per_day
...
acinetobacter_baumannii,enzyme_16s_rrmt,0.3
...
acinetobacter_baumannii,global_porin_loss,1.000000e-4
acinetobacter_baumannii,mutation_folate_pathway,0.03
acinetobacter_baumannii,enzyme_fos_a,3.000000e-3
acinetobacter_baumannii,mutation_rpo_b,0.01
acinetobacter_baumannii,protection_tet_m,0.03
acinetobacter_baumannii,enzyme_aac_aph,0.3
acinetobacter_baumannii,enzyme_oxa_acinetobacter,0.01
acinetobacter_baumannii,efflux_tet_abc,1.000000e-3
acinetobacter_baumannii,mutation_pbp_mosaic,0.01
citrobacter_spp.,enzyme_esbl_ctx_m,1.800000e-3
citrobacter_spp.,enzyme_esbl_tem,1.800000e-3
citrobacter_spp.,enzyme_esbl_shv,1.800000e-3
citrobacter_spp.,enzyme_kpc,3.500000e-4
citrobacter_spp.,enzyme_ndm_vim,3.500000e-4
citrobacter_spp.,enzyme_oxa_48,3.500000e-4
citrobacter_spp.,enzyme_ampc_cmy,1.800000e-3
citrobacter_spp.,enzyme_ampc_dha,1.800000e-3
citrobacter_spp.,mutation_gyra_primary,6.000000e-3
citrobacter_spp.,mutation_gyra_parc_secondary,3.500000e-5
citrobacter_spp.,protection_qnr,5.000000e-3
citrobacter_spp.,enzyme_16s_rrmt,0.025
citrobacter_spp.,enzyme_cat,6.000000e-3
citrobacter_spp.,efflux_acrab_tolc,1.800000e-3
citrobacter_spp.,efflux_mexxy_oprm,3.000000e-3
citrobacter_spp.,modification_mcr_1,7.000000e-3
citrobacter_spp.,global_efflux_pump,5.000000e-4
citrobacter_spp.,global_porin_loss,7.000000e-5
citrobacter_spp.,mutation_folate_pathway,1.300000e-3
citrobacter_spp.,mutation_nitroreductase,2.500000e-3
citrobacter_spp.,enzyme_fos_a,6.000000e-4
citrobacter_spp.,mutation_rpo_b,6.000000e-3
citrobacter_spp.,protection_tet_m,6.000000e-4
citrobacter_spp.,enzyme_aac_aph,0.035
citrobacter_spp.,efflux_tet_abc,6.000000e-4
citrobacter_spp.,mutation_pbp_mosaic,5.000000e-4
enterobacter_spp.,enzyme_esbl_ctx_m,5.000000e-4
enterobacter_spp.,enzyme_esbl_tem,5.000000e-4
enterobacter_spp.,enzyme_esbl_shv,5.000000e-4
enterobacter_spp.,enzyme_kpc,5.000000e-4
enterobacter_spp.,enzyme_ndm_vim,5.000000e-4
enterobacter_spp.,enzyme_oxa_48,5.000000e-4
enterobacter_spp.,enzyme_ampc_cmy,5.000000e-4
enterobacter_spp.,enzyme_ampc_dha,5.000000e-4
enterobacter_spp.,mutation_gyra_primary,5.000000e-4
enterobacter_spp.,mutation_gyra_parc_secondary,5.000000e-4
enterobacter_spp.,protection_qnr,5.000000e-4
enterobacter_spp.,enzyme_16s_rrmt,0.3
enterobacter_spp.,enzyme_cat,5.000000e-3
enterobacter_spp.,efflux_acrab_tolc,5.000000e-4
enterobacter_spp.,modification_mcr_1,0.03
enterobacter_spp.,global_efflux_pump,5.000000e-4
enterobacter_spp.,global_porin_loss,3.000000e-4
enterobacter_spp.,mutation_folate_pathway,5.000000e-3
enterobacter_spp.,mutation_nitroreductase,3.000000e-3
enterobacter_spp.,enzyme_fos_a,0.01
enterobacter_spp.,mutation_rpo_b,0.03
enterobacter_spp.,protection_tet_m,2.000000e-3
enterobacter_spp.,enzyme_aac_aph,0.3
enterobacter_spp.,efflux_tet_abc,2.000000e-3
enterobacter_spp.,mutation_pbp_mosaic,2.000000e-3
enterococcus_faecalis,target_site_pbp2a_meca,1.000000e-6
enterococcus_faecalis,target_site_van_a,1.000000e-3
enterococcus_faecalis,target_site_van_b,1.000000e-3
enterococcus_faecalis,mutation_gyra_primary,1.000000e-4
enterococcus_faecalis,mutation_gyra_parc_secondary,2.000000e-5
enterococcus_faecalis,target_site_erm_b,1.000000e-4
enterococcus_faecalis,target_site_cfr,2.000000e-4
enterococcus_faecalis,enzyme_cat,1.500000e-5
enterococcus_faecalis,global_efflux_pump,2.000000e-5
enterococcus_faecalis,global_porin_loss,5.000000e-6
enterococcus_faecalis,mutation_folate_pathway,1.000000e-3
enterococcus_faecalis,mutation_nitroreductase,1.000000e-3
enterococcus_faecalis,mutation_mpr_f,3.000000e-4
enterococcus_faecalis,mutation_rpo_b,3.000000e-4
enterococcus_faecalis,protection_fus_b,3.000000e-5
enterococcus_faecalis,protection_tet_m,1.000000e-4
enterococcus_faecalis,enzyme_aac_aph,5.000000e-6
enterococcus_faecalis,mutation_23s_rrna,2.000000e-5
enterococcus_faecalis,mutation_pbp_mosaic,1.000000e-6
enterococcus_faecium,target_site_van_a,0.01
enterococcus_faecium,target_site_van_b,0.01
enterococcus_faecium,mutation_gyra_primary,8.000000e-4
enterococcus_faecium,mutation_gyra_parc_secondary,1.500000e-3
enterococcus_faecium,enzyme_16s_rrmt,3.000000e-3
enterococcus_faecium,target_site_erm_b,9.000000e-3
enterococcus_faecium,target_site_cfr,9.000000e-3
enterococcus_faecium,enzyme_cat,1.000000e-3
enterococcus_faecium,global_efflux_pump,4.000000e-3
enterococcus_faecium,mutation_folate_pathway,6.000000e-3
...
enterococcus_faecium,protection_tet_m,4.000000e-3
enterococcus_faecium,enzyme_aac_aph,0.015
enterococcus_faecium,mutation_23s_rrna,1.500000e-3
enterococcus_faecium,mutation_pbp_mosaic,0.015
enterococcus_faecium,efflux_mtr_cde,1.500000e-3
escherichia_coli,enzyme_esbl_ctx_m,7.000000e-12
escherichia_coli,enzyme_esbl_tem,7.000000e-12
escherichia_coli,enzyme_esbl_shv,7.000000e-12
escherichia_coli,enzyme_kpc,7.000000e-12
escherichia_coli,enzyme_ndm_vim,7.000000e-12
escherichia_coli,enzyme_oxa_48,7.000000e-12
escherichia_coli,enzyme_ampc_cmy,7.000000e-12
escherichia_coli,enzyme_ampc_dha,7.000000e-12
escherichia_coli,mutation_gyra_primary,3.000000e-7
escherichia_coli,mutation_gyra_parc_secondary,3.000000e-14
escherichia_coli,protection_qnr,3.000000e-7
escherichia_coli,enzyme_16s_rrmt,3.000000e-12
escherichia_coli,enzyme_cat,3.000000e-9
escherichia_coli,efflux_acrab_tolc,3.000000e-1
escherichia_coli,modification_mcr_1,3.000000e-1
escherichia_coli,global_efflux_pump,3.000000e-1
escherichia_coli,global_porin_loss,3.000000e-13
escherichia_coli,mutation_folate_pathway,3.000000e-9
escherichia_coli,mutation_nitroreductase,3.000000e-12
escherichia_coli,enzyme_fos_a,3.000000e-11
escherichia_coli,mutation_rpo_b,3.000000e-1
escherichia_coli,protection_tet_m,3.000000e-11
escherichia_coli,enzyme_aac_aph,3.000000e-8
escherichia_coli,efflux_tet_abc,3.000000e-11
klebsiella_pneumoniae,enzyme_esbl_ctx_m,3.000000e-6
klebsiella_pneumoniae,enzyme_esbl_tem,3.000000e-6
klebsiella_pneumoniae,enzyme_esbl_shv,3.000000e-6
klebsiella_pneumoniae,enzyme_kpc,3.000000e-6
klebsiella_pneumoniae,enzyme_ndm_vim,3.000000e-6
klebsiella_pneumoniae,enzyme_oxa_48,3.000000e-6
klebsiella_pneumoniae,enzyme_ampc_cmy,3.000000e-6
klebsiella_pneumoniae,enzyme_ampc_dha,3.000000e-6
klebsiella_pneumoniae,mutation_gyra_primary,5.000000e-4
klebsiella_pneumoniae,mutation_gyra_parc_secondary,5.000000e-4
klebsiella_pneumoniae,protection_qnr,5.000000e-4
klebsiella_pneumoniae,enzyme_16s_rrmt,0.03
klebsiella_pneumoniae,enzyme_cat,3.000000e-3
klebsiella_pneumoniae,efflux_acrab_tolc,3.000000e-4
klebsiella_pneumoniae,porin_loss_ompk35_36,3.000000e-6
klebsiella_pneumoniae,modification_mcr_1,5.000000e-3
klebsiella_pneumoniae,global_efflux_pump,2.000000e-4
klebsiella_pneumoniae,global_porin_loss,3.000000e-9
klebsiella_pneumoniae,mutation_folate_pathway,2.000000e-3
klebsiella_pneumoniae,mutation_nitroreductase,2.000000e-3
klebsiella_pneumoniae,enzyme_fos_a,2.000000e-3
klebsiella_pneumoniae,mutation_rpo_b,2.000000e-4
klebsiella_pneumoniae,protection_tet_m,5.000000e-5
klebsiella_pneumoniae,enzyme_aac_aph,0.03
klebsiella_pneumoniae,efflux_tet_abc,5.000000e-5
morganella_spp.,enzyme_esbl_ctx_m,7.000000e-4
morganella_spp.,enzyme_esbl_tem,7.000000e-4
morganella_spp.,enzyme_esbl_shv,7.000000e-4
morganella_spp.,enzyme_kpc,4.000000e-4
morganella_spp.,enzyme_ndm_vim,4.000000e-4
morganella_spp.,enzyme_oxa_48,4.000000e-4
morganella_spp.,enzyme_ampc_cmy,4.000000e-4
morganella_spp.,enzyme_ampc_dha,4.000000e-4
morganella_spp.,mutation_gyra_primary,3.000000e-3
morganella_spp.,mutation_gyra_parc_secondary,3.000000e-3
morganella_spp.,protection_qnr,3.000000e-3
morganella_spp.,enzyme_16s_rrmt,0.4
morganella_spp.,enzyme_cat,0.09
morganella_spp.,efflux_acrab_tolc,7.000000e-4
morganella_spp.,efflux_mexxy_oprm,1.300000e-3
morganella_spp.,modification_mcr_1,0.025
morganella_spp.,global_efflux_pump,1.300000e-3
morganella_spp.,global_porin_loss,7.000000e-6
morganella_spp.,mutation_folate_pathway,5.000000e-3
morganella_spp.,mutation_nitroreductase,0.06
morganella_spp.,enzyme_fos_a,6.000000e-3
morganella_spp.,mutation_rpo_b,0.025
morganella_spp.,protection_tet_m,6.000000e-4
morganella_spp.,enzyme_aac_aph,0.025
morganella_spp.,efflux_tet_abc,2.500000e-3
morganella_spp.,mutation_pbp_mosaic,1.300000e-7
proteus_spp.,enzyme_esbl_ctx_m,2.500000e-4
proteus_spp.,enzyme_esbl_tem,2.500000e-4
proteus_spp.,enzyme_esbl_shv,2.500000e-5
proteus_spp.,enzyme_kpc,7.000000e-6
proteus_spp.,enzyme_ndm_vim,7.000000e-6
proteus_spp.,enzyme_oxa_48,7.000000e-6
proteus_spp.,enzyme_ampc_cmy,2.500000e-5
proteus_spp.,enzyme_ampc_dha,2.500000e-5
proteus_spp.,mutation_gyra_primary,7.000000e-4
proteus_spp.,mutation_gyra_parc_secondary,2.500000e-4
proteus_spp.,protection_qnr,1.300000e-4
proteus_spp.,enzyme_16s_rrmt,1.500000e-5
proteus_spp.,enzyme_cat,4.000000e-5
proteus_spp.,efflux_acrab_tolc,7.000000e-4
proteus_spp.,modification_mcr_1,3.000000e-5
proteus_spp.,global_efflux_pump,7.000000e-4
proteus_spp.,global_porin_loss,7.000000e-6
proteus_spp.,mutation_folate_pathway,3.000000e-4
proteus_spp.,mutation_nitroreductase,7.000000e-7
proteus_spp.,enzyme_fos_a,7.000000e-5
proteus_spp.,mutation_rpo_b,7.000000e-6
proteus_spp.,protection_tet_m,7.000000e-5
proteus_spp.,enzyme_aac_aph,1.000000e-8
proteus_spp.,efflux_tet_abc,1.000000e-8
serratia_spp.,enzyme_esbl_ctx_m,2.000000e-3
serratia_spp.,enzyme_esbl_tem,2.000000e-3
serratia_spp.,enzyme_esbl_shv,2.000000e-3
serratia_spp.,enzyme_kpc,2.000000e-3
serratia_spp.,enzyme_ndm_vim,2.000000e-4
serratia_spp.,enzyme_oxa_48,2.000000e-4
serratia_spp.,enzyme_ampc_cmy,2.000000e-3
serratia_spp.,enzyme_ampc_dha,2.000000e-3
serratia_spp.,mutation_gyra_primary,4.000000e-3
serratia_spp.,mutation_gyra_parc_secondary,4.000000e-3
serratia_spp.,protection_qnr,4.000000e-3
serratia_spp.,enzyme_16s_rrmt,0.15
serratia_spp.,enzyme_cat,1.000000e-4
serratia_spp.,efflux_acrab_tolc,4.000000e-3
serratia_spp.,modification_mcr_1,0.015
serratia_spp.,global_efflux_pump,2.500000e-3
serratia_spp.,global_porin_loss,2.000000e-5
serratia_spp.,mutation_folate_pathway,2.000000e-3
serratia_spp.,mutation_nitroreductase,1.000000e-3
serratia_spp.,enzyme_fos_a,1.000000e-4
serratia_spp.,mutation_rpo_b,0.01
serratia_spp.,protection_tet_m,2.000000e-3
serratia_spp.,enzyme_aac_aph,0.15
serratia_spp.,efflux_tet_abc,2.000000e-4
p_stuartii,enzyme_esbl_ctx_m,1.900000e-4
p_stuartii,enzyme_esbl_tem,1.900000e-4
p_stuartii,enzyme_esbl_shv,3.700000e-5
p_stuartii,enzyme_kpc,1.900000e-5
p_stuartii,enzyme_ndm_vim,1.900000e-5
p_stuartii,enzyme_oxa_48,1.900000e-5
p_stuartii,enzyme_ampc_cmy,3.800000e-4
p_stuartii,enzyme_ampc_dha,1.900000e-4
p_stuartii,mutation_gyra_primary,3.800000e-4
p_stuartii,mutation_gyra_parc_secondary,1.900000e-4
p_stuartii,protection_qnr,1.900000e-4
p_stuartii,enzyme_16s_rrmt,3.800000e-6
p_stuartii,enzyme_cat,1.900000e-4
p_stuartii,efflux_acrab_tolc,1.900000e-4
p_stuartii,modification_mcr_1,1.900000e-5
p_stuartii,global_efflux_pump,3.700000e-5
p_stuartii,global_porin_loss,3.700000e-5
p_stuartii,mutation_folate_pathway,3.800000e-4
p_stuartii,mutation_nitroreductase,3.700000e-5
p_stuartii,enzyme_fos_a,3.700000e-5
p_stuartii,mutation_rpo_b,3.800000e-6
p_stuartii,protection_tet_m,3.800000e-4
p_stuartii,enzyme_aac_aph,5.000000e-11
p_stuartii,efflux_tet_abc,5.000000e-11
pseudomonas_aeruginosa,enzyme_esbl_ctx_m,1.000000e-5
pseudomonas_aeruginosa,enzyme_esbl_tem,1.000000e-5
pseudomonas_aeruginosa,enzyme_esbl_shv,1.000000e-5
pseudomonas_aeruginosa,enzyme_kpc,1.000000e-5
pseudomonas_aeruginosa,enzyme_ndm_vim,1.000000e-5
pseudomonas_aeruginosa,enzyme_oxa_48,1.000000e-5
pseudomonas_aeruginosa,enzyme_ampc_cmy,1.000000e-5
pseudomonas_aeruginosa,enzyme_ampc_dha,1.000000e-5
pseudomonas_aeruginosa,mutation_gyra_primary,1.000000e-4
pseudomonas_aeruginosa,mutation_gyra_parc_secondary,1.000000e-4
pseudomonas_aeruginosa,protection_qnr,1.000000e-4
pseudomonas_aeruginosa,enzyme_16s_rrmt,1.000000e-4
pseudomonas_aeruginosa,target_site_erm_b,3.000000e-6
pseudomonas_aeruginosa,target_site_cfr,3.000000e-6
pseudomonas_aeruginosa,enzyme_cat,3.000000e-5
pseudomonas_aeruginosa,efflux_mexxy_oprm,4.000000e-5
pseudomonas_aeruginosa,porin_loss_oprd,4.000000e-5
pseudomonas_aeruginosa,modification_mcr_1,3.000000e-4
pseudomonas_aeruginosa,global_efflux_pump,4.000000e-5
pseudomonas_aeruginosa,global_porin_loss,3.000000e-5
pseudomonas_aeruginosa,mutation_folate_pathway,3.000000e-4
pseudomonas_aeruginosa,mutation_nitroreductase,3.000000e-6
pseudomonas_aeruginosa,enzyme_fos_a,1.000000e-3
pseudomonas_aeruginosa,mutation_rpo_b,1.000000e-4
pseudomonas_aeruginosa,protection_tet_m,3.000000e-4
pseudomonas_aeruginosa,enzyme_aac_aph,1.000000e-4
pseudomonas_aeruginosa,efflux_tet_abc,3.000000e-6
stenotrophomonas_maltophilia,enzyme_esbl_ctx_m,2.000000e-5
stenotrophomonas_maltophilia,enzyme_esbl_tem,2.000000e-5
stenotrophomonas_maltophilia,enzyme_esbl_shv,2.000000e-5
stenotrophomonas_maltophilia,enzyme_kpc,2.000000e-5
stenotrophomonas_maltophilia,enzyme_ndm_vim,0.1
stenotrophomonas_maltophilia,enzyme_oxa_48,2.000000e-5
stenotrophomonas_maltophilia,enzyme_ampc_cmy,0.05
stenotrophomonas_maltophilia,enzyme_ampc_dha,2.000000e-4
stenotrophomonas_maltophilia,mutation_gyra_primary,5.000000e-8
stenotrophomonas_maltophilia,mutation_gyra_parc_secondary,5.000000e-8
stenotrophomonas_maltophilia,protection_qnr,2.000000e-5
stenotrophomonas_maltophilia,enzyme_16s_rrmt,0.01
stenotrophomonas_maltophilia,target_site_erm_b,0.1
stenotrophomonas_maltophilia,enzyme_cat,5.000000e-7
stenotrophomonas_maltophilia,modification_mcr_1,0.05
stenotrophomonas_maltophilia,global_efflux_pump,1.000000e-7
stenotrophomonas_maltophilia,global_porin_loss,1.000000e-13
stenotrophomonas_maltophilia,mutation_folate_pathway,5.000000e-3
stenotrophomonas_maltophilia,mutation_nitroreductase,0.5
stenotrophomonas_maltophilia,enzyme_fos_a,0.03
stenotrophomonas_maltophilia,mutation_rpo_b,2.000000e-4
stenotrophomonas_maltophilia,protection_tet_m,5.000000e-7
stenotrophomonas_maltophilia,enzyme_aac_aph,0.05
stenotrophomonas_maltophilia,efflux_tet_abc,2.000000e-9
staphylococcus_aureus,target_site_pbp2a_meca,1.300000e-6
staphylococcus_aureus,target_site_van_a,1.300000e-9
staphylococcus_aureus,target_site_van_b,4.000000e-12
staphylococcus_aureus,mutation_gyra_primary,1.300000e-6
staphylococcus_aureus,mutation_gyra_parc_secondary,1.300000e-6
staphylococcus_aureus,enzyme_16s_rrmt,1.300000e-6
staphylococcus_aureus,target_site_erm_b,1.300000e-6
staphylococcus_aureus,target_site_cfr,1.300000e-8
staphylococcus_aureus,enzyme_cat,1.300000e-9
staphylococcus_aureus,global_efflux_pump,1.300000e-6
staphylococcus_aureus,mutation_folate_pathway,1.300000e-6
staphylococcus_aureus,mutation_nitroreductase,1.300000e-6
staphylococcus_aureus,enzyme_fos_a,1.300000e-6
staphylococcus_aureus,mutation_mpr_f,1.300000e-6
staphylococcus_aureus,mutation_rpo_b,1.300000e-6
staphylococcus_aureus,protection_fus_b,1.300000e-6
staphylococcus_aureus,protection_tet_m,1.300000e-6
staphylococcus_aureus,enzyme_aac_aph,1.300000e-6
staphylococcus_aureus,enzyme_bla_z,1.300000e-7
staphylococcus_epidermidis,target_site_pbp2a_meca,1.000000e-6
staphylococcus_epidermidis,target_site_van_a,1.000000e-8
staphylococcus_epidermidis,target_site_van_b,1.000000e-8
staphylococcus_epidermidis,mutation_gyra_primary,1.000000e-5
staphylococcus_epidermidis,mutation_gyra_parc_secondary,1.000000e-6
staphylococcus_epidermidis,target_site_erm_b,1.000000e-5
staphylococcus_epidermidis,target_site_cfr,1.000000e-7
staphylococcus_epidermidis,enzyme_cat,1.000000e-6
staphylococcus_epidermidis,global_efflux_pump,1.000000e-6
staphylococcus_epidermidis,mutation_folate_pathway,1.000000e-5
staphylococcus_epidermidis,mutation_mpr_f,1.000000e-6
staphylococcus_epidermidis,mutation_rpo_b,1.000000e-3
staphylococcus_epidermidis,protection_fus_b,3.000000e-6
staphylococcus_epidermidis,protection_tet_m,3.000000e-5
staphylococcus_epidermidis,enzyme_aac_aph,1.000000e-9
staphylococcus_epidermidis,enzyme_bla_z,1.000000e-7
streptococcus_pneumoniae,target_site_pbp2a_meca,1.000000e-7
streptococcus_pneumoniae,mutation_gyra_primary,5.000000e-6
streptococcus_pneumoniae,mutation_gyra_parc_secondary,5.000000e-6
streptococcus_pneumoniae,target_site_erm_b,3.000000e-7
streptococcus_pneumoniae,enzyme_cat,2.000000e-5
streptococcus_pneumoniae,global_efflux_pump,5.000000e-6
streptococcus_pneumoniae,global_porin_loss,5.000000e-9
streptococcus_pneumoniae,mutation_folate_pathway,3.000000e-4
streptococcus_pneumoniae,mutation_rpo_b,3.000000e-4
streptococcus_pneumoniae,protection_tet_m,3.000000e-4
streptococcus_pneumoniae,enzyme_bla_z,1.000000e-7
streptococcus_pneumoniae,mutation_23s_rrna,1.000000e-7
streptococcus_pneumoniae,mutation_pbp_mosaic,1.000000e-7
salmonella_enterica_serovar_typhi,enzyme_esbl_ctx_m,5.000000e-3
salmonella_enterica_serovar_typhi,enzyme_esbl_tem,0.15
salmonella_enterica_serovar_typhi,enzyme_esbl_shv,1.500000e-3
salmonella_enterica_serovar_typhi,enzyme_kpc,3.000000e-5
salmonella_enterica_serovar_typhi,enzyme_ndm_vim,3.000000e-5
salmonella_enterica_serovar_typhi,enzyme_oxa_48,3.000000e-5
salmonella_enterica_serovar_typhi,enzyme_ampc_cmy,5.000000e-4
salmonella_enterica_serovar_typhi,enzyme_ampc_dha,5.000000e-4
salmonella_enterica_serovar_typhi,mutation_gyra_primary,0.15
salmonella_enterica_serovar_typhi,mutation_gyra_parc_secondary,0.015
salmonella_enterica_serovar_typhi,protection_qnr,2.000000e-3
salmonella_enterica_serovar_typhi,enzyme_16s_rrmt,3.000000e-5
salmonella_enterica_serovar_typhi,enzyme_cat,0.015
salmonella_enterica_serovar_typhi,efflux_acrab_tolc,0.015
salmonella_enterica_serovar_typhi,modification_mcr_1,1.500000e-3
salmonella_enterica_serovar_typhi,global_efflux_pump,2.000000e-3
salmonella_enterica_serovar_typhi,global_porin_loss,1.000000e-3
salmonella_enterica_serovar_typhi,mutation_folate_pathway,0.15
salmonella_enterica_serovar_typhi,mutation_nitroreductase,1.500000e-3
salmonella_enterica_serovar_typhi,enzyme_fos_a,1.500000e-3
salmonella_enterica_serovar_typhi,mutation_rpo_b,1.500000e-4
salmonella_enterica_serovar_typhi,protection_tet_m,0.015
salmonella_enterica_serovar_typhi,enzyme_aac_aph,2.000000e-6
salmonella_enterica_serovar_typhi,efflux_tet_abc,2.000000e-6
salmonella_enterica_serovar_typhi,efflux_mtr_cde,0.01
salmonella_enterica_serovar_paratyphi_a,enzyme_esbl_ctx_m,8.000000e-4
salmonella_enterica_serovar_paratyphi_a,enzyme_esbl_tem,1.200000e-3
salmonella_enterica_serovar_paratyphi_a,enzyme_esbl_shv,6.000000e-4
salmonella_enterica_serovar_paratyphi_a,enzyme_kpc,1.600000e-5
salmonella_enterica_serovar_paratyphi_a,enzyme_ndm_vim,2.300000e-5
salmonella_enterica_serovar_paratyphi_a,enzyme_oxa_48,1.600000e-5
salmonella_enterica_serovar_paratyphi_a,enzyme_ampc_cmy,5.000000e-4
salmonella_enterica_serovar_paratyphi_a,enzyme_ampc_dha,4.000000e-4
...
salmonella_enterica_serovar_paratyphi_a,protection_qnr,4.000000e-3
salmonella_enterica_serovar_paratyphi_a,enzyme_16s_rrmt,4.000000e-3
salmonella_enterica_serovar_paratyphi_a,enzyme_cat,6.000000e-3
salmonella_enterica_serovar_paratyphi_a,efflux_acrab_tolc,0.014
salmonella_enterica_serovar_paratyphi_a,efflux_mexxy_oprm,8.000000e-4
salmonella_enterica_serovar_paratyphi_a,modification_mcr_1,2.000000e-3
salmonella_enterica_serovar_paratyphi_a,global_efflux_pump,3.500000e-3
salmonella_enterica_serovar_paratyphi_a,global_porin_loss,3.000000e-5
salmonella_enterica_serovar_paratyphi_a,mutation_folate_pathway,0.01
salmonella_enterica_serovar_paratyphi_a,mutation_nitroreductase,5.000000e-5
salmonella_enterica_serovar_paratyphi_a,enzyme_fos_a,5.000000e-5
salmonella_enterica_serovar_paratyphi_a,mutation_rpo_b,3.000000e-3
salmonella_enterica_serovar_paratyphi_a,protection_tet_m,5.500000e-3
salmonella_enterica_serovar_paratyphi_a,enzyme_aac_aph,5.500000e-3
salmonella_enterica_serovar_paratyphi_a,efflux_tet_abc,5.500000e-3
salmonella_enterica_serovar_paratyphi_a,mutation_pbp_mosaic,4.500000e-4
salmonella_enterica_serovar_paratyphi_a,efflux_mtr_cde,1.600000e-4
invasive_non-typhoidal_salmonella_spp.,enzyme_esbl_ctx_m,1.500000e-4
invasive_non-typhoidal_salmonella_spp.,enzyme_esbl_tem,1.500000e-4
invasive_non-typhoidal_salmonella_spp.,enzyme_esbl_shv,1.500000e-4
invasive_non-typhoidal_salmonella_spp.,enzyme_kpc,1.500000e-5
invasive_non-typhoidal_salmonella_spp.,enzyme_ndm_vim,1.500000e-5
invasive_non-typhoidal_salmonella_spp.,enzyme_oxa_48,1.500000e-5
invasive_non-typhoidal_salmonella_spp.,enzyme_ampc_cmy,1.500000e-4
invasive_non-typhoidal_salmonella_spp.,enzyme_ampc_dha,1.500000e-4
invasive_non-typhoidal_salmonella_spp.,mutation_gyra_primary,3.000000e-3
invasive_non-typhoidal_salmonella_spp.,mutation_gyra_parc_secondary,3.000000e-3
invasive_non-typhoidal_salmonella_spp.,protection_qnr,3.000000e-3
invasive_non-typhoidal_salmonella_spp.,enzyme_16s_rrmt,0.05
invasive_non-typhoidal_salmonella_spp.,enzyme_cat,7.000000e-3
invasive_non-typhoidal_salmonella_spp.,efflux_acrab_tolc,3.000000e-3
invasive_non-typhoidal_salmonella_spp.,modification_mcr_1,7.000000e-3
invasive_non-typhoidal_salmonella_spp.,global_efflux_pump,3.000000e-3
invasive_non-typhoidal_salmonella_spp.,global_porin_loss,1.500000e-6
invasive_non-typhoidal_salmonella_spp.,mutation_folate_pathway,1.500000e-3
invasive_non-typhoidal_salmonella_spp.,mutation_nitroreductase,1.500000e-3
invasive_non-typhoidal_salmonella_spp.,enzyme_fos_a,3.000000e-4
invasive_non-typhoidal_salmonella_spp.,mutation_rpo_b,7.000000e-3
invasive_non-typhoidal_salmonella_spp.,protection_tet_m,7.000000e-4
invasive_non-typhoidal_salmonella_spp.,enzyme_aac_aph,0.015
invasive_non-typhoidal_salmonella_spp.,efflux_tet_abc,7.000000e-3
invasive_non-typhoidal_salmonella_spp.,efflux_mtr_cde,1.500000e-6
shigella_spp.,enzyme_esbl_ctx_m,3.000000e-5
shigella_spp.,enzyme_esbl_tem,3.000000e-5
shigella_spp.,enzyme_esbl_shv,3.000000e-5
shigella_spp.,enzyme_kpc,3.000000e-5
shigella_spp.,enzyme_ndm_vim,3.000000e-5
shigella_spp.,enzyme_oxa_48,3.000000e-5
shigella_spp.,enzyme_ampc_cmy,3.000000e-5
shigella_spp.,enzyme_ampc_dha,3.000000e-5
shigella_spp.,mutation_gyra_primary,6.000000e-6
shigella_spp.,mutation_gyra_parc_secondary,6.000000e-6
shigella_spp.,protection_qnr,6.000000e-6
shigella_spp.,enzyme_16s_rrmt,6.000000e-3
shigella_spp.,target_site_erm_b,0.3
shigella_spp.,enzyme_cat,6.000000e-6
shigella_spp.,efflux_acrab_tolc,6.000000e-6
shigella_spp.,modification_mcr_1,3.000000e-6
shigella_spp.,global_efflux_pump,0.25
shigella_spp.,global_porin_loss,3.000000e-7
shigella_spp.,mutation_folate_pathway,3.000000e-5
shigella_spp.,mutation_rpo_b,1.500000e-3
shigella_spp.,protection_tet_m,6.000000e-4
shigella_spp.,enzyme_aac_aph,0.06
shigella_spp.,mutation_23s_rrna,0.15
shigella_spp.,efflux_tet_abc,1.500000e-4
shigella_spp.,mutation_pbp_mosaic,6.000000e-6
shigella_spp.,efflux_mtr_cde,1.200000e-5
neisseria_gonorrhoeae,mutation_gyra_primary,0.1
neisseria_gonorrhoeae,mutation_gyra_parc_secondary,0.1
neisseria_gonorrhoeae,protection_qnr,0.1
neisseria_gonorrhoeae,enzyme_16s_rrmt,0.3
neisseria_gonorrhoeae,target_site_erm_b,6.000000e-5
neisseria_gonorrhoeae,target_site_cfr,6.000000e-5
neisseria_gonorrhoeae,enzyme_cat,7.000000e-5
neisseria_gonorrhoeae,modification_mcr_1,6.000000e-5
neisseria_gonorrhoeae,global_efflux_pump,0.01
neisseria_gonorrhoeae,global_porin_loss,6.000000e-7
neisseria_gonorrhoeae,mutation_folate_pathway,6.000000e-3
neisseria_gonorrhoeae,mutation_nitroreductase,6.000000e-3
neisseria_gonorrhoeae,enzyme_fos_a,6.000000e-6
neisseria_gonorrhoeae,mutation_rpo_b,0.06
neisseria_gonorrhoeae,protection_tet_m,2.500000e-3
neisseria_gonorrhoeae,enzyme_aac_aph,0.25
neisseria_gonorrhoeae,enzyme_bla_z,6.000000e-5
neisseria_gonorrhoeae,mutation_23s_rrna,1.500000e-4
neisseria_gonorrhoeae,efflux_tet_abc,6.000000e-5
neisseria_gonorrhoeae,mutation_pbp_mosaic,3.000000e-4
neisseria_gonorrhoeae,efflux_mtr_cde,3.000000e-5
streptococcus_pyogenes,mutation_gyra_primary,3.800000e-7
streptococcus_pyogenes,mutation_gyra_parc_secondary,7.500000e-8
streptococcus_pyogenes,target_site_erm_b,7.500000e-6
streptococcus_pyogenes,target_site_cfr,7.500000e-9
streptococcus_pyogenes,enzyme_cat,3.800000e-7
streptococcus_pyogenes,global_efflux_pump,7.500000e-7
streptococcus_pyogenes,mutation_folate_pathway,3.800000e-6
streptococcus_pyogenes,mutation_mpr_f,7.500000e-9
streptococcus_pyogenes,mutation_rpo_b,7.500000e-9
streptococcus_pyogenes,protection_fus_b,7.500000e-9
streptococcus_pyogenes,protection_tet_m,7.500000e-6
streptococcus_pyogenes,mutation_23s_rrna,5.000000e-11
streptococcus_agalactiae,target_site_pbp2a_meca,1.000000e-8
streptococcus_agalactiae,target_site_van_a,1.000000e-8
streptococcus_agalactiae,target_site_van_b,1.000000e-8
streptococcus_agalactiae,mutation_gyra_primary,1.000000e-6
streptococcus_agalactiae,mutation_gyra_parc_secondary,1.000000e-6
streptococcus_agalactiae,target_site_erm_b,1.000000e-6
streptococcus_agalactiae,target_site_cfr,1.000000e-8
streptococcus_agalactiae,enzyme_cat,3.000000e-7
streptococcus_agalactiae,global_efflux_pump,1.000000e-6
streptococcus_agalactiae,mutation_folate_pathway,1.000000e-5
streptococcus_agalactiae,mutation_mpr_f,1.000000e-7
streptococcus_agalactiae,mutation_rpo_b,1.000000e-7
streptococcus_agalactiae,protection_fus_b,1.000000e-7
streptococcus_agalactiae,protection_tet_m,1.000000e-3
streptococcus_agalactiae,mutation_23s_rrna,5.000000e-11
streptococcus_agalactiae,mutation_pbp_mosaic,3.000000e-5
haemophilus_influenzae,enzyme_esbl_ctx_m,1.000000e-8
haemophilus_influenzae,enzyme_esbl_tem,1.000000e-8
haemophilus_influenzae,enzyme_esbl_shv,1.000000e-8
haemophilus_influenzae,enzyme_kpc,1.000000e-8
haemophilus_influenzae,enzyme_ndm_vim,1.000000e-8
haemophilus_influenzae,enzyme_oxa_48,1.000000e-8
haemophilus_influenzae,enzyme_ampc_cmy,1.000000e-8
haemophilus_influenzae,enzyme_ampc_dha,1.000000e-8
haemophilus_influenzae,mutation_gyra_primary,3.000000e-5
haemophilus_influenzae,mutation_gyra_parc_secondary,1.000000e-5
haemophilus_influenzae,protection_qnr,1.000000e-5
haemophilus_influenzae,enzyme_16s_rrmt,2.000000e-4
haemophilus_influenzae,target_site_erm_b,3.000000e-5
haemophilus_influenzae,target_site_cfr,3.000000e-5
haemophilus_influenzae,enzyme_cat,3.000000e-5
haemophilus_influenzae,modification_mcr_1,1.000000e-7
haemophilus_influenzae,global_efflux_pump,3.000000e-4
haemophilus_influenzae,global_porin_loss,1.000000e-8
haemophilus_influenzae,mutation_folate_pathway,3.000000e-5
haemophilus_influenzae,mutation_nitroreductase,1.000000e-6
haemophilus_influenzae,mutation_rpo_b,1.000000e-3
haemophilus_influenzae,protection_tet_m,3.000000e-5
haemophilus_influenzae,enzyme_aac_aph,3.000000e-4
haemophilus_influenzae,enzyme_bla_z,1.000000e-8
haemophilus_influenzae,mutation_23s_rrna,3.000000e-6
haemophilus_influenzae,mutation_pbp_mosaic,1.000000e-8
haemophilus_influenzae,efflux_mtr_cde,1.000000e-8
chlamydia_trachomatis,mutation_gyra_primary,9.400000e-8
chlamydia_trachomatis,mutation_gyra_parc_secondary,4.700000e-8
chlamydia_trachomatis,target_site_erm_b,4.700000e-8
chlamydia_trachomatis,target_site_cfr,9.400000e-1
chlamydia_trachomatis,enzyme_cat,9.400000e-1
chlamydia_trachomatis,global_efflux_pump,9.400000e-9
chlamydia_trachomatis,mutation_folate_pathway,9.400000e-1
chlamydia_trachomatis,mutation_nitroreductase,9.400000e-1
chlamydia_trachomatis,mutation_rpo_b,9.400000e-9
chlamydia_trachomatis,protection_tet_m,9.400000e-8
chlamydia_trachomatis,mutation_23s_rrna,5.000000e-11
mycoplasma_genitalium,mutation_gyra_primary,1.500000e-3
mycoplasma_genitalium,mutation_gyra_parc_secondary,1.500000e-3
mycoplasma_genitalium,target_site_erm_b,1.500000e-4
mycoplasma_genitalium,target_site_cfr,1.500000e-4
mycoplasma_genitalium,enzyme_cat,5.000000e-5
mycoplasma_genitalium,global_efflux_pump,1.500000e-6
mycoplasma_genitalium,mutation_folate_pathway,5.000000e-5
mycoplasma_genitalium,mutation_nitroreductase,5.000000e-5
mycoplasma_genitalium,mutation_rpo_b,5.000000e-4
mycoplasma_genitalium,protection_tet_m,7.000000e-4
mycoplasma_genitalium,mutation_23s_rrna,7.000000e-4
vibrio_cholerae,enzyme_esbl_ctx_m,3.000000e-6
vibrio_cholerae,enzyme_esbl_tem,3.000000e-6
vibrio_cholerae,enzyme_esbl_shv,1.000000e-6
vibrio_cholerae,enzyme_kpc,1.000000e-7
vibrio_cholerae,enzyme_ndm_vim,1.000000e-6
vibrio_cholerae,enzyme_oxa_48,1.000000e-7
vibrio_cholerae,enzyme_ampc_cmy,1.000000e-6
vibrio_cholerae,enzyme_ampc_dha,1.000000e-6
vibrio_cholerae,mutation_gyra_primary,3.000000e-5
vibrio_cholerae,mutation_gyra_parc_secondary,1.500000e-5
vibrio_cholerae,protection_qnr,3.000000e-6
vibrio_cholerae,enzyme_16s_rrmt,3.000000e-8
vibrio_cholerae,enzyme_cat,1.000000e-4
vibrio_cholerae,efflux_acrab_tolc,3.000000e-6
vibrio_cholerae,modification_mcr_1,3.000000e-7
vibrio_cholerae,global_efflux_pump,3.000000e-6
vibrio_cholerae,global_porin_loss,1.500000e-6
vibrio_cholerae,mutation_folate_pathway,1.500000e-4
vibrio_cholerae,mutation_nitroreductase,3.000000e-7
vibrio_cholerae,enzyme_fos_a,3.000000e-7
vibrio_cholerae,mutation_rpo_b,3.000000e-7
vibrio_cholerae,protection_tet_m,5.000000e-5
vibrio_cholerae,enzyme_aac_aph,5.000000e-11
vibrio_cholerae,mutation_23s_rrna,1.500000e-4
vibrio_cholerae,efflux_tet_abc,5.000000e-11
vibrio_cholerae,efflux_mtr_cde,1.000000e-9
neisseria_meningitidis,enzyme_esbl_ctx_m,3.000000e-8
neisseria_meningitidis,enzyme_esbl_tem,3.000000e-8
neisseria_meningitidis,enzyme_esbl_shv,3.000000e-8
neisseria_meningitidis,enzyme_ampc_cmy,3.000000e-8
neisseria_meningitidis,enzyme_ampc_dha,3.000000e-8
neisseria_meningitidis,mutation_gyra_primary,3.000000e-5
neisseria_meningitidis,mutation_gyra_parc_secondary,1.000000e-5
neisseria_meningitidis,protection_qnr,3.000000e-7
neisseria_meningitidis,enzyme_16s_rrmt,1.000000e-7
neisseria_meningitidis,target_site_erm_b,1.000000e-7
neisseria_meningitidis,target_site_cfr,2.000000e-7
neisseria_meningitidis,enzyme_cat,2.000000e-6
neisseria_meningitidis,efflux_acrab_tolc,3.000000e-7
neisseria_meningitidis,modification_mcr_1,3.000000e-7
neisseria_meningitidis,global_efflux_pump,2.000000e-6
neisseria_meningitidis,global_porin_loss,5.000000e-7
neisseria_meningitidis,mutation_folate_pathway,5.000000e-6
neisseria_meningitidis,mutation_nitroreductase,3.000000e-6
neisseria_meningitidis,mutation_rpo_b,3.000000e-6
neisseria_meningitidis,protection_tet_m,5.000000e-6
neisseria_meningitidis,mutation_23s_rrna,1.000000e-7
neisseria_meningitidis,efflux_tet_abc,5.000000e-6
neisseria_meningitidis,mutation_pbp_mosaic,1.000000e-4
neisseria_meningitidis,efflux_mtr_cde,1.000000e-7
listeria_monocytogenes,target_site_van_a,3.800000e-6
listeria_monocytogenes,target_site_van_b,3.800000e-6
listeria_monocytogenes,mutation_gyra_primary,1.900000e-4
listeria_monocytogenes,mutation_gyra_parc_secondary,3.800000e-5
listeria_monocytogenes,target_site_erm_b,3.800000e-4
listeria_monocytogenes,target_site_cfr,3.800000e-6
listeria_monocytogenes,enzyme_cat,1.900000e-4
listeria_monocytogenes,global_efflux_pump,1.900000e-4
listeria_monocytogenes,mutation_folate_pathway,3.800000e-4
listeria_monocytogenes,mutation_mpr_f,3.800000e-5
listeria_monocytogenes,mutation_rpo_b,3.800000e-5
listeria_monocytogenes,protection_fus_b,3.800000e-5
listeria_monocytogenes,protection_tet_m,1.900000e-3
clostridioides_difficile,mutation_gyra_primary,3.000000e-5
clostridioides_difficile,mutation_gyra_parc_secondary,6.000000e-6
clostridioides_difficile,enzyme_16s_rrmt,6.000000e-8
clostridioides_difficile,target_site_erm_b,3.000000e-5
clostridioides_difficile,target_site_cfr,6.000000e-7
clostridioides_difficile,enzyme_cat,6.000000e-6
clostridioides_difficile,global_efflux_pump,6.000000e-6
clostridioides_difficile,mutation_folate_pathway,3.000000e-6
clostridioides_difficile,mutation_nitroreductase,6.000000e-5
clostridioides_difficile,mutation_rpo_b,3.000000e-5
clostridioides_difficile,protection_tet_m,6.000000e-5
bacteroides_fragilis,enzyme_esbl_ctx_m,0.08
bacteroides_fragilis,enzyme_esbl_tem,0.08
bacteroides_fragilis,enzyme_esbl_shv,0.08
bacteroides_fragilis,enzyme_kpc,5.000000e-5
bacteroides_fragilis,enzyme_ndm_vim,2.000000e-4
bacteroides_fragilis,enzyme_oxa_48,1.000000e-4
bacteroides_fragilis,enzyme_ampc_cmy,3.000000e-4
bacteroides_fragilis,enzyme_ampc_dha,3.000000e-4
bacteroides_fragilis,mutation_gyra_primary,5.000000e-4
bacteroides_fragilis,mutation_gyra_parc_secondary,0.015
bacteroides_fragilis,protection_qnr,3.000000e-4
bacteroides_fragilis,enzyme_16s_rrmt,0.5
bacteroides_fragilis,target_site_erm_b,0.04
bacteroides_fragilis,target_site_cfr,3.000000e-4
bacteroides_fragilis,enzyme_cat,2.000000e-5
bacteroides_fragilis,efflux_acrab_tolc,2.000000e-4
bacteroides_fragilis,modification_mcr_1,5.000000e-3
bacteroides_fragilis,global_efflux_pump,2.000000e-4
bacteroides_fragilis,global_porin_loss,3.000000e-5
bacteroides_fragilis,mutation_folate_pathway,0.01
bacteroides_fragilis,mutation_nitroreductase,1.000000e-3
bacteroides_fragilis,mutation_rpo_b,5.000000e-3
bacteroides_fragilis,protection_tet_m,0.015
bacteroides_fragilis,enzyme_aac_aph,0.5
bacteroides_fragilis,mutation_pbp_mosaic,3.000000e-4
campylobacter_jejuni,mutation_gyra_primary,2.500000e-3
campylobacter_jejuni,mutation_gyra_parc_secondary,3.500000e-3
campylobacter_jejuni,target_site_erm_b,1.300000e-6
campylobacter_jejuni,target_site_cfr,1.300000e-6
campylobacter_jejuni,enzyme_cat,1.300000e-4
campylobacter_jejuni,global_efflux_pump,1.500000e-6
campylobacter_jejuni,global_porin_loss,3.500000e-6
campylobacter_jejuni,mutation_folate_pathway,0.13
campylobacter_jejuni,mutation_rpo_b,0.13
campylobacter_jejuni,protection_tet_m,7.000000e-5
campylobacter_jejuni,enzyme_aac_aph,0.013
campylobacter_jejuni,mutation_23s_rrna,1.000000e-7
campylobacter_jejuni,efflux_tet_abc,3.500000e-6
campylobacter_jejuni,efflux_mtr_cde,1.300000e-5
enterobacter_cloacae,enzyme_esbl_ctx_m,1.000000e-4
enterobacter_cloacae,enzyme_esbl_tem,1.000000e-4
enterobacter_cloacae,enzyme_esbl_shv,1.000000e-4
enterobacter_cloacae,enzyme_kpc,1.000000e-4
enterobacter_cloacae,enzyme_ndm_vim,1.000000e-4
enterobacter_cloacae,enzyme_oxa_48,1.000000e-4
enterobacter_cloacae,enzyme_ampc_cmy,1.000000e-4
enterobacter_cloacae,enzyme_ampc_dha,1.000000e-4
enterobacter_cloacae,mutation_gyra_primary,3.000000e-4
enterobacter_cloacae,mutation_gyra_parc_secondary,3.000000e-4
enterobacter_cloacae,protection_qnr,3.000000e-4
enterobacter_cloacae,enzyme_16s_rrmt,0.05
enterobacter_cloacae,enzyme_cat,1.000000e-3
enterobacter_cloacae,efflux_acrab_tolc,1.000000e-4
enterobacter_cloacae,modification_mcr_1,5.000000e-3
enterobacter_cloacae,global_porin_loss,1.000000e-7
enterobacter_cloacae,mutation_folate_pathway,5.000000e-5
enterobacter_cloacae,mutation_nitroreductase,1.000000e-3
enterobacter_cloacae,enzyme_fos_a,1.000000e-3
enterobacter_cloacae,mutation_rpo_b,0.01
enterobacter_cloacae,protection_tet_m,1.000000e-3
enterobacter_cloacae,enzyme_aac_aph,0.05
enterobacter_cloacae,efflux_tet_abc,1.000000e-4
enterobacter_cloacae,mutation_pbp_mosaic,1.000000e-7
yersinia_enterocolitica,enzyme_esbl_ctx_m,1.000000e-1
yersinia_enterocolitica,enzyme_esbl_tem,1.000000e-1
yersinia_enterocolitica,enzyme_esbl_shv,3.000000e-11
yersinia_enterocolitica,enzyme_kpc,1.000000e-11
yersinia_enterocolitica,enzyme_ndm_vim,1.000000e-11
yersinia_enterocolitica,enzyme_oxa_48,1.000000e-11
yersinia_enterocolitica,enzyme_ampc_cmy,1.000000e-1
yersinia_enterocolitica,enzyme_ampc_dha,1.000000e-1
yersinia_enterocolitica,mutation_gyra_primary,1.000000e-1
yersinia_enterocolitica,mutation_gyra_parc_secondary,1.000000e-1
yersinia_enterocolitica,protection_qnr,1.000000e-1
yersinia_enterocolitica,enzyme_16s_rrmt,1.000000e-11
yersinia_enterocolitica,enzyme_cat,1.000000e-1
yersinia_enterocolitica,efflux_acrab_tolc,1.000000e-1
yersinia_enterocolitica,modification_mcr_1,1.000000e-1
yersinia_enterocolitica,global_efflux_pump,1.000000e-1
yersinia_enterocolitica,global_porin_loss,3.000000e-11
yersinia_enterocolitica,mutation_folate_pathway,1.000000e-1
yersinia_enterocolitica,mutation_nitroreductase,3.000000e-1
yersinia_enterocolitica,enzyme_fos_a,1.000000e-1
yersinia_enterocolitica,mutation_rpo_b,1.000000e-11
yersinia_enterocolitica,protection_tet_m,1.000000e-1
yersinia_enterocolitica,enzyme_aac_aph,5.000000e-11
yersinia_enterocolitica,efflux_tet_abc,5.000000e-11
yersinia_enterocolitica,efflux_mtr_cde,1.000000e-1
moraxella_catarrhalis,enzyme_esbl_ctx_m,1.000000e-7
moraxella_catarrhalis,enzyme_esbl_tem,3.000000e-6
moraxella_catarrhalis,enzyme_esbl_shv,1.000000e-8
moraxella_catarrhalis,enzyme_ampc_cmy,3.000000e-7
moraxella_catarrhalis,enzyme_ampc_dha,1.000000e-7
moraxella_catarrhalis,mutation_gyra_primary,1.000000e-6
moraxella_catarrhalis,mutation_gyra_parc_secondary,3.000000e-7
moraxella_catarrhalis,protection_qnr,1.000000e-7
moraxella_catarrhalis,enzyme_16s_rrmt,1.000000e-8
moraxella_catarrhalis,target_site_erm_b,3.000000e-6
moraxella_catarrhalis,target_site_cfr,3.000000e-8
moraxella_catarrhalis,enzyme_cat,3.000000e-7
moraxella_catarrhalis,efflux_acrab_tolc,3.000000e-7
moraxella_catarrhalis,modification_mcr_1,1.000000e-8
moraxella_catarrhalis,global_efflux_pump,3.000000e-6
moraxella_catarrhalis,global_porin_loss,1.000000e-7
moraxella_catarrhalis,mutation_folate_pathway,5.000000e-6
moraxella_catarrhalis,mutation_nitroreductase,1.000000e-7
moraxella_catarrhalis,mutation_rpo_b,1.000000e-7
moraxella_catarrhalis,protection_tet_m,5.000000e-6
moraxella_catarrhalis,mutation_pbp_mosaic,3.000000e-6
moraxella_catarrhalis,efflux_mtr_cde,3.000000e-7
treponema_pallidum,mutation_gyra_primary,1.500000e-6
treponema_pallidum,mutation_gyra_parc_secondary,7.500000e-7
treponema_pallidum,enzyme_cat,1.500000e-7
treponema_pallidum,global_efflux_pump,1.500000e-7
treponema_pallidum,mutation_folate_pathway,1.500000e-7
treponema_pallidum,mutation_rpo_b,1.500000e-7
treponema_pallidum,protection_tet_m,1.500000e-6
bordetella_pertussis,enzyme_esbl_ctx_m,1.000000e-1
bordetella_pertussis,enzyme_esbl_tem,1.000000e-1
bordetella_pertussis,enzyme_esbl_shv,1.000000e-1
bordetella_pertussis,enzyme_ampc_cmy,1.000000e-1
bordetella_pertussis,enzyme_ampc_dha,1.000000e-1
bordetella_pertussis,mutation_gyra_primary,2.000000e-12
bordetella_pertussis,mutation_gyra_parc_secondary,1.000000e-12
bordetella_pertussis,enzyme_16s_rrmt,1.000000e-1
bordetella_pertussis,target_site_cfr,5.000000e-11
bordetella_pertussis,enzyme_cat,3.800000e-12
bordetella_pertussis,efflux_acrab_tolc,1.000000e-12
bordetella_pertussis,global_efflux_pump,5.000000e-12
bordetella_pertussis,global_porin_loss,1.000000e-12
bordetella_pertussis,mutation_folate_pathway,1.000000e-11
bordetella_pertussis,mutation_nitroreductase,1.000000e-1
bordetella_pertussis,mutation_rpo_b,1.000000e-12
bordetella_pertussis,protection_tet_m,1.000000e-11
bordetella_pertussis,efflux_mtr_cde,2.000000e-12
helicobacter_pylori,mutation_gyra_primary,1.000000e6
helicobacter_pylori,mutation_gyra_parc_secondary,1.000000e6
helicobacter_pylori,target_site_erm_b,1.000000e6
helicobacter_pylori,target_site_cfr,1.000000e6
helicobacter_pylori,global_efflux_pump,1.000000e6
helicobacter_pylori,global_porin_loss,1.000000e6
helicobacter_pylori,mutation_folate_pathway,1.000000e6
helicobacter_pylori,mutation_nitroreductase,1.000000e6
helicobacter_pylori,mutation_rpo_b,1.000000e6
helicobacter_pylori,protection_tet_m,1.000000e6
helicobacter_pylori,enzyme_bla_z,1.000000e6
helicobacter_pylori,mutation_23s_rrna,1.000000e6
helicobacter_pylori,mutation_pbp_mosaic,1.000000e6
mycoplasma_pneumoniae,mutation_gyra_primary,3.000000e-7
mycoplasma_pneumoniae,mutation_gyra_parc_secondary,1.500000e-7
mycoplasma_pneumoniae,target_site_erm_b,1.500000e-5
mycoplasma_pneumoniae,target_site_cfr,3.000000e-9
mycoplasma_pneumoniae,enzyme_cat,3.000000e-9
mycoplasma_pneumoniae,global_efflux_pump,1.500000e-7
mycoplasma_pneumoniae,mutation_folate_pathway,3.000000e-9
mycoplasma_pneumoniae,mutation_nitroreductase,3.000000e-9
mycoplasma_pneumoniae,mutation_rpo_b,3.000000e-8
mycoplasma_pneumoniae,protection_tet_m,3.000000e-7
mycoplasma_pneumoniae,mutation_23s_rrna,5.000000e-9
legionella_pneumophila,enzyme_esbl_ctx_m,3.000000e-7
legionella_pneumophila,enzyme_esbl_tem,3.000000e-7
legionella_pneumophila,enzyme_esbl_shv,3.000000e-7
legionella_pneumophila,enzyme_ampc_cmy,3.000000e-7
legionella_pneumophila,enzyme_ampc_dha,3.000000e-7
legionella_pneumophila,mutation_gyra_primary,3.000000e-5
legionella_pneumophila,mutation_gyra_parc_secondary,3.000000e-5
legionella_pneumophila,protection_qnr,1.000000e-7
legionella_pneumophila,enzyme_16s_rrmt,3.000000e-7
legionella_pneumophila,target_site_erm_b,3.000000e-5
legionella_pneumophila,target_site_cfr,3.000000e-7
legionella_pneumophila,enzyme_cat,3.000000e-6
legionella_pneumophila,efflux_acrab_tolc,3.000000e-7
legionella_pneumophila,modification_mcr_1,3.000000e-7
legionella_pneumophila,global_efflux_pump,3.000000e-5
legionella_pneumophila,global_porin_loss,1.000000e-6
legionella_pneumophila,mutation_folate_pathway,3.000000e-6
legionella_pneumophila,mutation_nitroreductase,3.000000e-7
legionella_pneumophila,mutation_rpo_b,3.000000e-6
legionella_pneumophila,protection_tet_m,3.000000e-5
legionella_pneumophila,mutation_23s_rrna,5.000000e-11
burkholderia_cepacia_complex,enzyme_esbl_ctx_m,7.500000e-6
burkholderia_cepacia_complex,enzyme_esbl_tem,7.500000e-6
burkholderia_cepacia_complex,enzyme_esbl_shv,7.500000e-6
burkholderia_cepacia_complex,enzyme_kpc,7.500000e-6
burkholderia_cepacia_complex,enzyme_ndm_vim,3.700000e-5
burkholderia_cepacia_complex,enzyme_oxa_48,7.500000e-6
burkholderia_cepacia_complex,enzyme_ampc_cmy,3.800000e-4
burkholderia_cepacia_complex,enzyme_ampc_dha,7.500000e-5
burkholderia_cepacia_complex,mutation_gyra_primary,3.800000e-4
burkholderia_cepacia_complex,mutation_gyra_parc_secondary,7.500000e-5
burkholderia_cepacia_complex,protection_qnr,7.500000e-6
burkholderia_cepacia_complex,enzyme_16s_rrmt,7.500000e-6
burkholderia_cepacia_complex,enzyme_cat,3.700000e-5
burkholderia_cepacia_complex,modification_mcr_1,7.500000e-6
burkholderia_cepacia_complex,global_efflux_pump,7.500000e-4
burkholderia_cepacia_complex,global_porin_loss,3.800000e-4
burkholderia_cepacia_complex,mutation_folate_pathway,7.500000e-5
burkholderia_cepacia_complex,enzyme_fos_a,3.700000e-5
burkholderia_cepacia_complex,mutation_rpo_b,7.500000e-6
burkholderia_cepacia_complex,protection_tet_m,3.700000e-5
burkholderia_cepacia_complex,enzyme_aac_aph,5.000000e-11
burkholderia_cepacia_complex,efflux_tet_abc,5.000000e-11
```
...
```csv
donor_bacteria,recipient_bacteria,probability_per_day
acinetobacter_baumannii,citrobacter_spp.,1.000000e-1
acinetobacter_baumannii,enterobacter_spp.,1.000000e-1
acinetobacter_baumannii,escherichia_coli,1.000000e-1
acinetobacter_baumannii,klebsiella_pneumoniae,1.000000e-1
acinetobacter_baumannii,morganella_spp.,1.000000e-1
acinetobacter_baumannii,proteus_spp.,1.000000e-1
acinetobacter_baumannii,serratia_spp.,1.000000e-1
acinetobacter_baumannii,p_stuartii,1.000000e-1
acinetobacter_baumannii,pseudomonas_aeruginosa,1.000000e-9
acinetobacter_baumannii,stenotrophomonas_maltophilia,1.000000e-9
acinetobacter_baumannii,salmonella_enterica_serovar_typhi,1.000000e-1
acinetobacter_baumannii,salmonella_enterica_serovar_paratyphi_a,1.000000e-1
acinetobacter_baumannii,invasive_non-typhoidal_salmonella_spp.,1.000000e-1
acinetobacter_baumannii,shigella_spp.,1.000000e-1
acinetobacter_baumannii,neisseria_gonorrhoeae,3.000000e-11
acinetobacter_baumannii,haemophilus_influenzae,3.000000e-11
acinetobacter_baumannii,chlamydia_trachomatis,3.000000e-11
acinetobacter_baumannii,mycoplasma_genitalium,3.000000e-11
acinetobacter_baumannii,vibrio_cholerae,1.000000e-1
acinetobacter_baumannii,neisseria_meningitidis,3.000000e-11
acinetobacter_baumannii,clostridioides_difficile,3.000000e-11
acinetobacter_baumannii,bacteroides_fragilis,3.000000e-11
acinetobacter_baumannii,enterobacter_cloacae,1.000000e-1
acinetobacter_baumannii,yersinia_enterocolitica,1.000000e-1
acinetobacter_baumannii,moraxella_catarrhalis,3.000000e-11
acinetobacter_baumannii,bordetella_pertussis,3.000000e-11
acinetobacter_baumannii,mycoplasma_pneumoniae,3.000000e-11
acinetobacter_baumannii,legionella_pneumophila,3.000000e-11
acinetobacter_baumannii,burkholderia_cepacia_complex,1.000000e-9
citrobacter_spp.,acinetobacter_baumannii,1.000000e-1
citrobacter_spp.,enterobacter_spp.,1.000000e-9
citrobacter_spp.,escherichia_coli,1.000000e-9
citrobacter_spp.,klebsiella_pneumoniae,1.000000e-9
citrobacter_spp.,morganella_spp.,1.000000e-9
citrobacter_spp.,proteus_spp.,1.000000e-9
citrobacter_spp.,serratia_spp.,1.000000e-9
citrobacter_spp.,p_stuartii,1.000000e-9
citrobacter_spp.,pseudomonas_aeruginosa,1.000000e-1
citrobacter_spp.,stenotrophomonas_maltophilia,1.000000e-1
citrobacter_spp.,salmonella_enterica_serovar_typhi,1.000000e-9
citrobacter_spp.,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
citrobacter_spp.,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
citrobacter_spp.,shigella_spp.,1.000000e-9
citrobacter_spp.,neisseria_gonorrhoeae,3.000000e-11
citrobacter_spp.,haemophilus_influenzae,3.000000e-11
citrobacter_spp.,chlamydia_trachomatis,3.000000e-11
citrobacter_spp.,mycoplasma_genitalium,3.000000e-11
citrobacter_spp.,vibrio_cholerae,1.000000e-1
citrobacter_spp.,neisseria_meningitidis,3.000000e-11
citrobacter_spp.,clostridioides_difficile,3.000000e-11
citrobacter_spp.,bacteroides_fragilis,3.000000e-11
citrobacter_spp.,enterobacter_cloacae,1.000000e-9
citrobacter_spp.,yersinia_enterocolitica,1.000000e-9
citrobacter_spp.,moraxella_catarrhalis,3.000000e-11
citrobacter_spp.,bordetella_pertussis,3.000000e-11
citrobacter_spp.,mycoplasma_pneumoniae,3.000000e-11
citrobacter_spp.,legionella_pneumophila,3.000000e-11
citrobacter_spp.,burkholderia_cepacia_complex,1.000000e-1
enterobacter_spp.,acinetobacter_baumannii,1.000000e-1
enterobacter_spp.,citrobacter_spp.,1.000000e-9
enterobacter_spp.,escherichia_coli,1.000000e-9
enterobacter_spp.,klebsiella_pneumoniae,1.000000e-9
enterobacter_spp.,morganella_spp.,1.000000e-9
enterobacter_spp.,proteus_spp.,1.000000e-9
enterobacter_spp.,serratia_spp.,1.000000e-9
enterobacter_spp.,p_stuartii,1.000000e-9
enterobacter_spp.,pseudomonas_aeruginosa,1.000000e-1
enterobacter_spp.,stenotrophomonas_maltophilia,1.000000e-1
enterobacter_spp.,salmonella_enterica_serovar_typhi,1.000000e-9
enterobacter_spp.,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
enterobacter_spp.,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
enterobacter_spp.,shigella_spp.,1.000000e-9
enterobacter_spp.,neisseria_gonorrhoeae,3.000000e-11
enterobacter_spp.,haemophilus_influenzae,3.000000e-11
enterobacter_spp.,chlamydia_trachomatis,3.000000e-11
enterobacter_spp.,mycoplasma_genitalium,3.000000e-11
enterobacter_spp.,vibrio_cholerae,1.000000e-1
enterobacter_spp.,neisseria_meningitidis,3.000000e-11
enterobacter_spp.,clostridioides_difficile,3.000000e-11
enterobacter_spp.,bacteroides_fragilis,3.000000e-11
enterobacter_spp.,enterobacter_cloacae,1.000000e-9
enterobacter_spp.,yersinia_enterocolitica,1.000000e-9
enterobacter_spp.,moraxella_catarrhalis,3.000000e-11
enterobacter_spp.,bordetella_pertussis,3.000000e-11
enterobacter_spp.,mycoplasma_pneumoniae,3.000000e-11
enterobacter_spp.,legionella_pneumophila,3.000000e-11
enterobacter_spp.,burkholderia_cepacia_complex,1.000000e-1
enterococcus_faecalis,enterococcus_faecium,1.000000e-9
enterococcus_faecalis,staphylococcus_aureus,1.000000e-9
enterococcus_faecalis,staphylococcus_epidermidis,1.000000e-9
enterococcus_faecalis,streptococcus_pneumoniae,1.000000e-9
enterococcus_faecalis,streptococcus_pyogenes,1.000000e-9
enterococcus_faecalis,streptococcus_agalactiae,1.000000e-9
enterococcus_faecalis,listeria_monocytogenes,1.000000e-9
enterococcus_faecium,enterococcus_faecalis,1.000000e-9
enterococcus_faecium,staphylococcus_aureus,1.000000e-9
enterococcus_faecium,staphylococcus_epidermidis,1.000000e-9
enterococcus_faecium,streptococcus_pneumoniae,1.000000e-9
enterococcus_faecium,streptococcus_pyogenes,1.000000e-9
enterococcus_faecium,streptococcus_agalactiae,1.000000e-9
enterococcus_faecium,listeria_monocytogenes,1.000000e-9
escherichia_coli,acinetobacter_baumannii,1.000000e-1
escherichia_coli,citrobacter_spp.,1.000000e-9
escherichia_coli,enterobacter_spp.,1.000000e-9
escherichia_coli,klebsiella_pneumoniae,1.000000e-9
escherichia_coli,morganella_spp.,1.000000e-9
escherichia_coli,proteus_spp.,1.000000e-9
escherichia_coli,serratia_spp.,1.000000e-9
escherichia_coli,p_stuartii,1.000000e-9
escherichia_coli,pseudomonas_aeruginosa,1.000000e-1
escherichia_coli,stenotrophomonas_maltophilia,1.000000e-1
escherichia_coli,salmonella_enterica_serovar_typhi,1.000000e-9
escherichia_coli,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
escherichia_coli,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
escherichia_coli,shigella_spp.,1.000000e-9
escherichia_coli,neisseria_gonorrhoeae,3.000000e-11
escherichia_coli,haemophilus_influenzae,3.000000e-11
escherichia_coli,chlamydia_trachomatis,3.000000e-11
escherichia_coli,mycoplasma_genitalium,3.000000e-11
escherichia_coli,vibrio_cholerae,1.000000e-1
escherichia_coli,neisseria_meningitidis,3.000000e-11
escherichia_coli,clostridioides_difficile,3.000000e-11
escherichia_coli,bacteroides_fragilis,3.000000e-11
escherichia_coli,enterobacter_cloacae,1.000000e-9
escherichia_coli,yersinia_enterocolitica,1.000000e-9
escherichia_coli,moraxella_catarrhalis,3.000000e-11
escherichia_coli,bordetella_pertussis,3.000000e-11
escherichia_coli,mycoplasma_pneumoniae,3.000000e-11
escherichia_coli,legionella_pneumophila,3.000000e-11
escherichia_coli,burkholderia_cepacia_complex,1.000000e-1
klebsiella_pneumoniae,acinetobacter_baumannii,1.000000e-1
klebsiella_pneumoniae,citrobacter_spp.,1.000000e-9
klebsiella_pneumoniae,enterobacter_spp.,1.000000e-9
klebsiella_pneumoniae,escherichia_coli,1.000000e-9
klebsiella_pneumoniae,morganella_spp.,1.000000e-9
klebsiella_pneumoniae,proteus_spp.,1.000000e-9
klebsiella_pneumoniae,serratia_spp.,1.000000e-9
klebsiella_pneumoniae,p_stuartii,1.000000e-9
klebsiella_pneumoniae,pseudomonas_aeruginosa,1.000000e-1
klebsiella_pneumoniae,stenotrophomonas_maltophilia,1.000000e-1
klebsiella_pneumoniae,salmonella_enterica_serovar_typhi,1.000000e-9
klebsiella_pneumoniae,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
klebsiella_pneumoniae,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
klebsiella_pneumoniae,shigella_spp.,1.000000e-9
klebsiella_pneumoniae,neisseria_gonorrhoeae,3.000000e-11
klebsiella_pneumoniae,haemophilus_influenzae,3.000000e-11
klebsiella_pneumoniae,chlamydia_trachomatis,3.000000e-11
klebsiella_pneumoniae,mycoplasma_genitalium,3.000000e-11
klebsiella_pneumoniae,vibrio_cholerae,1.000000e-1
klebsiella_pneumoniae,neisseria_meningitidis,3.000000e-11
klebsiella_pneumoniae,clostridioides_difficile,3.000000e-11
klebsiella_pneumoniae,bacteroides_fragilis,3.000000e-11
klebsiella_pneumoniae,enterobacter_cloacae,1.000000e-9
klebsiella_pneumoniae,yersinia_enterocolitica,1.000000e-9
klebsiella_pneumoniae,moraxella_catarrhalis,3.000000e-11
klebsiella_pneumoniae,bordetella_pertussis,3.000000e-11
klebsiella_pneumoniae,mycoplasma_pneumoniae,3.000000e-11
klebsiella_pneumoniae,legionella_pneumophila,3.000000e-11
klebsiella_pneumoniae,burkholderia_cepacia_complex,1.000000e-1
morganella_spp.,acinetobacter_baumannii,1.000000e-1
morganella_spp.,citrobacter_spp.,1.000000e-9
morganella_spp.,enterobacter_spp.,1.000000e-9
morganella_spp.,escherichia_coli,1.000000e-9
morganella_spp.,klebsiella_pneumoniae,1.000000e-9
morganella_spp.,proteus_spp.,1.000000e-9
morganella_spp.,serratia_spp.,1.000000e-9
morganella_spp.,p_stuartii,1.000000e-9
morganella_spp.,pseudomonas_aeruginosa,1.000000e-1
morganella_spp.,stenotrophomonas_maltophilia,1.000000e-1
morganella_spp.,salmonella_enterica_serovar_typhi,1.000000e-9
morganella_spp.,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
morganella_spp.,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
morganella_spp.,shigella_spp.,1.000000e-9
morganella_spp.,neisseria_gonorrhoeae,3.000000e-11
morganella_spp.,haemophilus_influenzae,3.000000e-11
morganella_spp.,chlamydia_trachomatis,3.000000e-11
morganella_spp.,mycoplasma_genitalium,3.000000e-11
morganella_spp.,vibrio_cholerae,1.000000e-1
morganella_spp.,neisseria_meningitidis,3.000000e-11
morganella_spp.,clostridioides_difficile,3.000000e-11
morganella_spp.,bacteroides_fragilis,3.000000e-11
morganella_spp.,enterobacter_cloacae,1.000000e-9
morganella_spp.,yersinia_enterocolitica,1.000000e-9
morganella_spp.,moraxella_catarrhalis,3.000000e-11
morganella_spp.,bordetella_pertussis,3.000000e-11
morganella_spp.,mycoplasma_pneumoniae,3.000000e-11
morganella_spp.,legionella_pneumophila,3.000000e-11
morganella_spp.,burkholderia_cepacia_complex,1.000000e-1
proteus_spp.,acinetobacter_baumannii,1.000000e-1
proteus_spp.,citrobacter_spp.,1.000000e-9
proteus_spp.,enterobacter_spp.,1.000000e-9
proteus_spp.,escherichia_coli,1.000000e-9
proteus_spp.,klebsiella_pneumoniae,1.000000e-9
proteus_spp.,morganella_spp.,1.000000e-9
proteus_spp.,serratia_spp.,1.000000e-9
proteus_spp.,p_stuartii,1.000000e-9
proteus_spp.,pseudomonas_aeruginosa,1.000000e-1
proteus_spp.,stenotrophomonas_maltophilia,1.000000e-1
proteus_spp.,salmonella_enterica_serovar_typhi,1.000000e-9
proteus_spp.,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
proteus_spp.,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
proteus_spp.,shigella_spp.,1.000000e-9
proteus_spp.,neisseria_gonorrhoeae,3.000000e-11
proteus_spp.,haemophilus_influenzae,3.000000e-11
proteus_spp.,chlamydia_trachomatis,3.000000e-11
proteus_spp.,mycoplasma_genitalium,3.000000e-11
proteus_spp.,vibrio_cholerae,1.000000e-1
proteus_spp.,neisseria_meningitidis,3.000000e-11
proteus_spp.,clostridioides_difficile,3.000000e-11
proteus_spp.,bacteroides_fragilis,3.000000e-11
proteus_spp.,enterobacter_cloacae,1.000000e-9
proteus_spp.,yersinia_enterocolitica,1.000000e-9
proteus_spp.,moraxella_catarrhalis,3.000000e-11
proteus_spp.,bordetella_pertussis,3.000000e-11
proteus_spp.,mycoplasma_pneumoniae,3.000000e-11
proteus_spp.,legionella_pneumophila,3.000000e-11
proteus_spp.,burkholderia_cepacia_complex,1.000000e-1
serratia_spp.,acinetobacter_baumannii,1.000000e-1
serratia_spp.,citrobacter_spp.,1.000000e-9
serratia_spp.,enterobacter_spp.,1.000000e-9
serratia_spp.,escherichia_coli,1.000000e-9
serratia_spp.,klebsiella_pneumoniae,1.000000e-9
serratia_spp.,morganella_spp.,1.000000e-9
serratia_spp.,proteus_spp.,1.000000e-9
serratia_spp.,p_stuartii,1.000000e-9
serratia_spp.,pseudomonas_aeruginosa,1.000000e-1
serratia_spp.,stenotrophomonas_maltophilia,1.000000e-1
serratia_spp.,salmonella_enterica_serovar_typhi,1.000000e-9
serratia_spp.,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
serratia_spp.,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
serratia_spp.,shigella_spp.,1.000000e-9
serratia_spp.,neisseria_gonorrhoeae,3.000000e-11
serratia_spp.,haemophilus_influenzae,3.000000e-11
serratia_spp.,chlamydia_trachomatis,3.000000e-11
serratia_spp.,mycoplasma_genitalium,3.000000e-11
serratia_spp.,vibrio_cholerae,1.000000e-1
serratia_spp.,neisseria_meningitidis,3.000000e-11
serratia_spp.,clostridioides_difficile,3.000000e-11
serratia_spp.,bacteroides_fragilis,3.000000e-11
serratia_spp.,enterobacter_cloacae,1.000000e-9
serratia_spp.,yersinia_enterocolitica,1.000000e-9
serratia_spp.,moraxella_catarrhalis,3.000000e-11
serratia_spp.,bordetella_pertussis,3.000000e-11
serratia_spp.,mycoplasma_pneumoniae,3.000000e-11
serratia_spp.,legionella_pneumophila,3.000000e-11
serratia_spp.,burkholderia_cepacia_complex,1.000000e-1
p_stuartii,acinetobacter_baumannii,1.000000e-1
p_stuartii,citrobacter_spp.,1.000000e-9
p_stuartii,enterobacter_spp.,1.000000e-9
p_stuartii,escherichia_coli,1.000000e-9
p_stuartii,klebsiella_pneumoniae,1.000000e-9
p_stuartii,morganella_spp.,1.000000e-9
p_stuartii,proteus_spp.,1.000000e-9
p_stuartii,serratia_spp.,1.000000e-9
p_stuartii,pseudomonas_aeruginosa,1.000000e-1
p_stuartii,stenotrophomonas_maltophilia,1.000000e-1
p_stuartii,salmonella_enterica_serovar_typhi,1.000000e-9
p_stuartii,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
p_stuartii,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
p_stuartii,shigella_spp.,1.000000e-9
p_stuartii,neisseria_gonorrhoeae,3.000000e-11
p_stuartii,haemophilus_influenzae,3.000000e-11
p_stuartii,chlamydia_trachomatis,3.000000e-11
p_stuartii,mycoplasma_genitalium,3.000000e-11
p_stuartii,vibrio_cholerae,1.000000e-1
p_stuartii,neisseria_meningitidis,3.000000e-11
p_stuartii,clostridioides_difficile,3.000000e-11
p_stuartii,bacteroides_fragilis,3.000000e-11
p_stuartii,enterobacter_cloacae,1.000000e-9
p_stuartii,yersinia_enterocolitica,1.000000e-9
p_stuartii,moraxella_catarrhalis,3.000000e-11
p_stuartii,bordetella_pertussis,3.000000e-11
p_stuartii,mycoplasma_pneumoniae,3.000000e-11
p_stuartii,legionella_pneumophila,3.000000e-11
p_stuartii,burkholderia_cepacia_complex,1.000000e-1
pseudomonas_aeruginosa,acinetobacter_baumannii,1.000000e-9
pseudomonas_aeruginosa,citrobacter_spp.,1.000000e-1
pseudomonas_aeruginosa,enterobacter_spp.,1.000000e-1
pseudomonas_aeruginosa,escherichia_coli,1.000000e-1
pseudomonas_aeruginosa,klebsiella_pneumoniae,1.000000e-1
pseudomonas_aeruginosa,morganella_spp.,1.000000e-1
pseudomonas_aeruginosa,proteus_spp.,1.000000e-1
pseudomonas_aeruginosa,serratia_spp.,1.000000e-1
pseudomonas_aeruginosa,p_stuartii,1.000000e-1
pseudomonas_aeruginosa,stenotrophomonas_maltophilia,1.000000e-9
pseudomonas_aeruginosa,salmonella_enterica_serovar_typhi,1.000000e-1
pseudomonas_aeruginosa,salmonella_enterica_serovar_paratyphi_a,1.000000e-1
pseudomonas_aeruginosa,invasive_non-typhoidal_salmonella_spp.,1.000000e-1
pseudomonas_aeruginosa,shigella_spp.,1.000000e-1
pseudomonas_aeruginosa,neisseria_gonorrhoeae,3.000000e-11
pseudomonas_aeruginosa,haemophilus_influenzae,3.000000e-11
pseudomonas_aeruginosa,chlamydia_trachomatis,3.000000e-11
pseudomonas_aeruginosa,mycoplasma_genitalium,3.000000e-11
pseudomonas_aeruginosa,vibrio_cholerae,1.000000e-1
pseudomonas_aeruginosa,neisseria_meningitidis,3.000000e-11
pseudomonas_aeruginosa,clostridioides_difficile,3.000000e-11
pseudomonas_aeruginosa,bacteroides_fragilis,3.000000e-11
pseudomonas_aeruginosa,enterobacter_cloacae,1.000000e-1
pseudomonas_aeruginosa,yersinia_enterocolitica,1.000000e-1
pseudomonas_aeruginosa,moraxella_catarrhalis,3.000000e-11
pseudomonas_aeruginosa,bordetella_pertussis,3.000000e-11
pseudomonas_aeruginosa,mycoplasma_pneumoniae,3.000000e-11
pseudomonas_aeruginosa,legionella_pneumophila,3.000000e-11
pseudomonas_aeruginosa,burkholderia_cepacia_complex,1.000000e-9
stenotrophomonas_maltophilia,acinetobacter_baumannii,1.000000e-9
stenotrophomonas_maltophilia,citrobacter_spp.,1.000000e-1
stenotrophomonas_maltophilia,enterobacter_spp.,1.000000e-1
stenotrophomonas_maltophilia,escherichia_coli,1.000000e-1
stenotrophomonas_maltophilia,klebsiella_pneumoniae,1.000000e-1
stenotrophomonas_maltophilia,morganella_spp.,1.000000e-1
stenotrophomonas_maltophilia,proteus_spp.,1.000000e-1
stenotrophomonas_maltophilia,serratia_spp.,1.000000e-1
stenotrophomonas_maltophilia,p_stuartii,1.000000e-1
stenotrophomonas_maltophilia,pseudomonas_aeruginosa,1.000000e-9
stenotrophomonas_maltophilia,salmonella_enterica_serovar_typhi,1.000000e-1
stenotrophomonas_maltophilia,salmonella_enterica_serovar_paratyphi_a,1.000000e-1
stenotrophomonas_maltophilia,invasive_non-typhoidal_salmonella_spp.,1.000000e-1
stenotrophomonas_maltophilia,shigella_spp.,1.000000e-1
stenotrophomonas_maltophilia,neisseria_gonorrhoeae,3.000000e-11
stenotrophomonas_maltophilia,haemophilus_influenzae,3.000000e-11
stenotrophomonas_maltophilia,chlamydia_trachomatis,3.000000e-11
stenotrophomonas_maltophilia,mycoplasma_genitalium,3.000000e-11
stenotrophomonas_maltophilia,vibrio_cholerae,1.000000e-1
stenotrophomonas_maltophilia,neisseria_meningitidis,3.000000e-11
stenotrophomonas_maltophilia,clostridioides_difficile,3.000000e-11
stenotrophomonas_maltophilia,bacteroides_fragilis,3.000000e-11
stenotrophomonas_maltophilia,enterobacter_cloacae,1.000000e-1
stenotrophomonas_maltophilia,yersinia_enterocolitica,1.000000e-1
stenotrophomonas_maltophilia,moraxella_catarrhalis,3.000000e-11
stenotrophomonas_maltophilia,bordetella_pertussis,3.000000e-11
stenotrophomonas_maltophilia,mycoplasma_pneumoniae,3.000000e-11
stenotrophomonas_maltophilia,legionella_pneumophila,3.000000e-11
stenotrophomonas_maltophilia,burkholderia_cepacia_complex,1.000000e-9
staphylococcus_aureus,enterococcus_faecalis,1.000000e-9
staphylococcus_aureus,enterococcus_faecium,1.000000e-9
staphylococcus_aureus,staphylococcus_epidermidis,1.000000e-9
staphylococcus_aureus,streptococcus_pneumoniae,1.000000e-9
staphylococcus_aureus,streptococcus_pyogenes,1.000000e-9
staphylococcus_aureus,streptococcus_agalactiae,1.000000e-9
staphylococcus_aureus,listeria_monocytogenes,1.000000e-9
staphylococcus_epidermidis,enterococcus_faecalis,1.000000e-9
staphylococcus_epidermidis,enterococcus_faecium,1.000000e-9
staphylococcus_epidermidis,staphylococcus_aureus,1.000000e-9
staphylococcus_epidermidis,streptococcus_pneumoniae,1.000000e-9
staphylococcus_epidermidis,streptococcus_pyogenes,1.000000e-9
staphylococcus_epidermidis,streptococcus_agalactiae,1.000000e-9
staphylococcus_epidermidis,listeria_monocytogenes,1.000000e-9
streptococcus_pneumoniae,enterococcus_faecalis,1.000000e-9
streptococcus_pneumoniae,enterococcus_faecium,1.000000e-9
streptococcus_pneumoniae,staphylococcus_aureus,1.000000e-9
streptococcus_pneumoniae,staphylococcus_epidermidis,1.000000e-9
streptococcus_pneumoniae,streptococcus_pyogenes,1.000000e-9
streptococcus_pneumoniae,streptococcus_agalactiae,1.000000e-9
streptococcus_pneumoniae,listeria_monocytogenes,1.000000e-9
salmonella_enterica_serovar_typhi,acinetobacter_baumannii,1.000000e-1
salmonella_enterica_serovar_typhi,citrobacter_spp.,1.000000e-9
salmonella_enterica_serovar_typhi,enterobacter_spp.,1.000000e-9
salmonella_enterica_serovar_typhi,escherichia_coli,1.000000e-9
salmonella_enterica_serovar_typhi,klebsiella_pneumoniae,1.000000e-9
salmonella_enterica_serovar_typhi,morganella_spp.,1.000000e-9
salmonella_enterica_serovar_typhi,proteus_spp.,1.000000e-9
salmonella_enterica_serovar_typhi,serratia_spp.,1.000000e-9
salmonella_enterica_serovar_typhi,p_stuartii,1.000000e-9
salmonella_enterica_serovar_typhi,pseudomonas_aeruginosa,1.000000e-1
salmonella_enterica_serovar_typhi,stenotrophomonas_maltophilia,1.000000e-1
salmonella_enterica_serovar_typhi,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
salmonella_enterica_serovar_typhi,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
salmonella_enterica_serovar_typhi,shigella_spp.,1.000000e-9
salmonella_enterica_serovar_typhi,neisseria_gonorrhoeae,3.000000e-11
salmonella_enterica_serovar_typhi,haemophilus_influenzae,3.000000e-11
salmonella_enterica_serovar_typhi,chlamydia_trachomatis,3.000000e-11
salmonella_enterica_serovar_typhi,mycoplasma_genitalium,3.000000e-11
salmonella_enterica_serovar_typhi,vibrio_cholerae,1.000000e-1
salmonella_enterica_serovar_typhi,neisseria_meningitidis,3.000000e-11
salmonella_enterica_serovar_typhi,clostridioides_difficile,3.000000e-11
salmonella_enterica_serovar_typhi,bacteroides_fragilis,3.000000e-11
salmonella_enterica_serovar_typhi,enterobacter_cloacae,1.000000e-9
salmonella_enterica_serovar_typhi,yersinia_enterocolitica,1.000000e-9
salmonella_enterica_serovar_typhi,moraxella_catarrhalis,3.000000e-11
salmonella_enterica_serovar_typhi,bordetella_pertussis,3.000000e-11
salmonella_enterica_serovar_typhi,mycoplasma_pneumoniae,3.000000e-11
salmonella_enterica_serovar_typhi,legionella_pneumophila,3.000000e-11
salmonella_enterica_serovar_typhi,burkholderia_cepacia_complex,1.000000e-1
salmonella_enterica_serovar_paratyphi_a,acinetobacter_baumannii,1.000000e-1
salmonella_enterica_serovar_paratyphi_a,citrobacter_spp.,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,enterobacter_spp.,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,escherichia_coli,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,klebsiella_pneumoniae,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,morganella_spp.,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,proteus_spp.,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,serratia_spp.,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,p_stuartii,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,pseudomonas_aeruginosa,1.000000e-1
salmonella_enterica_serovar_paratyphi_a,stenotrophomonas_maltophilia,1.000000e-1
salmonella_enterica_serovar_paratyphi_a,salmonella_enterica_serovar_typhi,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,shigella_spp.,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,neisseria_gonorrhoeae,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,haemophilus_influenzae,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,chlamydia_trachomatis,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,mycoplasma_genitalium,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,vibrio_cholerae,1.000000e-1
salmonella_enterica_serovar_paratyphi_a,neisseria_meningitidis,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,clostridioides_difficile,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,bacteroides_fragilis,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,enterobacter_cloacae,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,yersinia_enterocolitica,1.000000e-9
salmonella_enterica_serovar_paratyphi_a,moraxella_catarrhalis,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,bordetella_pertussis,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,mycoplasma_pneumoniae,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,legionella_pneumophila,3.000000e-11
salmonella_enterica_serovar_paratyphi_a,burkholderia_cepacia_complex,1.000000e-1
invasive_non-typhoidal_salmonella_spp.,acinetobacter_baumannii,1.000000e-1
invasive_non-typhoidal_salmonella_spp.,citrobacter_spp.,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,enterobacter_spp.,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,escherichia_coli,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,klebsiella_pneumoniae,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,morganella_spp.,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,proteus_spp.,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,serratia_spp.,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,p_stuartii,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,pseudomonas_aeruginosa,1.000000e-1
invasive_non-typhoidal_salmonella_spp.,stenotrophomonas_maltophilia,1.000000e-1
invasive_non-typhoidal_salmonella_spp.,salmonella_enterica_serovar_typhi,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,shigella_spp.,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,neisseria_gonorrhoeae,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,haemophilus_influenzae,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,chlamydia_trachomatis,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,mycoplasma_genitalium,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,vibrio_cholerae,1.000000e-1
invasive_non-typhoidal_salmonella_spp.,neisseria_meningitidis,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,clostridioides_difficile,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,bacteroides_fragilis,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,enterobacter_cloacae,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,yersinia_enterocolitica,1.000000e-9
invasive_non-typhoidal_salmonella_spp.,moraxella_catarrhalis,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,bordetella_pertussis,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,mycoplasma_pneumoniae,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,legionella_pneumophila,3.000000e-11
invasive_non-typhoidal_salmonella_spp.,burkholderia_cepacia_complex,1.000000e-1
shigella_spp.,acinetobacter_baumannii,1.000000e-1
shigella_spp.,citrobacter_spp.,1.000000e-9
shigella_spp.,enterobacter_spp.,1.000000e-9
shigella_spp.,escherichia_coli,1.000000e-9
shigella_spp.,klebsiella_pneumoniae,1.000000e-9
shigella_spp.,morganella_spp.,1.000000e-9
shigella_spp.,proteus_spp.,1.000000e-9
shigella_spp.,serratia_spp.,1.000000e-9
shigella_spp.,p_stuartii,1.000000e-9
shigella_spp.,pseudomonas_aeruginosa,1.000000e-1
shigella_spp.,stenotrophomonas_maltophilia,1.000000e-1
shigella_spp.,salmonella_enterica_serovar_typhi,1.000000e-9
shigella_spp.,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
shigella_spp.,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
shigella_spp.,neisseria_gonorrhoeae,3.000000e-11
shigella_spp.,haemophilus_influenzae,3.000000e-11
shigella_spp.,chlamydia_trachomatis,3.000000e-11
shigella_spp.,mycoplasma_genitalium,3.000000e-11
shigella_spp.,vibrio_cholerae,1.000000e-1
shigella_spp.,neisseria_meningitidis,3.000000e-11
shigella_spp.,clostridioides_difficile,3.000000e-11
shigella_spp.,bacteroides_fragilis,3.000000e-11
shigella_spp.,enterobacter_cloacae,1.000000e-9
shigella_spp.,yersinia_enterocolitica,1.000000e-9
shigella_spp.,moraxella_catarrhalis,3.000000e-11
shigella_spp.,bordetella_pertussis,3.000000e-11
shigella_spp.,mycoplasma_pneumoniae,3.000000e-11
shigella_spp.,legionella_pneumophila,3.000000e-11
shigella_spp.,burkholderia_cepacia_complex,1.000000e-1
neisseria_gonorrhoeae,acinetobacter_baumannii,3.000000e-11
neisseria_gonorrhoeae,citrobacter_spp.,3.000000e-11
neisseria_gonorrhoeae,enterobacter_spp.,3.000000e-11
neisseria_gonorrhoeae,escherichia_coli,3.000000e-11
neisseria_gonorrhoeae,klebsiella_pneumoniae,3.000000e-11
neisseria_gonorrhoeae,morganella_spp.,3.000000e-11
neisseria_gonorrhoeae,proteus_spp.,3.000000e-11
neisseria_gonorrhoeae,serratia_spp.,3.000000e-11
neisseria_gonorrhoeae,p_stuartii,3.000000e-11
neisseria_gonorrhoeae,pseudomonas_aeruginosa,3.000000e-11
neisseria_gonorrhoeae,stenotrophomonas_maltophilia,3.000000e-11
neisseria_gonorrhoeae,salmonella_enterica_serovar_typhi,3.000000e-11
neisseria_gonorrhoeae,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
neisseria_gonorrhoeae,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
neisseria_gonorrhoeae,shigella_spp.,3.000000e-11
neisseria_gonorrhoeae,haemophilus_influenzae,1.000000e-9
neisseria_gonorrhoeae,chlamydia_trachomatis,1.000000e-9
neisseria_gonorrhoeae,mycoplasma_genitalium,1.000000e-9
neisseria_gonorrhoeae,vibrio_cholerae,3.000000e-11
neisseria_gonorrhoeae,neisseria_meningitidis,1.000000e-9
neisseria_gonorrhoeae,enterobacter_cloacae,3.000000e-11
neisseria_gonorrhoeae,yersinia_enterocolitica,3.000000e-11
neisseria_gonorrhoeae,moraxella_catarrhalis,1.000000e-9
neisseria_gonorrhoeae,bordetella_pertussis,1.000000e-9
neisseria_gonorrhoeae,mycoplasma_pneumoniae,1.000000e-9
neisseria_gonorrhoeae,legionella_pneumophila,1.000000e-9
neisseria_gonorrhoeae,burkholderia_cepacia_complex,3.000000e-11
streptococcus_pyogenes,enterococcus_faecalis,1.000000e-9
streptococcus_pyogenes,enterococcus_faecium,1.000000e-9
streptococcus_pyogenes,staphylococcus_aureus,1.000000e-9
streptococcus_pyogenes,staphylococcus_epidermidis,1.000000e-9
streptococcus_pyogenes,streptococcus_pneumoniae,1.000000e-9
streptococcus_pyogenes,streptococcus_agalactiae,1.000000e-9
streptococcus_pyogenes,listeria_monocytogenes,1.000000e-9
streptococcus_agalactiae,enterococcus_faecalis,1.000000e-9
streptococcus_agalactiae,enterococcus_faecium,1.000000e-9
streptococcus_agalactiae,staphylococcus_aureus,1.000000e-9
streptococcus_agalactiae,staphylococcus_epidermidis,1.000000e-9
streptococcus_agalactiae,streptococcus_pneumoniae,1.000000e-9
streptococcus_agalactiae,streptococcus_pyogenes,1.000000e-9
streptococcus_agalactiae,listeria_monocytogenes,1.000000e-9
haemophilus_influenzae,acinetobacter_baumannii,3.000000e-11
haemophilus_influenzae,citrobacter_spp.,3.000000e-11
haemophilus_influenzae,enterobacter_spp.,3.000000e-11
haemophilus_influenzae,escherichia_coli,3.000000e-11
haemophilus_influenzae,klebsiella_pneumoniae,3.000000e-11
haemophilus_influenzae,morganella_spp.,3.000000e-11
haemophilus_influenzae,proteus_spp.,3.000000e-11
haemophilus_influenzae,serratia_spp.,3.000000e-11
haemophilus_influenzae,p_stuartii,3.000000e-11
haemophilus_influenzae,pseudomonas_aeruginosa,3.000000e-11
haemophilus_influenzae,stenotrophomonas_maltophilia,3.000000e-11
haemophilus_influenzae,salmonella_enterica_serovar_typhi,3.000000e-11
haemophilus_influenzae,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
haemophilus_influenzae,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
haemophilus_influenzae,shigella_spp.,3.000000e-11
haemophilus_influenzae,neisseria_gonorrhoeae,1.000000e-9
haemophilus_influenzae,chlamydia_trachomatis,1.000000e-9
haemophilus_influenzae,mycoplasma_genitalium,1.000000e-9
haemophilus_influenzae,vibrio_cholerae,3.000000e-11
haemophilus_influenzae,neisseria_meningitidis,1.000000e-9
haemophilus_influenzae,enterobacter_cloacae,3.000000e-11
haemophilus_influenzae,yersinia_enterocolitica,3.000000e-11
haemophilus_influenzae,moraxella_catarrhalis,1.000000e-9
haemophilus_influenzae,bordetella_pertussis,1.000000e-9
haemophilus_influenzae,mycoplasma_pneumoniae,1.000000e-9
haemophilus_influenzae,legionella_pneumophila,1.000000e-9
haemophilus_influenzae,burkholderia_cepacia_complex,3.000000e-11
chlamydia_trachomatis,acinetobacter_baumannii,3.000000e-11
chlamydia_trachomatis,citrobacter_spp.,3.000000e-11
chlamydia_trachomatis,enterobacter_spp.,3.000000e-11
chlamydia_trachomatis,escherichia_coli,3.000000e-11
chlamydia_trachomatis,klebsiella_pneumoniae,3.000000e-11
chlamydia_trachomatis,morganella_spp.,3.000000e-11
chlamydia_trachomatis,proteus_spp.,3.000000e-11
chlamydia_trachomatis,serratia_spp.,3.000000e-11
chlamydia_trachomatis,p_stuartii,3.000000e-11
chlamydia_trachomatis,pseudomonas_aeruginosa,3.000000e-11
chlamydia_trachomatis,stenotrophomonas_maltophilia,3.000000e-11
chlamydia_trachomatis,salmonella_enterica_serovar_typhi,3.000000e-11
chlamydia_trachomatis,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
chlamydia_trachomatis,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
chlamydia_trachomatis,shigella_spp.,3.000000e-11
chlamydia_trachomatis,neisseria_gonorrhoeae,1.000000e-9
chlamydia_trachomatis,haemophilus_influenzae,1.000000e-9
chlamydia_trachomatis,mycoplasma_genitalium,1.000000e-9
chlamydia_trachomatis,vibrio_cholerae,3.000000e-11
chlamydia_trachomatis,neisseria_meningitidis,1.000000e-9
chlamydia_trachomatis,enterobacter_cloacae,3.000000e-11
chlamydia_trachomatis,yersinia_enterocolitica,3.000000e-11
chlamydia_trachomatis,moraxella_catarrhalis,1.000000e-9
chlamydia_trachomatis,bordetella_pertussis,1.000000e-9
chlamydia_trachomatis,mycoplasma_pneumoniae,1.000000e-9
chlamydia_trachomatis,legionella_pneumophila,1.000000e-9
chlamydia_trachomatis,burkholderia_cepacia_complex,3.000000e-11
mycoplasma_genitalium,acinetobacter_baumannii,3.000000e-11
mycoplasma_genitalium,citrobacter_spp.,3.000000e-11
mycoplasma_genitalium,enterobacter_spp.,3.000000e-11
mycoplasma_genitalium,escherichia_coli,3.000000e-11
mycoplasma_genitalium,klebsiella_pneumoniae,3.000000e-11
mycoplasma_genitalium,morganella_spp.,3.000000e-11
mycoplasma_genitalium,proteus_spp.,3.000000e-11
mycoplasma_genitalium,serratia_spp.,3.000000e-11
mycoplasma_genitalium,p_stuartii,3.000000e-11
mycoplasma_genitalium,pseudomonas_aeruginosa,3.000000e-11
mycoplasma_genitalium,stenotrophomonas_maltophilia,3.000000e-11
mycoplasma_genitalium,salmonella_enterica_serovar_typhi,3.000000e-11
mycoplasma_genitalium,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
mycoplasma_genitalium,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
mycoplasma_genitalium,shigella_spp.,3.000000e-11
mycoplasma_genitalium,neisseria_gonorrhoeae,1.000000e-9
mycoplasma_genitalium,haemophilus_influenzae,1.000000e-9
mycoplasma_genitalium,chlamydia_trachomatis,1.000000e-9
mycoplasma_genitalium,vibrio_cholerae,3.000000e-11
mycoplasma_genitalium,neisseria_meningitidis,1.000000e-9
mycoplasma_genitalium,enterobacter_cloacae,3.000000e-11
mycoplasma_genitalium,yersinia_enterocolitica,3.000000e-11
mycoplasma_genitalium,moraxella_catarrhalis,1.000000e-9
mycoplasma_genitalium,bordetella_pertussis,1.000000e-9
mycoplasma_genitalium,mycoplasma_pneumoniae,1.000000e-9
mycoplasma_genitalium,legionella_pneumophila,1.000000e-9
mycoplasma_genitalium,burkholderia_cepacia_complex,3.000000e-11
vibrio_cholerae,acinetobacter_baumannii,1.000000e-1
vibrio_cholerae,citrobacter_spp.,1.000000e-1
vibrio_cholerae,enterobacter_spp.,1.000000e-1
vibrio_cholerae,escherichia_coli,1.000000e-1
vibrio_cholerae,klebsiella_pneumoniae,1.000000e-1
vibrio_cholerae,morganella_spp.,1.000000e-1
vibrio_cholerae,proteus_spp.,1.000000e-1
vibrio_cholerae,serratia_spp.,1.000000e-1
vibrio_cholerae,p_stuartii,1.000000e-1
vibrio_cholerae,pseudomonas_aeruginosa,1.000000e-1
vibrio_cholerae,stenotrophomonas_maltophilia,1.000000e-1
vibrio_cholerae,salmonella_enterica_serovar_typhi,1.000000e-1
vibrio_cholerae,salmonella_enterica_serovar_paratyphi_a,1.000000e-1
vibrio_cholerae,invasive_non-typhoidal_salmonella_spp.,1.000000e-1
vibrio_cholerae,shigella_spp.,1.000000e-1
vibrio_cholerae,neisseria_gonorrhoeae,3.000000e-11
vibrio_cholerae,haemophilus_influenzae,3.000000e-11
vibrio_cholerae,chlamydia_trachomatis,3.000000e-11
vibrio_cholerae,mycoplasma_genitalium,3.000000e-11
vibrio_cholerae,neisseria_meningitidis,3.000000e-11
vibrio_cholerae,clostridioides_difficile,3.000000e-11
vibrio_cholerae,bacteroides_fragilis,3.000000e-11
vibrio_cholerae,enterobacter_cloacae,1.000000e-1
vibrio_cholerae,yersinia_enterocolitica,1.000000e-1
vibrio_cholerae,moraxella_catarrhalis,3.000000e-11
vibrio_cholerae,bordetella_pertussis,3.000000e-11
vibrio_cholerae,mycoplasma_pneumoniae,3.000000e-11
vibrio_cholerae,legionella_pneumophila,3.000000e-11
vibrio_cholerae,burkholderia_cepacia_complex,1.000000e-1
neisseria_meningitidis,acinetobacter_baumannii,3.000000e-11
neisseria_meningitidis,citrobacter_spp.,3.000000e-11
neisseria_meningitidis,enterobacter_spp.,3.000000e-11
neisseria_meningitidis,escherichia_coli,3.000000e-11
neisseria_meningitidis,klebsiella_pneumoniae,3.000000e-11
neisseria_meningitidis,morganella_spp.,3.000000e-11
neisseria_meningitidis,proteus_spp.,3.000000e-11
neisseria_meningitidis,serratia_spp.,3.000000e-11
neisseria_meningitidis,p_stuartii,3.000000e-11
neisseria_meningitidis,pseudomonas_aeruginosa,3.000000e-11
neisseria_meningitidis,stenotrophomonas_maltophilia,3.000000e-11
neisseria_meningitidis,salmonella_enterica_serovar_typhi,3.000000e-11
neisseria_meningitidis,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
neisseria_meningitidis,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
neisseria_meningitidis,shigella_spp.,3.000000e-11
neisseria_meningitidis,neisseria_gonorrhoeae,1.000000e-9
neisseria_meningitidis,haemophilus_influenzae,1.000000e-9
neisseria_meningitidis,chlamydia_trachomatis,1.000000e-9
neisseria_meningitidis,mycoplasma_genitalium,1.000000e-9
neisseria_meningitidis,vibrio_cholerae,3.000000e-11
neisseria_meningitidis,enterobacter_cloacae,3.000000e-11
neisseria_meningitidis,yersinia_enterocolitica,3.000000e-11
neisseria_meningitidis,moraxella_catarrhalis,1.000000e-9
neisseria_meningitidis,bordetella_pertussis,1.000000e-9
neisseria_meningitidis,mycoplasma_pneumoniae,1.000000e-9
neisseria_meningitidis,legionella_pneumophila,1.000000e-9
neisseria_meningitidis,burkholderia_cepacia_complex,3.000000e-11
listeria_monocytogenes,enterococcus_faecalis,1.000000e-9
listeria_monocytogenes,enterococcus_faecium,1.000000e-9
listeria_monocytogenes,staphylococcus_aureus,1.000000e-9
listeria_monocytogenes,staphylococcus_epidermidis,1.000000e-9
listeria_monocytogenes,streptococcus_pneumoniae,1.000000e-9
listeria_monocytogenes,streptococcus_pyogenes,1.000000e-9
listeria_monocytogenes,streptococcus_agalactiae,1.000000e-9
clostridioides_difficile,acinetobacter_baumannii,3.000000e-11
clostridioides_difficile,citrobacter_spp.,3.000000e-11
clostridioides_difficile,enterobacter_spp.,3.000000e-11
clostridioides_difficile,escherichia_coli,3.000000e-11
clostridioides_difficile,klebsiella_pneumoniae,3.000000e-11
clostridioides_difficile,morganella_spp.,3.000000e-11
clostridioides_difficile,proteus_spp.,3.000000e-11
clostridioides_difficile,serratia_spp.,3.000000e-11
clostridioides_difficile,p_stuartii,3.000000e-11
clostridioides_difficile,pseudomonas_aeruginosa,3.000000e-11
clostridioides_difficile,stenotrophomonas_maltophilia,3.000000e-11
clostridioides_difficile,salmonella_enterica_serovar_typhi,3.000000e-11
clostridioides_difficile,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
clostridioides_difficile,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
clostridioides_difficile,shigella_spp.,3.000000e-11
clostridioides_difficile,vibrio_cholerae,3.000000e-11
clostridioides_difficile,bacteroides_fragilis,1.000000e-9
clostridioides_difficile,enterobacter_cloacae,3.000000e-11
clostridioides_difficile,yersinia_enterocolitica,3.000000e-11
clostridioides_difficile,burkholderia_cepacia_complex,3.000000e-11
bacteroides_fragilis,acinetobacter_baumannii,3.000000e-11
bacteroides_fragilis,citrobacter_spp.,3.000000e-11
bacteroides_fragilis,enterobacter_spp.,3.000000e-11
bacteroides_fragilis,escherichia_coli,3.000000e-11
bacteroides_fragilis,klebsiella_pneumoniae,3.000000e-11
bacteroides_fragilis,morganella_spp.,3.000000e-11
bacteroides_fragilis,proteus_spp.,3.000000e-11
bacteroides_fragilis,serratia_spp.,3.000000e-11
bacteroides_fragilis,p_stuartii,3.000000e-11
bacteroides_fragilis,pseudomonas_aeruginosa,3.000000e-11
bacteroides_fragilis,stenotrophomonas_maltophilia,3.000000e-11
bacteroides_fragilis,salmonella_enterica_serovar_typhi,3.000000e-11
bacteroides_fragilis,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
bacteroides_fragilis,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
bacteroides_fragilis,shigella_spp.,3.000000e-11
bacteroides_fragilis,vibrio_cholerae,3.000000e-11
bacteroides_fragilis,clostridioides_difficile,1.000000e-9
bacteroides_fragilis,enterobacter_cloacae,3.000000e-11
bacteroides_fragilis,yersinia_enterocolitica,3.000000e-11
bacteroides_fragilis,burkholderia_cepacia_complex,3.000000e-11
enterobacter_cloacae,acinetobacter_baumannii,1.000000e-1
enterobacter_cloacae,citrobacter_spp.,1.000000e-9
enterobacter_cloacae,enterobacter_spp.,1.000000e-9
enterobacter_cloacae,escherichia_coli,1.000000e-9
enterobacter_cloacae,klebsiella_pneumoniae,1.000000e-9
enterobacter_cloacae,morganella_spp.,1.000000e-9
enterobacter_cloacae,proteus_spp.,1.000000e-9
enterobacter_cloacae,serratia_spp.,1.000000e-9
enterobacter_cloacae,p_stuartii,1.000000e-9
enterobacter_cloacae,pseudomonas_aeruginosa,1.000000e-1
enterobacter_cloacae,stenotrophomonas_maltophilia,1.000000e-1
enterobacter_cloacae,salmonella_enterica_serovar_typhi,1.000000e-9
enterobacter_cloacae,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
enterobacter_cloacae,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
enterobacter_cloacae,shigella_spp.,1.000000e-9
enterobacter_cloacae,neisseria_gonorrhoeae,3.000000e-11
enterobacter_cloacae,haemophilus_influenzae,3.000000e-11
enterobacter_cloacae,chlamydia_trachomatis,3.000000e-11
enterobacter_cloacae,mycoplasma_genitalium,3.000000e-11
enterobacter_cloacae,vibrio_cholerae,1.000000e-1
enterobacter_cloacae,neisseria_meningitidis,3.000000e-11
enterobacter_cloacae,clostridioides_difficile,3.000000e-11
enterobacter_cloacae,bacteroides_fragilis,3.000000e-11
enterobacter_cloacae,yersinia_enterocolitica,1.000000e-9
enterobacter_cloacae,moraxella_catarrhalis,3.000000e-11
enterobacter_cloacae,bordetella_pertussis,3.000000e-11
enterobacter_cloacae,mycoplasma_pneumoniae,3.000000e-11
enterobacter_cloacae,legionella_pneumophila,3.000000e-11
enterobacter_cloacae,burkholderia_cepacia_complex,1.000000e-1
yersinia_enterocolitica,acinetobacter_baumannii,1.000000e-1
yersinia_enterocolitica,citrobacter_spp.,1.000000e-9
yersinia_enterocolitica,enterobacter_spp.,1.000000e-9
yersinia_enterocolitica,escherichia_coli,1.000000e-9
yersinia_enterocolitica,klebsiella_pneumoniae,1.000000e-9
yersinia_enterocolitica,morganella_spp.,1.000000e-9
yersinia_enterocolitica,proteus_spp.,1.000000e-9
yersinia_enterocolitica,serratia_spp.,1.000000e-9
yersinia_enterocolitica,p_stuartii,1.000000e-9
yersinia_enterocolitica,pseudomonas_aeruginosa,1.000000e-1
yersinia_enterocolitica,stenotrophomonas_maltophilia,1.000000e-1
yersinia_enterocolitica,salmonella_enterica_serovar_typhi,1.000000e-9
yersinia_enterocolitica,salmonella_enterica_serovar_paratyphi_a,1.000000e-9
yersinia_enterocolitica,invasive_non-typhoidal_salmonella_spp.,1.000000e-9
yersinia_enterocolitica,shigella_spp.,1.000000e-9
yersinia_enterocolitica,neisseria_gonorrhoeae,3.000000e-11
yersinia_enterocolitica,haemophilus_influenzae,3.000000e-11
yersinia_enterocolitica,chlamydia_trachomatis,3.000000e-11
yersinia_enterocolitica,mycoplasma_genitalium,3.000000e-11
yersinia_enterocolitica,vibrio_cholerae,1.000000e-1
yersinia_enterocolitica,neisseria_meningitidis,3.000000e-11
yersinia_enterocolitica,clostridioides_difficile,3.000000e-11
yersinia_enterocolitica,bacteroides_fragilis,3.000000e-11
yersinia_enterocolitica,enterobacter_cloacae,1.000000e-9
yersinia_enterocolitica,moraxella_catarrhalis,3.000000e-11
yersinia_enterocolitica,bordetella_pertussis,3.000000e-11
yersinia_enterocolitica,mycoplasma_pneumoniae,3.000000e-11
yersinia_enterocolitica,legionella_pneumophila,3.000000e-11
yersinia_enterocolitica,burkholderia_cepacia_complex,1.000000e-1
moraxella_catarrhalis,acinetobacter_baumannii,3.000000e-11
moraxella_catarrhalis,citrobacter_spp.,3.000000e-11
moraxella_catarrhalis,enterobacter_spp.,3.000000e-11
moraxella_catarrhalis,escherichia_coli,3.000000e-11
moraxella_catarrhalis,klebsiella_pneumoniae,3.000000e-11
moraxella_catarrhalis,morganella_spp.,3.000000e-11
moraxella_catarrhalis,proteus_spp.,3.000000e-11
moraxella_catarrhalis,serratia_spp.,3.000000e-11
moraxella_catarrhalis,p_stuartii,3.000000e-11
moraxella_catarrhalis,pseudomonas_aeruginosa,3.000000e-11
moraxella_catarrhalis,stenotrophomonas_maltophilia,3.000000e-11
moraxella_catarrhalis,salmonella_enterica_serovar_typhi,3.000000e-11
moraxella_catarrhalis,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
moraxella_catarrhalis,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
moraxella_catarrhalis,shigella_spp.,3.000000e-11
moraxella_catarrhalis,neisseria_gonorrhoeae,1.000000e-9
moraxella_catarrhalis,haemophilus_influenzae,1.000000e-9
moraxella_catarrhalis,chlamydia_trachomatis,1.000000e-9
moraxella_catarrhalis,mycoplasma_genitalium,1.000000e-9
moraxella_catarrhalis,vibrio_cholerae,3.000000e-11
moraxella_catarrhalis,neisseria_meningitidis,1.000000e-9
moraxella_catarrhalis,enterobacter_cloacae,3.000000e-11
moraxella_catarrhalis,yersinia_enterocolitica,3.000000e-11
moraxella_catarrhalis,bordetella_pertussis,1.000000e-9
moraxella_catarrhalis,mycoplasma_pneumoniae,1.000000e-9
moraxella_catarrhalis,legionella_pneumophila,1.000000e-9
moraxella_catarrhalis,burkholderia_cepacia_complex,3.000000e-11
bordetella_pertussis,acinetobacter_baumannii,3.000000e-11
bordetella_pertussis,citrobacter_spp.,3.000000e-11
bordetella_pertussis,enterobacter_spp.,3.000000e-11
bordetella_pertussis,escherichia_coli,3.000000e-11
bordetella_pertussis,klebsiella_pneumoniae,3.000000e-11
bordetella_pertussis,morganella_spp.,3.000000e-11
bordetella_pertussis,proteus_spp.,3.000000e-11
bordetella_pertussis,serratia_spp.,3.000000e-11
bordetella_pertussis,p_stuartii,3.000000e-11
bordetella_pertussis,pseudomonas_aeruginosa,3.000000e-11
bordetella_pertussis,stenotrophomonas_maltophilia,3.000000e-11
bordetella_pertussis,salmonella_enterica_serovar_typhi,3.000000e-11
bordetella_pertussis,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
bordetella_pertussis,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
bordetella_pertussis,shigella_spp.,3.000000e-11
bordetella_pertussis,neisseria_gonorrhoeae,1.000000e-9
bordetella_pertussis,haemophilus_influenzae,1.000000e-9
bordetella_pertussis,chlamydia_trachomatis,1.000000e-9
bordetella_pertussis,mycoplasma_genitalium,1.000000e-9
bordetella_pertussis,vibrio_cholerae,3.000000e-11
bordetella_pertussis,neisseria_meningitidis,1.000000e-9
bordetella_pertussis,enterobacter_cloacae,3.000000e-11
bordetella_pertussis,yersinia_enterocolitica,3.000000e-11
bordetella_pertussis,moraxella_catarrhalis,1.000000e-9
bordetella_pertussis,mycoplasma_pneumoniae,1.000000e-9
bordetella_pertussis,legionella_pneumophila,1.000000e-9
bordetella_pertussis,burkholderia_cepacia_complex,3.000000e-11
mycoplasma_pneumoniae,acinetobacter_baumannii,3.000000e-11
mycoplasma_pneumoniae,citrobacter_spp.,3.000000e-11
mycoplasma_pneumoniae,enterobacter_spp.,3.000000e-11
mycoplasma_pneumoniae,escherichia_coli,3.000000e-11
mycoplasma_pneumoniae,klebsiella_pneumoniae,3.000000e-11
mycoplasma_pneumoniae,morganella_spp.,3.000000e-11
mycoplasma_pneumoniae,proteus_spp.,3.000000e-11
mycoplasma_pneumoniae,serratia_spp.,3.000000e-11
mycoplasma_pneumoniae,p_stuartii,3.000000e-11
mycoplasma_pneumoniae,pseudomonas_aeruginosa,3.000000e-11
mycoplasma_pneumoniae,stenotrophomonas_maltophilia,3.000000e-11
mycoplasma_pneumoniae,salmonella_enterica_serovar_typhi,3.000000e-11
mycoplasma_pneumoniae,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
mycoplasma_pneumoniae,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
mycoplasma_pneumoniae,shigella_spp.,3.000000e-11
mycoplasma_pneumoniae,neisseria_gonorrhoeae,1.000000e-9
mycoplasma_pneumoniae,haemophilus_influenzae,1.000000e-9
mycoplasma_pneumoniae,chlamydia_trachomatis,1.000000e-9
mycoplasma_pneumoniae,mycoplasma_genitalium,1.000000e-9
mycoplasma_pneumoniae,vibrio_cholerae,3.000000e-11
mycoplasma_pneumoniae,neisseria_meningitidis,1.000000e-9
mycoplasma_pneumoniae,enterobacter_cloacae,3.000000e-11
mycoplasma_pneumoniae,yersinia_enterocolitica,3.000000e-11
mycoplasma_pneumoniae,moraxella_catarrhalis,1.000000e-9
mycoplasma_pneumoniae,bordetella_pertussis,1.000000e-9
mycoplasma_pneumoniae,legionella_pneumophila,1.000000e-9
mycoplasma_pneumoniae,burkholderia_cepacia_complex,3.000000e-11
legionella_pneumophila,acinetobacter_baumannii,3.000000e-11
legionella_pneumophila,citrobacter_spp.,3.000000e-11
legionella_pneumophila,enterobacter_spp.,3.000000e-11
legionella_pneumophila,escherichia_coli,3.000000e-11
legionella_pneumophila,klebsiella_pneumoniae,3.000000e-11
legionella_pneumophila,morganella_spp.,3.000000e-11
legionella_pneumophila,proteus_spp.,3.000000e-11
legionella_pneumophila,serratia_spp.,3.000000e-11
legionella_pneumophila,p_stuartii,3.000000e-11
legionella_pneumophila,pseudomonas_aeruginosa,3.000000e-11
legionella_pneumophila,stenotrophomonas_maltophilia,3.000000e-11
legionella_pneumophila,salmonella_enterica_serovar_typhi,3.000000e-11
legionella_pneumophila,salmonella_enterica_serovar_paratyphi_a,3.000000e-11
legionella_pneumophila,invasive_non-typhoidal_salmonella_spp.,3.000000e-11
legionella_pneumophila,shigella_spp.,3.000000e-11
legionella_pneumophila,neisseria_gonorrhoeae,1.000000e-9
legionella_pneumophila,haemophilus_influenzae,1.000000e-9
legionella_pneumophila,chlamydia_trachomatis,1.000000e-9
legionella_pneumophila,mycoplasma_genitalium,1.000000e-9
legionella_pneumophila,vibrio_cholerae,3.000000e-11
legionella_pneumophila,neisseria_meningitidis,1.000000e-9
legionella_pneumophila,enterobacter_cloacae,3.000000e-11
legionella_pneumophila,yersinia_enterocolitica,3.000000e-11
legionella_pneumophila,moraxella_catarrhalis,1.000000e-9
legionella_pneumophila,bordetella_pertussis,1.000000e-9
legionella_pneumophila,mycoplasma_pneumoniae,1.000000e-9
legionella_pneumophila,burkholderia_cepacia_complex,3.000000e-11
burkholderia_cepacia_complex,acinetobacter_baumannii,1.000000e-9
burkholderia_cepacia_complex,citrobacter_spp.,1.000000e-1
burkholderia_cepacia_complex,enterobacter_spp.,1.000000e-1
burkholderia_cepacia_complex,escherichia_coli,1.000000e-1
burkholderia_cepacia_complex,klebsiella_pneumoniae,1.000000e-1
burkholderia_cepacia_complex,morganella_spp.,1.000000e-1
burkholderia_cepacia_complex,proteus_spp.,1.000000e-1
burkholderia_cepacia_complex,serratia_spp.,1.000000e-1
burkholderia_cepacia_complex,p_stuartii,1.000000e-1
burkholderia_cepacia_complex,pseudomonas_aeruginosa,1.000000e-9
burkholderia_cepacia_complex,stenotrophomonas_maltophilia,1.000000e-9
burkholderia_cepacia_complex,salmonella_enterica_serovar_typhi,1.000000e-1
burkholderia_cepacia_complex,salmonella_enterica_serovar_paratyphi_a,1.000000e-1
burkholderia_cepacia_complex,invasive_non-typhoidal_salmonella_spp.,1.000000e-1
burkholderia_cepacia_complex,shigella_spp.,1.000000e-1
burkholderia_cepacia_complex,neisseria_gonorrhoeae,3.000000e-11
burkholderia_cepacia_complex,haemophilus_influenzae,3.000000e-11
burkholderia_cepacia_complex,chlamydia_trachomatis,3.000000e-11
burkholderia_cepacia_complex,mycoplasma_genitalium,3.000000e-11
burkholderia_cepacia_complex,vibrio_cholerae,1.000000e-1
burkholderia_cepacia_complex,neisseria_meningitidis,3.000000e-11
burkholderia_cepacia_complex,clostridioides_difficile,3.000000e-11
burkholderia_cepacia_complex,bacteroides_fragilis,3.000000e-11
burkholderia_cepacia_complex,enterobacter_cloacae,1.000000e-1
burkholderia_cepacia_complex,yersinia_enterocolitica,1.000000e-1
burkholderia_cepacia_complex,moraxella_catarrhalis,3.000000e-11
burkholderia_cepacia_complex,bordetella_pertussis,3.000000e-11
burkholderia_cepacia_complex,mycoplasma_pneumoniae,3.000000e-11
burkholderia_cepacia_complex,legionella_pneumophila,3.000000e-11
```
