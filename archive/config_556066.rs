...
pub struct GlobalScalars {
    ...
    pub hospital_resistance_boost_probability: f64,
...
impl GlobalScalars {
    fn from_map(map: &HashMap<String, f64>) -> Self {
        ...
        GlobalScalars {
            ...
            // ── Hospital resistance boost: probability that each applicable mechanism
            //    is added to a hospital-acquired infection after profile sampling ──
            hospital_resistance_boost_probability: get_or_default(
                map,
                "hospital_resistance_boost_probability",
                0.15,
            ),
...
lazy_static! {
  ...
  // Enterobacter spp. — Gram-negative, Enterobacterales
    ...
    map.insert("empiric_therapy_broad_spectrum_bonus".to_string(), 0.85); // Make broad-spectrum empiric choices noticeably less favored than narrow options
        ...
        map.insert("hospital_resistance_boost_probability".to_string(), 0.15); // Per-mechanism boost for hospital-acquired infections
