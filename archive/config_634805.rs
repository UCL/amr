...
lazy_static! {
    ...
    map.insert("random_drug_cessation_probability_if_no_active_infection".to_string(), 0.15); // Higher probability if no active infection
        ...
        map.insert("acinetobacter_baumannii_acquisition_log_odds_baseline".to_string(), -14.5); 
        map.insert("campylobacter_jejuni_acquisition_log_odds_baseline".to_string(), -12.8); 
        map.insert("chlamydia_trachomatis_acquisition_log_odds_baseline".to_string(), -12.3); 
        map.insert("citrobacter_spp._acquisition_log_odds_baseline".to_string(), -18.0);
        map.insert("clostridioides_difficile_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("enterobacter_cloacae_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("enterobacter_spp._acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("enterococcus_faecalis_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("enterococcus_faecium_acquisition_log_odds_baseline".to_string(), -17.5); 
        ...
        map.insert("klebsiella_pneumoniae_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("listeria_monocytogenes_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("mdr_mycobacterium_tuberculosis_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("moraxella_catarrhalis_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("morganella_spp._acquisition_log_odds_baseline".to_string(), -17.5); 
        ...
        map.insert("serratia_spp._acquisition_log_odds_baseline".to_string(), -17.5); 
        ...
        map.insert("stenotrophomonas_maltophilia_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("staphylococcus_aureus_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("streptococcus_agalactiae_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("streptococcus_pneumoniae_acquisition_log_odds_baseline".to_string(), -13.5); 
        map.insert("streptococcus_pyogenes_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("treponema_pallidum_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("vibrio_cholerae_acquisition_log_odds_baseline".to_string(), -17.5); 
        map.insert("yersinia_enterocolitica_acquisition_log_odds_baseline".to_string(), -17.5); 
    ...
    map.insert("klebsiella_pneumoniae_microbiome_clearance_probability_per_day".to_string(), 0.02);
    ...
    map.insert("moraxella_catarrhalis_microbiome_clearance_probability_per_day".to_string(), 0.04);
    ...
    map.insert("empiric_therapy_broad_spectrum_bonus".to_string(), 0.95); // Make broad-spectrum empiric choices slightly less favored than narrow options
        ...
        map.insert("streptococcus_pneumoniae_sepsis_risk_multiplier".to_string(), 1.5); // Pneumococcal sepsis very severe
