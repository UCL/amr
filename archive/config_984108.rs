...
lazy_static! {
    ...
    map.insert("klebsiella_pneumoniae_hospital_resistance_prune_susceptible_percent".to_string(), 65.0);
    map.insert("enterobacter_spp._hospital_resistance_prune_susceptible_percent".to_string(), 65.0);
    map.insert("enterobacter_cloacae_hospital_resistance_prune_susceptible_percent".to_string(), 65.0);
    ...
    map.insert("staphylococcus_aureus_hospital_resistance_prune_susceptible_percent".to_string(), 55.0);
    map.insert("enterococcus_faecium_hospital_resistance_prune_susceptible_percent".to_string(), 55.0);
