...
*/
    ...
    map.insert("log_odds_microbiome_vs_infection".to_string(), 2.0); // Fallback: modest carriage boost if no bacteria-specific param
        ...
        map.insert("bacteria_enterobacter_cloacae_mechanism_target_site_mutation_emergence_multiplier".to_string(), 10.0);
        map.insert("bacteria_enterobacter_cloacae_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_enterobacter_cloacae_mechanism_reduced_permeability_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_enterobacter_cloacae_mechanism_qnr_emergence_multiplier".to_string(), 0.1);
        map.insert("bacteria_enterobacter_cloacae_mechanism_erm_methylation_emergence_multiplier".to_string(), 0.0);
        map.insert("bacteria_enterobacter_cloacae_mechanism_esbl_emergence_multiplier".to_string(), 0.1);
        map.insert("bacteria_enterobacter_cloacae_mechanism_ampc_emergence_multiplier".to_string(), 10.0);
        map.insert("bacteria_enterobacter_cloacae_mechanism_meca_emergence_multiplier".to_string(), 0.0);
        map.insert("bacteria_enterobacter_cloacae_mechanism_carbapenemase_emergence_multiplier".to_string(), 0.1);
       ...
       // L1/L2 are intrinsic, but we model them as high emergence for "acquisition" logic if not present
        ...
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_qnr_emergence_multiplier".to_string(), 0.03); // Plasmid mediated less common than chromosomal
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_esbl_emergence_multiplier".to_string(), 0.5); // Plasmid TEM-1 is common ("Penicillinase") - mapped to ESBL for model purposes
        ...
        map.insert("bacteria_mycoplasma_genitalium_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.1); // HIGH: Quinolone resistance
        map.insert("bacteria_mycoplasma_genitalium_mechanism_qnr_emergence_multiplier".to_string(), 0.0);
        map.insert("bacteria_mycoplasma_genitalium_mechanism_erm_methylation_emergence_multiplier".to_string(), 0.1); // HIGH: Macrolide resistance (mutation based, but mapped to Erm/Methylation effect)
        ...
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_qnr_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_esbl_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_ampc_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_carbapenemase_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_16s_methyltransferase_emergence_multiplier".to_string(), 0.05);
        ...
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.2);
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.2);
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.2);
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_qnr_emergence_multiplier".to_string(), 0.2);
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_esbl_emergence_multiplier".to_string(), 0.2);
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_ampc_emergence_multiplier".to_string(), 0.2);
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_carbapenemase_emergence_multiplier".to_string(), 0.2);
        ...
        map.insert("bacteria_staphylococcus_aureus_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.01);
        map.insert("bacteria_staphylococcus_aureus_mechanism_qnr_emergence_multiplier".to_string(), 0.01);
        ...
        map.insert("bacteria_enterococcus_faecium_mechanism_van_type_emergence_multiplier".to_string(), 0.0001);
        map.insert("bacteria_enterococcus_faecium_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.0001);
        map.insert("bacteria_enterococcus_faecium_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.0001);
        map.insert("bacteria_enterococcus_faecium_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.0001);
        ...
        map.insert("bacteria_bacteroides_fragilis_mechanism_esbl_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_carbapenemase_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_ampc_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_16s_methyltransferase_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_qnr_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_erm_methylation_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_van_type_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_meca_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_reduced_permeability_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_target_site_mutation_emergence_multiplier".to_string(), 1.0);
...
*/
    ...
    map.insert("empiric_therapy_broad_spectrum_bonus".to_string(), 0.85); // Make broad-spectrum empiric choices noticeably less favored than narrow options
        ...
        map.insert("sepsis_death_base_log_odds".to_string(), -8.0); 
