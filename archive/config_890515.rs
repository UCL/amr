...
lazy_static! {
    ...
    // pseudomonas_aeruginosa - Clinically apparent when burden high
        ...
        // bacteroides_fragilis - Tier 1 fix: dramatically reduce emergence (was showing 100% resistance everywhere)
        ...
        if BACTERIA_LIST.contains(&"bacteroides_fragilis") {
            ...
            for &drug in frontline_anaerobe_agents.iter() {
                map.insert(
                    ...
                    0.00000000000000001,  // 1e-17 - metronidazole resistance is rare
                );
            }
            ...
            for &drug in carbapenems.iter() {
                map.insert(
                    ...
                    0.000000000000000001,  // 1e-18 - carbapenem resistance is very rare
                );
            }
        }
        ...
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_serratia_spp._resistance_emergence_rate_per_day_baseline", drug), 0.001);
        }
        ...
        map.insert(format!("drug_{}_for_bacteria_serratia_spp._resistance_emergence_rate_per_day_baseline", drug), 0.003);
        }
        ...
        map.insert("drug_trim_sulf_for_bacteria_serratia_spp._resistance_emergence_rate_per_day_baseline".to_string(), 0.003);
...
*/
    ...
    map.insert("log_odds_microbiome_vs_infection".to_string(), 2.0); // Fallback: modest carriage boost if no bacteria-specific param
       ...
       // Stenotrophomonas maltophilia carries constitutive L1/L2 beta-lactamases and multi-drug efflux pumps
        ...
        // Bacteroides fragilis constitutively expresses beta-lactamases and occasionally acquires nim/erm determinants
        map.insert(
