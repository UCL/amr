...
*/
    ...
    map.insert("klebsiella_pneumoniae_log_odds_microbiome_vs_infection".to_string(), 9.5); 
    ...
    map.insert("proteus_spp._log_odds_microbiome_vs_infection".to_string(), 6.0); 
    map.insert("serratia_spp._log_odds_microbiome_vs_infection".to_string(), 8.5); 
    map.insert("morganella_spp._log_odds_microbiome_vs_infection".to_string(), 8.9); 
    ...
    map.insert("moraxella_catarrhalis_log_odds_microbiome_vs_infection".to_string(), 12.5); 
    map.insert("streptococcus_pyogenes_log_odds_microbiome_vs_infection".to_string(), 9.0); 
    ...
    map.insert("pseudomonas_aeruginosa_log_odds_microbiome_vs_infection".to_string(), 7.0); 
    map.insert("clostridioides_difficile_log_odds_microbiome_vs_infection".to_string(), 7.0); 
    map.insert("salmonella_enterica_serovar_typhi_log_odds_microbiome_vs_infection".to_string(), -3.0); 
    ...
    map.insert("shigella_spp._log_odds_microbiome_vs_infection".to_string(), -0.0); 
    map.insert("vibrio_cholerae_log_odds_microbiome_vs_infection".to_string(), 2.5); 
    map.insert("campylobacter_jejuni_log_odds_microbiome_vs_infection".to_string(), 2.0); 
    map.insert("yersinia_enterocolitica_log_odds_microbiome_vs_infection".to_string(), 4.0); 
    map.insert("listeria_monocytogenes_log_odds_microbiome_vs_infection".to_string(), 9.0); 
    map.insert("neisseria_gonorrhoeae_log_odds_microbiome_vs_infection".to_string(), 0.5); 
    map.insert("chlamydia_trachomatis_log_odds_microbiome_vs_infection".to_string(), 4.5); 
    map.insert("treponema_pallidum_log_odds_microbiome_vs_infection".to_string(), 6.0); 
    ...
    map.insert("bordetella_pertussis_log_odds_microbiome_vs_infection".to_string(), 2.0);
    map.insert("stenotrophomonas_maltophilia_log_odds_microbiome_vs_infection".to_string(), 5.0);
