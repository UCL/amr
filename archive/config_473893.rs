...
lazy_static! {
    ...
    map.insert("random_drug_cessation_probability_if_no_active_infection".to_string(), 0.15); // Higher probability if no active infection
        ...
        map.insert("neisseria_meningitidis_acquisition_log_odds_baseline".to_string(), -80.0); // Iter9: was 10,000x over at -28.6, need -9 more
        ...
        map.insert("campylobacter_jejuni_acquisition_log_odds_baseline".to_string(), -13.5); // Iter8: was -14.8, target 1.2% infection + 0.5% carriage
        map.insert("chlamydia_trachomatis_acquisition_log_odds_baseline".to_string(), -13.5); // Iter8: was -12.3, target 1.6% infection + 1.5% carriage
        map.insert("citrobacter_spp._acquisition_log_odds_baseline".to_string(), -19.0);
        map.insert("clostridioides_difficile_acquisition_log_odds_baseline".to_string(), -80.0); // Iter9: was 4,500x over at -18.2, need -8.5 more
        map.insert("enterobacter_cloacae_acquisition_log_odds_baseline".to_string(), -30.0); // Iter9: was 65x over, reduce by 10
        map.insert("enterobacter_spp._acquisition_log_odds_baseline".to_string(), -80.0); // Iter9: was 56,000x over at -19.7, need -11 more
        ...
        map.insert("helicobacter_pylori_acquisition_log_odds_baseline".to_string(), -13.0); // Iter8: was -10.7, target 2.5% infection (microbiome blocked by design)
        ...
        map.insert("listeria_monocytogenes_acquisition_log_odds_baseline".to_string(), -80.0); // Iter9: was 458x over at -22, need -6 more
        map.insert("mdr_mycobacterium_tuberculosis_acquisition_log_odds_baseline".to_string(), -20.0); // Iter9: was 67,000x over at -28, need -11 more
        map.insert("moraxella_catarrhalis_acquisition_log_odds_baseline".to_string(), -20.0); // Iter9: was 37x over at -16, need -4 more
        map.insert("morganella_spp._acquisition_log_odds_baseline".to_string(), -40.0); // Iter9: was 228,000x over at -20, need -12 more
        ...
        map.insert("shigella_spp._acquisition_log_odds_baseline".to_string(), -14.0); // Iter8: was -13.2, target 2.4% infection + 0.05% carriage
    ...
    map.insert("enterococcus_faecium_log_odds_microbiome_vs_infection".to_string(), 8.0); // Iter7: was 5.52
    map.insert("klebsiella_pneumoniae_log_odds_microbiome_vs_infection".to_string(), 9.0); // Iter7: was 5.46
    map.insert("staphylococcus_aureus_log_odds_microbiome_vs_infection".to_string(), 9.0); // Iter8: was 4.0, target 30:1 carriage:infection ratio
    ...
    map.insert("moraxella_catarrhalis_log_odds_microbiome_vs_infection".to_string(), 8.0); // ~50% NP colonization (50-75% in children)
    map.insert("streptococcus_pyogenes_log_odds_microbiome_vs_infection".to_string(), 8.0); // ~10% transient carriage
    map.insert("streptococcus_agalactiae_log_odds_microbiome_vs_infection".to_string(), 9.0); // ~25% vaginal/rectal colonization in women
    ...
    map.insert("neisseria_meningitidis_log_odds_microbiome_vs_infection".to_string(), 9.0); // ~10% NP carriage (5-15% in adolescents)
