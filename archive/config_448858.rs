...
lazy_static! {
    pub static ref PARAMETERS: HashMap<String, f64> = {
        ...
        map.insert("reserve_drug_score_penalty".to_string(), 0.4); // Reserve agents get 80% score haircut to keep total usage under stewardship targets
...
*/
    ...
    map.insert("empiric_therapy_broad_spectrum_bonus".to_string(), 0.85); // Make broad-spectrum empiric choices noticeably less favored than narrow options
        ...
        let bacteria_sepsis_baseline_overrides: &[(&str, f64)] = &[
            ...
            ("shigella_spp.", -14.2),
            ("neisseria_gonorrhoeae", -16.2),
            ("streptococcus_pyogenes", -7.5),
            ("streptococcus_agalactiae", -7.4),
            ("haemophilus_influenzae", -15.0),
            ("chlamydia_trachomatis", -18.3),
            ("vibrio_cholerae", -11.0),
            ("neisseria_meningitidis", -13.2),
            ("listeria_monocytogenes", -7.0),
            ("clostridioides_difficile", -9.0),
            ("campylobacter_jejuni", -16.1),
            ("enterobacter_cloacae", -7.0),
            ("yersinia_enterocolitica", -10.0),
            ("moraxella_catarrhalis", -12.0),
            ("treponema_pallidum", -18.3),
            ("bordetella_pertussis", -12.0),
