...
lazy_static! {
    ...
    map.insert("random_drug_cessation_probability_if_no_active_infection".to_string(), 0.15); // Higher probability if no active infection
        ...
        map.insert("campylobacter_jejuni_acquisition_log_odds_baseline".to_string(), -15.0); // Iter8: was -14.8, target 1.2% infection + 0.5% carriage
        map.insert("chlamydia_trachomatis_acquisition_log_odds_baseline".to_string(), -15.0); // Iter8: was -12.3, target 1.6% infection + 1.5% carriage
        ...
        map.insert("escherichia_coli_acquisition_log_odds_baseline".to_string(), -15.0); // Iter8: was -16.0, target 2.5% infection + 95% carriage
        map.insert("helicobacter_pylori_acquisition_log_odds_baseline".to_string(), -15.0); // Iter8: was -10.7, target 2.5% infection (microbiome blocked by design)
        ...
        map.insert("neisseria_gonorrhoeae_acquisition_log_odds_baseline".to_string(), -13.8); // Iter8: was -9.8, target 1% infection + 0.5% carriage (was 33% carriage!)
        ...
        map.insert("shigella_spp._acquisition_log_odds_baseline".to_string(), -14.8); // Iter8: was -13.2, target 2.4% infection + 0.05% carriage
        ...
        map.insert("streptococcus_pneumoniae_acquisition_log_odds_baseline".to_string(), -14.5); // Iter8: was -13.8, target 2% infection + 35% carriage
