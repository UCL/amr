...
lazy_static! {
    ...
    map.insert("random_drug_cessation_probability_if_no_active_infection".to_string(), 0.15); // Higher probability if no active infection
        ...
        map.insert("escherichia_coli_acquisition_log_odds_baseline".to_string(), -14.0); // Iter8: was -16.0, target 2.5% infection + 95% carriage
        ...
        map.insert("neisseria_gonorrhoeae_acquisition_log_odds_baseline".to_string(), -13.5); // Iter8: was -9.8, target 1% infection + 0.5% carriage (was 33% carriage!)
        ...
        map.insert("shigella_spp._acquisition_log_odds_baseline".to_string(), -14.3); // Iter8: was -13.2, target 2.4% infection + 0.05% carriage
        ...
        map.insert("streptococcus_pneumoniae_acquisition_log_odds_baseline".to_string(), -14.0); // Iter8: was -13.8, target 2% infection + 35% carriage
