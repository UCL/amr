...
impl VaccinationParameters {
    ...
    pub fn from_map(map: &HashMap<String, f64>) -> Self {
        ...
        let mut full_uplift_log_odds = vec![0.0; Self::VACCINES.len()];
        ...
        for (vaccine_idx, &vaccine) in Self::VACCINES.iter().enumerate() {
            ...
            let full_uplift_key = format!("vaccine_{}_full_uplift_log_odds", vaccine);
            full_uplift_log_odds[vaccine_idx] = get_or_default(map, &full_uplift_key, 0.0);
        }
    ...
    #[inline]
    pub fn acquisition_uplift_log_odds(&self, vaccine_idx: usize, simulation_year: f64) -> f64 {
        let full_uplift = self
            .full_uplift_log_odds
            .get(vaccine_idx)
            .copied()
            .unwrap_or(0.0);
        full_uplift * self.rollout_progress(vaccine_idx, simulation_year)
    }
}
...
lazy_static! {
    pub static ref PARAMETERS: HashMap<String, f64> = {
        ...
        map.insert(format!("{}_age_effect_scaling", bacteria), 1.0); // Scale the template effect (1.0 = full effect)
            ...
            // preserve observed vaccinated-world incidence while enabling vaccine counterfactuals.
            let bacterial_vaccines = vec![
                ("pneumococcal", 1977.0, 0.75, 20.0, 0.90),
                ("meningococcal", 1981.0, 0.55, 20.0, 0.50),
                ("hib", 1985.0, 0.85, 15.0, 1.10),
                ("pertussis", 1948.0, 0.82, 20.0, 1.00),
            ];
            for (vaccine, availability_year, birth_coverage_target, rollout_years, full_uplift_log_odds) in &bacterial_vaccines {
                ...
                map.insert(
                    format!("vaccine_{}_full_uplift_log_odds", vaccine),
                    *full_uplift_log_odds,
                );
            }
        }
    ...
    map.insert("log_odds_microbiome_vs_infection".to_string(), 2.0); // Fallback: modest carriage boost if no bacteria-specific param
        ...
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_enzyme_kpc_emergence_rate".to_string(), 0.000_000_05  ); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_enzyme_ndm_vim_emergence_rate".to_string(), 0.000_000_05     ); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_enzyme_oxa_48_emergence_rate".to_string(), 0.000_000_05     ); // classes: pen, bli, ceph, carb
        ...
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_mutation_folate_pathway_emergence_rate".to_string(), 0.000_1   ); // classes: sulf
  ...
  // Enterobacter spp. — Gram-negative, Enterobacterales
       ...
       // A. baumannii — Gram-negative, NonFermenter
        // Band 8 (x100)
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_esbl_ctx_m_emergence_rate".to_string(), 0.005); // classes: pen, bli, ceph, mono
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_esbl_tem_emergence_rate".to_string(), 0.005); // classes: pen, bli, ceph, mono
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_esbl_shv_emergence_rate".to_string(), 0.005); // classes: pen, bli, ceph, mono
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_ampc_cmy_emergence_rate".to_string(), 0.005); // classes: pen, bli, ceph, mono
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_ampc_dha_emergence_rate".to_string(), 0.005); // classes: pen, bli, ceph, mono
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_kpc_emergence_rate".to_string(), 0.005); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_ndm_vim_emergence_rate".to_string(), 0.005); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_oxa_48_emergence_rate".to_string(), 0.005); // classes: pen, bli, ceph, carb
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_cat_emergence_rate".to_string(), 0.01 ); // classes: chl
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_16s_rrmt_emergence_rate".to_string(), 3.0  ); // classes: ag
        ...
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_aac_aph_emergence_rate".to_string(), 3.0 ); // classes: ag; AMEs frequent in MDR AB
        ...
        map.insert("bacteria_acinetobacter_baumannii_mechanism_mutation_pbp_mosaic_emergence_rate".to_string(), 0.005); // classes: pen, bli, ceph, mono
        ...
        map.insert("bacteria_helicobacter_pylori_mechanism_target_site_cfr_emergence_rate".to_string(), 0.003); // classes: oxa, mls, chl
        map.insert("bacteria_helicobacter_pylori_mechanism_mutation_gyra_primary_emergence_rate".to_string(), 0.002 ); // classes: fq
        map.insert("bacteria_helicobacter_pylori_mechanism_mutation_gyra_parc_secondary_emergence_rate".to_string(), 0.002 ); // classes: fq
        ...
        map.insert("bacteria_helicobacter_pylori_mechanism_global_efflux_pump_emergence_rate".to_string(), 0.001  ); // classes: fq, mls, tet, chl
        ...
        map.insert("bacteria_helicobacter_pylori_mechanism_enzyme_bla_z_emergence_rate".to_string(), 0.000_5   ); // classes: pen; PBP1A proxy via blaZ; targets amox/amp only
        ...
        map.insert("bacteria_helicobacter_pylori_mechanism_mutation_pbp_mosaic_emergence_rate".to_string(), 0.000_5); // classes: pen, bli, ceph, mono; low PBP1A-type amoxicillin resistance proxy
        ...
        // Band 7 (x18.8)
        map.insert("bacteria_haemophilus_influenzae_mechanism_enzyme_esbl_ctx_m_emergence_rate".to_string(), 0.000_000_2  ); // classes: pen, bli, ceph, mono
        map.insert("bacteria_haemophilus_influenzae_mechanism_enzyme_esbl_tem_emergence_rate".to_string(), 0.000_000_2); // classes: pen, bli, ceph, mono
        map.insert("bacteria_haemophilus_influenzae_mechanism_enzyme_esbl_shv_emergence_rate".to_string(), 0.000_000_2 ); // classes: pen, bli, ceph, mono
        map.insert("bacteria_haemophilus_influenzae_mechanism_enzyme_ampc_cmy_emergence_rate".to_string(), 0.000_000_2  ); // classes: pen, bli, ceph, mono
        map.insert("bacteria_haemophilus_influenzae_mechanism_enzyme_ampc_dha_emergence_rate".to_string(), 0.000_000_2  ); // classes: pen, bli, ceph, mono
