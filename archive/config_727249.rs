...
lazy_static! {
    pub static ref PARAMETERS: HashMap<String, f64> = {
        ...
        map.insert("reserve_drug_score_penalty".to_string(), 0.05); // Reserve agents get 80% score haircut to keep total usage under stewardship targets
    ...
    // pseudomonas_aeruginosa - Clinically apparent when burden high
        ...
        // proteus_spp.
        for &drug in DRUG_SHORT_NAMES.iter() {
            map.insert(format!("drug_{}_for_bacteria_proteus_spp._resistance_emergence_rate_per_day_baseline", drug), 0.05); 
        }
        ...
        // salmonella_enterica_serovar_paratyphi_a
        for &drug in DRUG_SHORT_NAMES.iter() {
            map.insert(format!("drug_{}_for_bacteria_salmonella_enterica_serovar_paratyphi_a_resistance_emergence_rate_per_day_baseline", drug), 0.05); 
        }
        ...
        // shigella_spp_
        for &drug in DRUG_SHORT_NAMES.iter() {
            map.insert(format!("drug_{}_for_bacteria_shigella_spp_resistance_emergence_rate_per_day_baseline", drug), 0.005); 
        }
        
      
        // staphylococcus_aureus
        for &drug in DRUG_SHORT_NAMES.iter() {
            map.insert(format!("drug_{}_for_bacteria_staphylococcus_aureus_resistance_emergence_rate_per_day_baseline", drug), 0.05); 
        }
        ...
        // chlamydia_trachomatis
        for &drug in DRUG_SHORT_NAMES.iter() {
            map.insert(format!("drug_{}_for_bacteria_chlamydia_trachomatis_resistance_emergence_rate_per_day_baseline", drug), 0.02); 
        }
        ...
        // enterobacter_cloacae
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_enterobacter_cloacae_resistance_emergence_rate_per_day_baseline", drug), 0.05); 
        }
        ...
        // enterococcus_faecium
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_enterococcus_faecium_resistance_emergence_rate_per_day_baseline", drug), 0.05); 
        }
        ...
        // serratia_spp.
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_serratia_spp._resistance_emergence_rate_per_day_baseline", drug), 0.05); 
        }
        ...
        // treponema_pallidum
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_treponema_pallidum_resistance_emergence_rate_per_day_baseline", drug), 0.01); 
        }
        ...
        // neisseria_meningitidis
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_neisseria_meningitidis_resistance_emergence_rate_per_day_baseline", drug), 0.03); 
        }
...
*/
    ...
    map.insert("log_odds_microbiome_vs_infection".to_string(), 2.0); // Fallback: modest carriage boost if no bacteria-specific param
        ...
        map.insert("resistance_emergence_pop_size_multiplier".to_string(), 50.0); // Debug knob to keep prevalence steady when population size changes - 500_000 / pop size
