...
lazy_static! {
    ...
    // pseudomonas_aeruginosa - Clinically apparent when burden high
        ...
        map.insert("helicobacter_pylori_non_sepsis_infection_death_log_odds".to_string(), 1.0);     // Gastric cancer deaths; sepsis at -250 (CFR 0.37×)
    ...
    map.insert("empiric_therapy_broad_spectrum_bonus".to_string(), 0.85); // Make broad-spectrum empiric choices noticeably less favored than narrow options
        ...
        let bacteria_sepsis_baseline_overrides: &[(&str, f64)] = &[
            ...
            ("salmonella_enterica_serovar_paratyphi_a", -9.2), // was -8.0; CFR 3.4× over-death
            ("invasive_non-typhoidal_salmonella_spp.", -9.0),  // was -8.0; CFR 1.9× over-death
            ("shigella_spp.", -12.0),
            ("neisseria_gonorrhoeae", -21.0),
            ("streptococcus_pyogenes", -7.0),       // was -8.0; CFR 0.20× under-death (invasive GAS)
            ...
            ("yersinia_enterocolitica", -10.0),     // was -8.0; CFR 6.7× over-death
