...
lazy_static! {
    ...
    map.insert("random_drug_cessation_probability_if_no_active_infection".to_string(), 0.15); // Higher probability if no active infection
        ...
        map.insert("acinetobacter_baumannii_hospital_resistance_concentration_factor".to_string(), 4500.0);
        map.insert("pseudomonas_aeruginosa_hospital_resistance_concentration_factor".to_string(), 4500.0);
        map.insert("stenotrophomonas_maltophilia_hospital_resistance_concentration_factor".to_string(), 4500.0);
        map.insert("burkholderia_cepacia_complex_hospital_resistance_concentration_factor".to_string(), 4500.0);
        //
        ...
        map.insert("klebsiella_pneumoniae_hospital_resistance_concentration_factor".to_string(), 3900.0);
        map.insert("enterobacter_spp._hospital_resistance_concentration_factor".to_string(), 3900.0);
        map.insert("enterobacter_cloacae_hospital_resistance_concentration_factor".to_string(), 3900.0);
        map.insert("citrobacter_spp._hospital_resistance_concentration_factor".to_string(), 3900.0);
        map.insert("serratia_spp._hospital_resistance_concentration_factor".to_string(), 3900.0);
        map.insert("morganella_spp._hospital_resistance_concentration_factor".to_string(), 3900.0);
        map.insert("proteus_spp._hospital_resistance_concentration_factor".to_string(), 3900.0);
        map.insert("p_stuartii_hospital_resistance_concentration_factor".to_string(), 3900.0);
        map.insert("invasive_non-typhoidal_salmonella_spp._hospital_resistance_concentration_factor".to_string(), 3900.0);
        map.insert("staphylococcus_epidermidis_hospital_resistance_concentration_factor".to_string(), 3900.0);
        //
        // Tier 3 — Hospital-enriched Gram-positives (1.2):
        //   MRSA/VRE lineages, hand-transmitted, moderate device association.
        map.insert("staphylococcus_aureus_hospital_resistance_concentration_factor".to_string(), 3600.0);
        map.insert("enterococcus_faecium_hospital_resistance_concentration_factor".to_string(), 3600.0);
        map.insert("enterococcus_faecalis_hospital_resistance_concentration_factor".to_string(), 3600.0);
        map.insert("clostridioides_difficile_hospital_resistance_concentration_factor".to_string(), 3600.0);
        //
