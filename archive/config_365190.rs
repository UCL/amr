...
*/
    ...
    map.insert("microbiome_resistance_transfer_probability_per_day".to_string(), 0.0025); // Probability per day for resistance transfer between infection and microbiome
        ...
        map.insert("resistance_mechanism_target_site_mutation_emergence_rate".to_string(), 0.001); // Point mutations - most common
        map.insert("resistance_mechanism_efflux_overexpression_emergence_rate".to_string(), 0.001); // Regulatory mutations relatively common
        map.insert("resistance_mechanism_reduced_permeability_emergence_rate".to_string(), 0.001); // Porin loss is common
        map.insert("resistance_mechanism_qnr_emergence_rate".to_string(), 0.001); // Mobile genetic element acquisition
        map.insert("resistance_mechanism_erm_methylation_emergence_rate".to_string(), 0.001); // Common in gram-positives
        map.insert("resistance_mechanism_esbl_emergence_rate".to_string(), 0.0003); // Requires specific gene mutations
        map.insert("resistance_mechanism_ampc_emergence_rate".to_string(), 0.001); // Chromosomal or plasmid-mediated
        map.insert("resistance_mechanism_meca_emergence_rate".to_string(), 0.0003); // Requires SCCmec element acquisition
        map.insert("resistance_mechanism_carbapenemase_emergence_rate".to_string(), 0.0003); // Rare, high-level resistance genes
        map.insert("resistance_mechanism_van_type_emergence_rate".to_string(), 0.0003); // Complex vanA/vanB resistance cluster
        map.insert("resistance_mechanism_16s_methyltransferase_emergence_rate".to_string(), 0.0003); // Rare, high-level aminoglycoside resistance
