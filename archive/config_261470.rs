...
pub struct GlobalScalars {
    ...
    // Sepsis death additional factors
    pub sepsis_death_bacteria_level_coefficient: f64,
    pub sepsis_death_duration_coefficient: f64,
    pub sepsis_death_not_under_care_multiplier: f64,
...
impl GlobalScalars {
    fn from_map(map: &HashMap<String, f64>) -> Self {
        ...
        GlobalScalars {
            ...
            sepsis_death_bacteria_level_coefficient: get_or_default(
                map,
                "sepsis_death_bacteria_level_coefficient",
                0.1,
            ),
            sepsis_death_duration_coefficient: get_or_default(
                map,
                "sepsis_death_duration_coefficient",
                0.02,
            ),
            sepsis_death_not_under_care_multiplier: get_or_default(
                map,
                "sepsis_death_not_under_care_multiplier",
                2.0,
            ),
...
lazy_static! {
    pub static ref PARAMETERS: HashMap<String, f64> = {
        ...
        map.insert("bacteria_enterococcus_faecium_fluoroquinolones_resistance_floor".to_string(), 0.32); // High resistance observed
        map.insert("bacteria_enterococcus_faecium_macrolides_resistance_floor".to_string(), 0.28); // Moderate resistance
        map.insert("bacteria_enterococcus_faecium_glycopeptides_resistance_floor".to_string(), 0.17); // VRE - ~35-45% globally
        map.insert("bacteria_enterococcus_faecium_oxazolidinones_resistance_floor".to_string(), 0.05); // Low linezolid resistance
        map.insert("bacteria_enterococcus_faecium_tetracyclines_resistance_floor".to_string(), 0.25); // Moderate tetracycline resistance
        map.insert("bacteria_enterococcus_faecium_folate_antagonists_resistance_floor".to_string(), 0.50); // High TMP-SMX resistance
    ...
    // pseudomonas_aeruginosa - Clinically apparent when burden high
        ...
        for &drug in DRUG_SHORT_NAMES.iter() {
            map.insert(format!("drug_{}_for_bacteria_klebsiella_pneumoniae_resistance_emergence_rate_per_day_baseline", drug), 0.05);
        }
        ...
        // bacteroides_fragilis - anaerobic abscess pathogen with frequent beta-lactamase selection and metronidazole/clindamycin failures
        ...
        // mycoplasma_genitalium - macrolide and fluoroquinolone resistance emerges rapidly via point mutations
        if BACTERIA_LIST.contains(&"mycoplasma_genitalium") {
            for &drug in DRUG_SHORT_NAMES.iter() {
                map.insert(
                    format!(
        ...
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_listeria_monocytogenes_resistance_emergence_rate_per_day_baseline", drug), 0.5);
        }
        ...
        map.insert(format!("drug_{}_for_bacteria_listeria_monocytogenes_resistance_emergence_rate_per_day_baseline", drug), 0.8);
        }
        let listeria_macrolides = vec!["azithromycin", "clarithromycin"]; // fallback oral macrolides
        for &drug in listeria_macrolides.iter() {
        map.insert(format!("drug_{}_for_bacteria_listeria_monocytogenes_resistance_emergence_rate_per_day_baseline", drug), 0.8);
        }
        map.insert("drug_ceftazidime_avibactam_for_bacteria_listeria_monocytogenes_resistance_emergence_rate_per_day_baseline".to_string(), 0.6);

        // morganella_spp. - intrinsically resistant to many beta-lactams; ampC/ESBL amplification common
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_morganella_spp._resistance_emergence_rate_per_day_baseline", drug), 0.01);
        }
        ...
        map.insert(format!("drug_{}_for_bacteria_morganella_spp._resistance_emergence_rate_per_day_baseline", drug), 0.001);
        }
        let morganella_fqs = vec!["ciprofloxacin", "levofloxacin", "moxifloxacin", "ofloxacin"];
        for &drug in morganella_fqs.iter() {
        map.insert(format!("drug_{}_for_bacteria_morganella_spp._resistance_emergence_rate_per_day_baseline", drug), 0.01);
        }
        map.insert("drug_colistin_for_bacteria_morganella_spp._resistance_emergence_rate_per_day_baseline".to_string(), 0.01);
        ...
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_serratia_spp._resistance_emergence_rate_per_day_baseline", drug), 0.1);
        }
        ...
        map.insert(format!("drug_{}_for_bacteria_serratia_spp._resistance_emergence_rate_per_day_baseline", drug), 0.3);
        }
        ...
        map.insert("drug_trim_sulf_for_bacteria_serratia_spp._resistance_emergence_rate_per_day_baseline".to_string(), 0.3);

        // streptococcus_pneumoniae - conjugate-vaccine era with residual macrolide/tetracycline resistance
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_streptococcus_pneumoniae_resistance_emergence_rate_per_day_baseline", drug), 0.0000000001);
        }
        ...
        map.insert(format!("drug_{}_for_bacteria_streptococcus_pneumoniae_resistance_emergence_rate_per_day_baseline", drug), 0.000000001);
        }
        ...
        map.insert("drug_clindamycin_for_bacteria_streptococcus_pneumoniae_resistance_emergence_rate_per_day_baseline".to_string(), 0.000000001);
        ...
        map.insert("drug_trim_sulf_for_bacteria_streptococcus_pneumoniae_resistance_emergence_rate_per_day_baseline".to_string(), 0.000000001);
        map.insert("drug_chlorampheni_for_bacteria_streptococcus_pneumoniae_resistance_emergence_rate_per_day_baseline".to_string(), 0.00000001);
        map.insert("drug_rifampicin_for_bacteria_streptococcus_pneumoniae_resistance_emergence_rate_per_day_baseline".to_string(), 0.0000000001);
        map.insert("drug_quinu_dalfo_for_bacteria_streptococcus_pneumoniae_resistance_emergence_rate_per_day_baseline".to_string(), 0.0000000001);
        ...
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_vibrio_cholerae_resistance_emergence_rate_per_day_baseline", drug), 0.0001);
        }
        ...
        map.insert("drug_chlorampheni_for_bacteria_vibrio_cholerae_resistance_emergence_rate_per_day_baseline".to_string(), 0.0001);
        map.insert("drug_colistin_for_bacteria_vibrio_cholerae_resistance_emergence_rate_per_day_baseline".to_string(), 0.0001);
        map.insert("drug_trim_sulf_for_bacteria_vibrio_cholerae_resistance_emergence_rate_per_day_baseline".to_string(), 0.0001);

        // yersinia_enterocolitica – raise emergence to hit 5-30% surveillance targets for oral agents
        for &drug in DRUG_SHORT_NAMES.iter() {
        map.insert(format!("drug_{}_for_bacteria_yersinia_enterocolitica_resistance_emergence_rate_per_day_baseline", drug), 0.05);
        }
        ...
        map.insert(format!("drug_{}_for_bacteria_yersinia_enterocolitica_resistance_emergence_rate_per_day_baseline", drug), 0.2);
        }
        let yersinia_carbapenems = vec!["imipenem_c", "meropenem", "ertapenem", "meropenem_vaborbactam"];
        for &drug in yersinia_carbapenems.iter() {
        map.insert(format!("drug_{}_for_bacteria_yersinia_enterocolitica_resistance_emergence_rate_per_day_baseline", drug), 0.1);
        }
        ...
        map.insert("drug_trim_sulf_for_bacteria_yersinia_enterocolitica_resistance_emergence_rate_per_day_baseline".to_string(), 0.1);
        map.insert("drug_chlorampheni_for_bacteria_yersinia_enterocolitica_resistance_emergence_rate_per_day_baseline".to_string(), 0.1);
        map.insert("drug_rifampicin_for_bacteria_yersinia_enterocolitica_resistance_emergence_rate_per_day_baseline".to_string(), 0.1);
...
*/
        ...
        for &drug in DRUG_SHORT_NAMES.iter() {
            map.insert(format!("drug_{}_for_bacteria_neisseria_gonorrhoeae_resistance_emergence_rate_per_day_baseline", drug), 0.0002);
        }
    ...
    map.insert("random_drug_cessation_probability_if_no_active_infection".to_string(), 0.15); // Higher probability if no active infection
        ...
        map.insert("acinetobacter_baumannii_acquisition_log_odds_baseline".to_string(), -16.5);
        map.insert("campylobacter_jejuni_acquisition_log_odds_baseline".to_string(), -12.7);
        ...
        map.insert("clostridioides_difficile_acquisition_log_odds_baseline".to_string(), -15.4);
        ...
        map.insert("escherichia_coli_acquisition_log_odds_baseline".to_string(), -11.9);
        map.insert("helicobacter_pylori_acquisition_log_odds_baseline".to_string(), -13.9);
        ...
        map.insert("neisseria_gonorrhoeae_acquisition_log_odds_baseline".to_string(), -13.0);
        ...
        map.insert("shigella_spp._acquisition_log_odds_baseline".to_string(), -11.5);
        ...
        map.insert("staphylococcus_aureus_acquisition_log_odds_baseline".to_string(), -13.5);
        map.insert("streptococcus_agalactiae_acquisition_log_odds_baseline".to_string(), -16.0);
        map.insert("streptococcus_pneumoniae_acquisition_log_odds_baseline".to_string(), -12.9);
...
*/
    ...
    map.insert("empiric_therapy_broad_spectrum_bonus".to_string(), 0.85); // Make broad-spectrum empiric choices noticeably less favored than narrow options
        ...
        map.insert("log_odds_sepsis_infection_duration".to_string(), 0.05); // Log odds increase per day of infection duration (increased from 0.001)
        ...
        // Sepsis death additional factors
        map.insert("sepsis_death_bacteria_level_coefficient".to_string(), 0.1); // 10% increase in death risk per unit bacteria level
        map.insert("sepsis_death_duration_coefficient".to_string(), 0.02); // 2% increase in death risk per day of sepsis
        map.insert("sepsis_death_not_under_care_multiplier".to_string(), 2.0); // 2x death risk if not receiving treatment
