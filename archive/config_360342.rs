...
*/
    ...
    map.insert("log_odds_microbiome_vs_infection".to_string(), 2.0); // Fallback: modest carriage boost if no bacteria-specific param
        ...
        map.insert("bacteria_enterobacter_spp._mechanism_target_site_mutation_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_enterobacter_spp._mechanism_efflux_overexpression_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_enterobacter_spp._mechanism_reduced_permeability_emergence_multiplier".to_string(), 1.5);
        map.insert("bacteria_enterobacter_spp._mechanism_qnr_emergence_multiplier".to_string(), 0.6);
        map.insert("bacteria_enterobacter_spp._mechanism_erm_methylation_emergence_multiplier".to_string(), 0.0);
        map.insert("bacteria_enterobacter_spp._mechanism_esbl_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_enterobacter_spp._mechanism_ampc_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_enterobacter_spp._mechanism_meca_emergence_multiplier".to_string(), 0.0);
        map.insert("bacteria_enterobacter_spp._mechanism_carbapenemase_emergence_multiplier".to_string(), 0.3);
        ...
        map.insert("bacteria_mdr_mycobacterium_tuberculosis_mechanism_target_site_mutation_emergence_multiplier".to_string(), 5.0); // High propensity for further mutations (XDR) if treatment inadequate
        map.insert("bacteria_mdr_mycobacterium_tuberculosis_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 1.0);
       ...
       // L1/L2 are intrinsic, but we model them as high emergence for "acquisition" logic if not present
        ...
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.05); // HIGH: GyrA, ParC, PenA mutations are primary drivers
        ...
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.01 ); // PorB mutations
        ...
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_target_site_mutation_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_qnr_emergence_multiplier".to_string(), 5.0); // Frequent co-carriage
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 1.0); // AcrAB-TolC
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_reduced_permeability_emergence_multiplier".to_string(), 1.0); // OmpK35/36 loss
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_esbl_emergence_multiplier".to_string(), 5.0); // HIGH: CTX-M is endemic
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_ampc_emergence_multiplier".to_string(), 3.0); // Plasmid AmpC (DHA, CMY)
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_carbapenemase_emergence_multiplier".to_string(), 5.0); // HIGH: KPC, NDM, OXA-48
        ...
        map.insert("bacteria_mycoplasma_genitalium_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.3 ); // HIGH: Quinolone resistance
        map.insert("bacteria_mycoplasma_genitalium_mechanism_qnr_emergence_multiplier".to_string(), 0.0);
        map.insert("bacteria_mycoplasma_genitalium_mechanism_erm_methylation_emergence_multiplier".to_string(), 0.3 ); // HIGH: Macrolide resistance (mutation based, but mapped to Erm/Methylation effect)
        map.insert("bacteria_mycoplasma_genitalium_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.01 );
        map.insert("bacteria_mycoplasma_genitalium_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.01 );
        ...
        map.insert("bacteria_morganella_spp._mechanism_target_site_mutation_emergence_multiplier".to_string(),  0.5);
        map.insert("bacteria_morganella_spp._mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.5);
        map.insert("bacteria_morganella_spp._mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.5);
        map.insert("bacteria_morganella_spp._mechanism_esbl_emergence_multiplier".to_string(), 0.5);
        map.insert("bacteria_morganella_spp._mechanism_ampc_emergence_multiplier".to_string(), 0.5);
        map.insert("bacteria_morganella_spp._mechanism_carbapenemase_emergence_multiplier".to_string(), 0.5);
        ...
        map.insert("bacteria_serratia_spp._mechanism_target_site_mutation_emergence_multiplier".to_string(), 50.0);
        map.insert("bacteria_serratia_spp._mechanism_efflux_overexpression_emergence_multiplier".to_string(), 50.0);
        map.insert("bacteria_serratia_spp._mechanism_reduced_permeability_emergence_multiplier".to_string(), 50.0);
        map.insert("bacteria_serratia_spp._mechanism_qnr_emergence_multiplier".to_string(), 50.0);
        map.insert("bacteria_serratia_spp._mechanism_esbl_emergence_multiplier".to_string(), 50.0);
        map.insert("bacteria_serratia_spp._mechanism_ampc_emergence_multiplier".to_string(), 50.0);
        map.insert("bacteria_serratia_spp._mechanism_carbapenemase_emergence_multiplier".to_string(), 50.0);
        map.insert("bacteria_serratia_spp._mechanism_16s_methyltransferase_emergence_multiplier".to_string(), 50.0);
        ...
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.1 );
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.1 );
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.1 );
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_qnr_emergence_multiplier".to_string(), 0.1 );
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_esbl_emergence_multiplier".to_string(), 0.1 );
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_ampc_emergence_multiplier".to_string(), 0.1 );
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_carbapenemase_emergence_multiplier".to_string(), 0.1 );
        ...
        map.insert("bacteria_salmonella_enterica_serovar_paratyphi_a_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.3);
        map.insert("bacteria_salmonella_enterica_serovar_paratyphi_a_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.3);
        map.insert("bacteria_salmonella_enterica_serovar_paratyphi_a_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.3);
        map.insert("bacteria_salmonella_enterica_serovar_paratyphi_a_mechanism_qnr_emergence_multiplier".to_string(), 0.3);
        map.insert("bacteria_salmonella_enterica_serovar_paratyphi_a_mechanism_esbl_emergence_multiplier".to_string(), 0.3);
        map.insert("bacteria_salmonella_enterica_serovar_paratyphi_a_mechanism_ampc_emergence_multiplier".to_string(), 0.3);
        map.insert("bacteria_salmonella_enterica_serovar_paratyphi_a_mechanism_carbapenemase_emergence_multiplier".to_string(), 0.3);
        map.insert("bacteria_salmonella_enterica_serovar_paratyphi_a_mechanism_16s_methyltransferase_emergence_multiplier".to_string(), 0.3);
        ...
        map.insert("bacteria_shigella_spp._mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_shigella_spp._mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_shigella_spp._mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_shigella_spp._mechanism_qnr_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_shigella_spp._mechanism_esbl_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_shigella_spp._mechanism_ampc_emergence_multiplier".to_string(), 0.05);
        map.insert("bacteria_shigella_spp._mechanism_carbapenemase_emergence_multiplier".to_string(), 0.05);
        ...
        map.insert("bacteria_staphylococcus_aureus_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.3 );
        map.insert("bacteria_staphylococcus_aureus_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.3 );
        map.insert("bacteria_staphylococcus_aureus_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.03 );
        map.insert("bacteria_staphylococcus_aureus_mechanism_qnr_emergence_multiplier".to_string(), 0.03 );
        map.insert("bacteria_staphylococcus_aureus_mechanism_erm_methylation_emergence_multiplier".to_string(), 0.3 );
        ...
        map.insert("bacteria_staphylococcus_aureus_mechanism_meca_emergence_multiplier".to_string(), 0.02);
        ...
        map.insert("bacteria_enterococcus_faecium_mechanism_van_type_emergence_multiplier".to_string(), 0.0000001);
        map.insert("bacteria_enterococcus_faecium_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.0000001);
        map.insert("bacteria_enterococcus_faecium_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.0000001);
        map.insert("bacteria_enterococcus_faecium_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.0000001);
        ...
        map.insert("bacteria_acinetobacter_baumannii_mechanism_esbl_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_ampc_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_reduced_permeability_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_target_site_mutation_emergence_multiplier".to_string(), 1.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_qnr_emergence_multiplier".to_string(), 1.0);
        ...
        map.insert("bacteria_bacteroides_fragilis_mechanism_esbl_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_carbapenemase_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_ampc_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_16s_methyltransferase_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_qnr_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_erm_methylation_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_van_type_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_meca_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_reduced_permeability_emergence_multiplier".to_string(), 3.0);
        map.insert("bacteria_bacteroides_fragilis_mechanism_target_site_mutation_emergence_multiplier".to_string(), 3.0);
        ...
        map.insert("bacteria_campylobacter_jejuni_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.001);
        map.insert("bacteria_campylobacter_jejuni_mechanism_esbl_emergence_multiplier".to_string(), 0.001);
        map.insert("bacteria_campylobacter_jejuni_mechanism_ampc_emergence_multiplier".to_string(), 0.001);
        map.insert("bacteria_campylobacter_jejuni_mechanism_qnr_emergence_multiplier".to_string(), 0.001);
        map.insert("bacteria_campylobacter_jejuni_mechanism_carbapenemase_emergence_multiplier".to_string(), 0.001);
        map.insert("bacteria_campylobacter_jejuni_mechanism_16s_methyltransferase_emergence_multiplier".to_string(), 0.001);
        map.insert("bacteria_campylobacter_jejuni_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.001);
        map.insert("bacteria_campylobacter_jejuni_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.001);
        ...
        // Helicobacter_pylori
        map.insert("bacteria_helicobacter_pylori_mechanism_target_site_mutation_emergence_multiplier".to_string(), 0.01 );
        map.insert("bacteria_helicobacter_pylori_mechanism_esbl_emergence_multiplier".to_string(), 0.01 );
        map.insert("bacteria_helicobacter_pylori_mechanism_ampc_emergence_multiplier".to_string(), 0.01 );
        map.insert("bacteria_helicobacter_pylori_mechanism_qnr_emergence_multiplier".to_string(), 0.01 );
        map.insert("bacteria_helicobacter_pylori_mechanism_carbapenemase_emergence_multiplier".to_string(), 0.01 );
        map.insert("bacteria_helicobacter_pylori_mechanism_16s_methyltransferase_emergence_multiplier".to_string(), 0.01 );
        map.insert("bacteria_helicobacter_pylori_mechanism_efflux_overexpression_emergence_multiplier".to_string(), 0.01 );
        map.insert("bacteria_helicobacter_pylori_mechanism_reduced_permeability_emergence_multiplier".to_string(), 0.01 );
...
/* 
        ...
        map.insert("resistance_mechanism_reduced_permeability_emergence_rate".to_string(), 0.00 ); // Porin loss is common
        map.insert("resistance_mechanism_qnr_emergence_rate".to_string(), 0.00 ); // Mobile genetic element acquisition
        map.insert("resistance_mechanism_erm_methylation_emergence_rate".to_string(), 0.00 ); // Common in gram-positives
        map.insert("resistance_mechanism_esbl_emergence_rate".to_string(), 0.00 ); // Requires specific gene mutations
        map.insert("resistance_mechanism_ampc_emergence_rate".to_string(), 0.00 ); // Chromosomal or plasmid-mediated
        map.insert("resistance_mechanism_meca_emergence_rate".to_string(), 0.00 ); // Requires SCCmec element acquisition
        map.insert("resistance_mechanism_carbapenemase_emergence_rate".to_string(), 0.00 ); // Rare, high-level resistance genes
        map.insert("resistance_mechanism_van_type_emergence_rate".to_string(), 0.00 ); // Complex vanA/vanB resistance cluster
...
*/
    ...
    map.insert("empiric_therapy_broad_spectrum_bonus".to_string(), 0.85); // Make broad-spectrum empiric choices noticeably less favored than narrow options
        ...
        let bacteria_sepsis_baseline_overrides: &[(&str, f64)] = &[
            ("acinetobacter_baumannii", -7.0),
            ("citrobacter_spp.", -7.0),
            ("enterobacter_spp.", -7.0),
            ("enterococcus_faecalis", -7.0),
            ("enterococcus_faecium", -7.0),
            ("escherichia_coli", -21.0),
            ("klebsiella_pneumoniae", -7.0),
            ("morganella_spp.", -7.0),
            ("proteus_spp.", -7.0),
            ("serratia_spp.", -7.0),
            ("pseudomonas_aeruginosa", -7.0),
            ("stenotrophomonas_maltophilia", -7.0),
            ("staphylococcus_aureus", -7.0),
            ("staphylococcus_epidermidis", -7.0),
            ("streptococcus_pneumoniae", -8.0),
            ("salmonella_enterica_serovar_typhi", -7.0),
            ("salmonella_enterica_serovar_paratyphi_a", -7.0),
            ("invasive_non-typhoidal_salmonella_spp.", -7.0),
            ("shigella_spp.", -11.0),
            ("neisseria_gonorrhoeae", -20.0),
            ("streptococcus_pyogenes", -7.0),
            ("streptococcus_agalactiae", -7.0),
            ("haemophilus_influenzae", -8.0),
            ("chlamydia_trachomatis", -18.0),
            ("vibrio_cholerae", -7.5),
            ("neisseria_meningitidis", -8.0),
            ("listeria_monocytogenes", -7.0),
            ("clostridioides_difficile", -9.5),
            ("campylobacter_jejuni", -19.0),
            ("enterobacter_cloacae", -7.0),
            ("yersinia_enterocolitica", -7.0),
            ("moraxella_catarrhalis", -9.5),
        ...
        map.insert("sepsis_death_base_log_odds".to_string(), -5.5); // REVISED: Lowered from -4.5 to balance population death rates (~0.4% daily base)
