...
*/
    ...
    map.insert("log_odds_microbiome_vs_infection".to_string(), 2.0); // Fallback: modest carriage boost if no bacteria-specific param
        ...
        map.insert("microbiome_resistance_emergence_rate_per_day_baseline".to_string(), 0.00003); // Calibrated for microbiome resistance emergence
    ...
    map.insert("microbiome_resistance_transfer_probability_per_day".to_string(), 0.0025); // Probability per day for resistance transfer between infection and microbiome
        ...
        map.insert("resistance_mechanism_target_site_mutation_emergence_rate".to_string(), 0.0002); // Point mutations - most common
        map.insert("resistance_mechanism_efflux_overexpression_emergence_rate".to_string(), 0.0002); // Regulatory mutations relatively common
        map.insert("resistance_mechanism_reduced_permeability_emergence_rate".to_string(), 0.0002); // Porin loss is common
        map.insert("resistance_mechanism_qnr_emergence_rate".to_string(), 0.0002); // Mobile genetic element acquisition
        map.insert("resistance_mechanism_erm_methylation_emergence_rate".to_string(), 0.0002); // Common in gram-positives
        map.insert("resistance_mechanism_esbl_emergence_rate".to_string(), 0.00005); // Requires specific gene mutations
        map.insert("resistance_mechanism_ampc_emergence_rate".to_string(), 0.0002); // Chromosomal or plasmid-mediated
        map.insert("resistance_mechanism_meca_emergence_rate".to_string(), 0.00005); // Requires SCCmec element acquisition
        map.insert("resistance_mechanism_carbapenemase_emergence_rate".to_string(), 0.00005); // Rare, high-level resistance genes
        map.insert("resistance_mechanism_van_type_emergence_rate".to_string(), 0.00005); // Complex vanA/vanB resistance cluster
        map.insert("resistance_mechanism_16s_methyltransferase_emergence_rate".to_string(), 0.0002); // Rare, high-level aminoglycoside resistance
