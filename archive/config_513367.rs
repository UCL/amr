...
lazy_static! {
    pub static ref PARAMETERS: HashMap<String, f64> = {
        ...
        map.insert("bacteria_helicobacter_pylori_macrolides_resistance_floor".to_string(), 0.50);       // clarithromycin: ~50% globally
        map.insert("bacteria_helicobacter_pylori_nitroimidazoles_resistance_floor".to_string(), 0.50);   // metronidazole: ~50% globally
        map.insert("bacteria_helicobacter_pylori_penicillins_resistance_floor".to_string(), 0.35);       // amoxicillin: ~35% globally
    ...
    map.insert("random_drug_cessation_probability_if_no_active_infection".to_string(), 0.15); // Higher probability if no active infection
        ...
        map.insert("acinetobacter_baumannii_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.03
        map.insert("pseudomonas_aeruginosa_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.03
        map.insert("stenotrophomonas_maltophilia_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.03
        map.insert("burkholderia_cepacia_complex_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.03
        map.insert("legionella_pneumophila_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.03
        map.insert("vibrio_cholerae_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.03
        //
        ...
        map.insert("campylobacter_jejuni_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.07
        map.insert("salmonella_enterica_serovar_typhi_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.10
        map.insert("salmonella_enterica_serovar_paratyphi_a_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.10
        map.insert("invasive_non-typhoidal_salmonella_spp._community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.07
        map.insert("yersinia_enterocolitica_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.07
        map.insert("listeria_monocytogenes_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.07
        map.insert("shigella_spp._community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.15
        //
        ...
        map.insert("clostridioides_difficile_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.10
        map.insert("enterobacter_spp._community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.15
        map.insert("enterobacter_cloacae_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.15
        map.insert("citrobacter_spp._community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.15
        map.insert("serratia_spp._community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.15
        map.insert("morganella_spp._community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.15
        map.insert("proteus_spp._community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.15
        map.insert("p_stuartii_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.15
        map.insert("klebsiella_pneumoniae_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.20
        map.insert("enterococcus_faecium_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.20
        map.insert("enterococcus_faecalis_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.25
        map.insert("staphylococcus_epidermidis_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.15
        //
        ...
        map.insert("escherichia_coli_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.35
        map.insert("staphylococcus_aureus_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.35
        map.insert("bacteroides_fragilis_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.30
        map.insert("haemophilus_influenzae_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.30
        map.insert("moraxella_catarrhalis_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.30
        map.insert("streptococcus_pneumoniae_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.40
        map.insert("streptococcus_pyogenes_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.40
        map.insert("streptococcus_agalactiae_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.40
        map.insert("helicobacter_pylori_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.40
        //
        ...
        map.insert("neisseria_gonorrhoeae_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.80
        map.insert("neisseria_meningitidis_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.60
        map.insert("chlamydia_trachomatis_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.80
        map.insert("mycoplasma_genitalium_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.80
        map.insert("mycoplasma_pneumoniae_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.60
        map.insert("treponema_pallidum_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.80
        map.insert("bordetella_pertussis_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.60
        map.insert("mdr_mycobacterium_tuberculosis_community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.80
        ...
        // Log-odds values increased to close gap between simulated and target HA%.
        // Delta = ln((target/(1-target)) / (sim/(1-sim))), added to previous value.
        map.insert("acinetobacter_baumannii_log_odds_hospital_acquired".to_string(), 5.9); // target ~65% HA (was 4.0, sim 22.6%)
        map.insert("pseudomonas_aeruginosa_log_odds_hospital_acquired".to_string(), 4.9); // target ~45% HA (was 3.5, sim 17.0%)
        map.insert("enterococcus_faecium_log_odds_hospital_acquired".to_string(), 4.9); // target ~50% HA (was 3.3, sim 10.3%)
        map.insert("staphylococcus_aureus_log_odds_hospital_acquired".to_string(), 4.3); // target ~25% HA (was 2.8, sim 6.6%)
        map.insert("clostridioides_difficile_log_odds_hospital_acquired".to_string(), 5.9); // target ~50% HA (was 3.3, sim 7.1%)
        map.insert("klebsiella_pneumoniae_log_odds_hospital_acquired".to_string(), 5.1); // target ~40% HA (was 3.0, sim 7.5%)
        map.insert("enterobacter_spp._log_odds_hospital_acquired".to_string(), 5.1); // target ~45% HA (was 3.2, sim 9.4%)
        map.insert("enterobacter_cloacae_log_odds_hospital_acquired".to_string(), 5.1); // target ~45% HA (was 3.2, sim 7.7%)
        map.insert("serratia_spp._log_odds_hospital_acquired".to_string(), 5.5); // target ~50% HA (was 3.3, sim 14.8%)
        map.insert("citrobacter_spp._log_odds_hospital_acquired".to_string(), 5.2); // target ~45% HA (was 3.1, sim 10.2%)
        map.insert("p_stuartii_log_odds_hospital_acquired".to_string(), 5.7); // target ~65% HA (was 3.8, sim 21.8%)
        map.insert("bacteroides_fragilis_log_odds_hospital_acquired".to_string(), 4.6); // target ~30% HA (was 2.3, sim 4.4%)
        map.insert("staphylococcus_epidermidis_log_odds_hospital_acquired".to_string(), 7.0); // target ~75% HA (was 4.2, sim 15.2%)
        map.insert("stenotrophomonas_maltophilia_log_odds_hospital_acquired".to_string(), 5.8); // target ~70% HA (was 4.2, sim 33.3%)
        map.insert("burkholderia_cepacia_complex_log_odds_hospital_acquired".to_string(), 5.8); // target ~65% HA (was 3.9, sim 8.0%)

        // Moderate HAI risk bacteria (increased to close sim-target gap)
        map.insert("escherichia_coli_log_odds_hospital_acquired".to_string(), 4.2); // target ~15% HA (was 1.1, sim 0.76%)
        map.insert("enterococcus_faecalis_log_odds_hospital_acquired".to_string(), 4.5); // target ~30% HA (was 2.1, sim 3.1%)
        map.insert("streptococcus_pneumoniae_log_odds_hospital_acquired".to_string(), 3.5); // target ~10% HA (was 0.5, sim 0.5%)
        map.insert("proteus_spp._log_odds_hospital_acquired".to_string(), 4.3); // target ~30% HA (was 1.4, sim 1.8%)
        map.insert("morganella_spp._log_odds_hospital_acquired".to_string(), 5.0); // target ~40% HA (was 3.0, sim 5.9%)
        ...
        map.insert("neisseria_meningitidis_log_odds_hospital_acquired".to_string(), 3.2); // target ~20% HA (was 0.3, sim 1.6%)
        map.insert("streptococcus_pyogenes_log_odds_hospital_acquired".to_string(), 3.5); // target ~10% HA (was 1.1, sim 0.9%)
        map.insert("streptococcus_agalactiae_log_odds_hospital_acquired".to_string(), 5.3); // target ~30% HA (was 1.2, sim 0.6%)
        map.insert("haemophilus_influenzae_log_odds_hospital_acquired".to_string(), 3.3); // target ~10% HA (was 0.9, sim 1.0%)
        map.insert("moraxella_catarrhalis_log_odds_hospital_acquired".to_string(), 3.7); // target ~10% HA (was 0.3, sim 0.4%)
        map.insert("yersinia_enterocolitica_log_odds_hospital_acquired".to_string(), 2.5); // target ~3% HA (was 0.5, sim 0.0%)
    ...
    map.insert("log_odds_microbiome_vs_infection".to_string(), 2.0); // Fallback: modest carriage boost if no bacteria-specific param
        ...
        map.insert("bacteria_escherichia_coli_mechanism_enzyme_kpc_emergence_rate".to_string(), 0.000_000_05  ); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_escherichia_coli_mechanism_enzyme_ndm_vim_emergence_rate".to_string(), 0.000_000_05   ); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_escherichia_coli_mechanism_enzyme_oxa_48_emergence_rate".to_string(), 0.000_000_05   ); // classes: pen, bli, ceph, carb
        ...
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_enzyme_ndm_vim_emergence_rate".to_string(), 0.000_000_3      ); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_enzyme_oxa_48_emergence_rate".to_string(), 0.000_000_3      ); // classes: pen, bli, ceph, carb
        ...
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_protection_qnr_emergence_rate".to_string(), 0.001_5   ); // classes: fq
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_efflux_acrab_tolc_emergence_rate".to_string(), 0.001_5 ); // classes: fq, tet, chl
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_efflux_mexxy_oprm_emergence_rate".to_string(), 0.0); // tier 0
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_global_efflux_pump_emergence_rate".to_string(), 0.001_5       ); // classes: fq, mls, tet, chl
        ...
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_protection_tet_m_emergence_rate".to_string(), 0.001    ); // classes: tet
  ...
  // Enterobacter spp. — Gram-negative, Enterobacterales
        ...
        map.insert("bacteria_enterobacter_spp._mechanism_enzyme_16s_rrmt_emergence_rate".to_string(), 0.2   ); // classes: ag
        ...
        map.insert("bacteria_enterobacter_spp._mechanism_efflux_acrab_tolc_emergence_rate".to_string(), 0.01    ); // classes: fq, tet, chl
        map.insert("bacteria_enterobacter_spp._mechanism_efflux_mexxy_oprm_emergence_rate".to_string(), 0.0    ); // tier 0
        map.insert("bacteria_enterobacter_spp._mechanism_global_efflux_pump_emergence_rate".to_string(), 0.01        ); // classes: fq, mls, tet, chl
        ...
        map.insert("bacteria_enterobacter_spp._mechanism_enzyme_aac_aph_emergence_rate".to_string(), 0.2 ); // classes: ag
        ...
        map.insert("bacteria_enterobacter_cloacae_mechanism_enzyme_kpc_emergence_rate".to_string(), 0.000_005    ); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_enterobacter_cloacae_mechanism_enzyme_ndm_vim_emergence_rate".to_string(), 0.000_005   ); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_enterobacter_cloacae_mechanism_enzyme_oxa_48_emergence_rate".to_string(), 0.000_005   ); // classes: pen, bli, ceph, carb
        ...
        map.insert("bacteria_enterobacter_cloacae_mechanism_mutation_gyra_primary_emergence_rate".to_string(), 0.003   ); // classes: fq
        map.insert("bacteria_enterobacter_cloacae_mechanism_mutation_gyra_parc_secondary_emergence_rate".to_string(), 0.003    ); // classes: fq
        map.insert("bacteria_enterobacter_cloacae_mechanism_protection_qnr_emergence_rate".to_string(), 0.003    ); // classes: fq
       ...
       // Morganella spp. — Gram-negative, Enterobacterales
        ...
        map.insert("bacteria_morganella_spp._mechanism_enzyme_16s_rrmt_emergence_rate".to_string(), 0.8   ); // classes: ag
        ...
        map.insert("bacteria_morganella_spp._mechanism_mutation_gyra_primary_emergence_rate".to_string(), 0.15 ); // classes: fq
        ...
        map.insert("bacteria_morganella_spp._mechanism_enzyme_aac_aph_emergence_rate".to_string(), 0.8    ); // classes: ag
        ...
        map.insert("bacteria_proteus_spp._mechanism_enzyme_kpc_emergence_rate".to_string(), 0.000_015     ); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_proteus_spp._mechanism_enzyme_ndm_vim_emergence_rate".to_string(), 0.000_015     ); // classes: pen, bli, ceph, carb, mono
        map.insert("bacteria_proteus_spp._mechanism_enzyme_oxa_48_emergence_rate".to_string(), 0.000_015     ); // classes: pen, bli, ceph, carb
        map.insert("bacteria_proteus_spp._mechanism_enzyme_cat_emergence_rate".to_string(), 0.000_35    ); // classes: chl
        map.insert("bacteria_proteus_spp._mechanism_enzyme_16s_rrmt_emergence_rate".to_string(), 0.8           ); // classes: ag
        ...
        map.insert("bacteria_proteus_spp._mechanism_enzyme_aac_aph_emergence_rate".to_string(), 0.08     ); // classes: ag
        ...
        // Band 8 (x250)
        map.insert("bacteria_serratia_spp._mechanism_enzyme_esbl_ctx_m_emergence_rate".to_string(), 0.000_5); // classes: pen, bli, ceph, mono
        map.insert("bacteria_serratia_spp._mechanism_enzyme_esbl_tem_emergence_rate".to_string(), 0.000_5); // classes: pen, bli, ceph, mono
        map.insert("bacteria_serratia_spp._mechanism_enzyme_esbl_shv_emergence_rate".to_string(), 0.000_5   ); // classes: pen, bli, ceph, mono
        map.insert("bacteria_serratia_spp._mechanism_enzyme_ampc_cmy_emergence_rate".to_string(), 0.000_5   ); // classes: pen, bli, ceph, mono
        map.insert("bacteria_serratia_spp._mechanism_enzyme_ampc_dha_emergence_rate".to_string(), 0.000_5   ); // classes: pen, bli, ceph, mono
        map.insert("bacteria_serratia_spp._mechanism_enzyme_kpc_emergence_rate".to_string(), 0.000_1    ); // classes: pen, bli, ceph, carb, mono
        ...
        map.insert("bacteria_serratia_spp._mechanism_enzyme_16s_rrmt_emergence_rate".to_string(), 0.5     ); // classes: ag
        ...
        map.insert("bacteria_serratia_spp._mechanism_mutation_gyra_primary_emergence_rate".to_string(), 0.025   ); // classes: fq
        ...
        map.insert("bacteria_serratia_spp._mechanism_enzyme_aac_aph_emergence_rate".to_string(), 0.5 ); // classes: ag
        ...
        map.insert("bacteria_shigella_spp._mechanism_target_site_erm_b_emergence_rate".to_string(), 3.0    ); // classes: mls
        map.insert("bacteria_shigella_spp._mechanism_target_site_cfr_emergence_rate".to_string(), 0.0); // tier 0
        map.insert("bacteria_shigella_spp._mechanism_mutation_gyra_primary_emergence_rate".to_string(), 0.8         ); // classes: fq
        map.insert("bacteria_shigella_spp._mechanism_mutation_gyra_parc_secondary_emergence_rate".to_string(), 0.8          ); // classes: fq
        map.insert("bacteria_shigella_spp._mechanism_protection_qnr_emergence_rate".to_string(), 0.8          ); // classes: fq
        ...
        map.insert("bacteria_shigella_spp._mechanism_global_efflux_pump_emergence_rate".to_string(), 3.0     ); // classes: fq, mls, tet, chl
        ...
        // Band 8 (x37.5)
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_enzyme_esbl_ctx_m_emergence_rate".to_string(), 0.000_15    ); // classes: pen, bli, ceph, mono
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_enzyme_esbl_tem_emergence_rate".to_string(), 0.000_15    ); // classes: pen, bli, ceph, mono
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_enzyme_esbl_shv_emergence_rate".to_string(), 0.000_15    ); // classes: pen, bli, ceph, mono
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_enzyme_ampc_cmy_emergence_rate".to_string(), 0.000_15   ); // classes: pen, bli, ceph, mono
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_enzyme_ampc_dha_emergence_rate".to_string(), 0.000_15   ); // classes: pen, bli, ceph, mono
        ...
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_efflux_mexxy_oprm_emergence_rate".to_string(), 0.000_15    ); // classes: ceph, carb, fq, ag
        ...
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_porin_loss_oprd_emergence_rate".to_string(), 0.000_15   ); // classes: carb
        ...
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_modification_mcr_1_emergence_rate".to_string(), 0.00_05   ); // classes: poly
       ...
       // A. baumannii — Gram-negative, NonFermenter
        ...
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_16s_rrmt_emergence_rate".to_string(), 2.0  ); // classes: ag
        ...
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_aac_aph_emergence_rate".to_string(), 2.0 ); // classes: ag; AMEs frequent in MDR AB
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_bla_z_emergence_rate".to_string(), 0.0); // tier 0
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_oxa_acinetobacter_emergence_rate".to_string(), 0.002); // classes: carb; OXA-23/40/58 primary carbapenem R in AB
        map.insert("bacteria_acinetobacter_baumannii_mechanism_mutation_23s_rrna_emergence_rate".to_string(), 0.0); // tier 0
        map.insert("bacteria_acinetobacter_baumannii_mechanism_efflux_tet_abc_emergence_rate".to_string(), 0.03   ); // classes: tet
        ...
        map.insert("bacteria_stenotrophomonas_maltophilia_mechanism_protection_qnr_emergence_rate".to_string(), 0.000_015  ); // classes: fq
        ...
        map.insert("bacteria_stenotrophomonas_maltophilia_mechanism_mutation_folate_pathway_emergence_rate".to_string(), 0.003); // classes: sulf; trim/sulf 34% vs target 15%
        ...
        map.insert("bacteria_campylobacter_jejuni_mechanism_mutation_gyra_primary_emergence_rate".to_string(), 0.03       ); // classes: fq
        map.insert("bacteria_campylobacter_jejuni_mechanism_mutation_gyra_parc_secondary_emergence_rate".to_string(), 0.03       ); // classes: fq
        ...
        map.insert("bacteria_campylobacter_jejuni_mechanism_global_efflux_pump_emergence_rate".to_string(), 0.03    ); // classes: fq, mls, tet, chl
        ...
        map.insert("bacteria_helicobacter_pylori_mechanism_target_site_erm_b_emergence_rate".to_string(), 0.001  ); // classes: mls
        map.insert("bacteria_helicobacter_pylori_mechanism_target_site_cfr_emergence_rate".to_string(), 0.000_3 ); // classes: oxa, mls, chl
        map.insert("bacteria_helicobacter_pylori_mechanism_mutation_gyra_primary_emergence_rate".to_string(), 0.000_2 ); // classes: fq
        map.insert("bacteria_helicobacter_pylori_mechanism_mutation_gyra_parc_secondary_emergence_rate".to_string(), 0.000_2  ); // classes: fq
        ...
        map.insert("bacteria_helicobacter_pylori_mechanism_global_efflux_pump_emergence_rate".to_string(), 0.000_2  ); // classes: fq, mls, tet, chl
        ...
        map.insert("bacteria_helicobacter_pylori_mechanism_mutation_nitroreductase_emergence_rate".to_string(), 0.03  ); // classes: other (metronidazole, nitrofurantoin, furazolidone)
        ...
        map.insert("bacteria_helicobacter_pylori_mechanism_protection_tet_m_emergence_rate".to_string(), 0.000_2 ); // classes: tet
        map.insert("bacteria_helicobacter_pylori_mechanism_enzyme_aac_aph_emergence_rate".to_string(), 0.0); // tier 0
        map.insert("bacteria_helicobacter_pylori_mechanism_enzyme_bla_z_emergence_rate".to_string(), 0.000_01  ); // classes: pen; PBP1A proxy via blaZ; targets amox/amp only
        map.insert("bacteria_helicobacter_pylori_mechanism_enzyme_oxa_acinetobacter_emergence_rate".to_string(), 0.0); // tier 0
        map.insert("bacteria_helicobacter_pylori_mechanism_mutation_23s_rrna_emergence_rate".to_string(), 0.000_2 ); // classes: mls; primary clarithromycin R mechanism
        map.insert("bacteria_helicobacter_pylori_mechanism_efflux_tet_abc_emergence_rate".to_string(), 0.0); // tier 0
        map.insert("bacteria_helicobacter_pylori_mechanism_mutation_pbp_mosaic_emergence_rate".to_string(), 0.000_01 ); // classes: pen, bli, ceph, mono; low PBP1A-type amoxicillin resistance proxy
        ...
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_target_site_erm_b_emergence_rate".to_string(), 0.01     ); // classes: mls
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_target_site_cfr_emergence_rate".to_string(), 0.01            ); // classes: oxa, mls, chl
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_mutation_gyra_primary_emergence_rate".to_string(), 100.0     ); // classes: fq
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_mutation_gyra_parc_secondary_emergence_rate".to_string(), 100.0      ); // classes: fq
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_protection_qnr_emergence_rate".to_string(), 100.0       ); // classes: fq
        ...
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_global_efflux_pump_emergence_rate".to_string(), 100.0            ); // classes: fq, mls, tet, chl
        ...
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_mutation_rpo_b_emergence_rate".to_string(), 100.0        ); // classes: other (rifampicin, fidaxomicin)
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_protection_fus_b_emergence_rate".to_string(), 0.0  ); // tier 0
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_protection_tet_m_emergence_rate".to_string(), 100.0          ); // classes: tet
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_enzyme_aac_aph_emergence_rate".to_string(), 100.0   ); // classes: ag
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_enzyme_bla_z_emergence_rate".to_string(), 0.02      ); // classes: pen; TEM-1 penicillinase; all penicillins
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_enzyme_oxa_acinetobacter_emergence_rate".to_string(), 0.0); // tier 0
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_mutation_23s_rrna_emergence_rate".to_string(), 0.03    ); // classes: mls; GC macrolide target-site resistance
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_efflux_tet_abc_emergence_rate".to_string(), 0.003           ); // classes: tet
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_mutation_pbp_mosaic_emergence_rate".to_string(), 0.02     ); // classes: pen, bli, ceph, mono; PBP mosaic: penA mosaic alleles, major contributor to pen/ceph R
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_efflux_mtr_cde_emergence_rate".to_string(), 0.02      ); // classes: pen, mls, tet, chl; mtrCDE efflux: common, broad GC resistance driver
        ...
        map.insert("bacteria_haemophilus_influenzae_mechanism_efflux_mtr_cde_emergence_rate".to_string(), 0.000_000_1   ); // classes: pen, mls, tet, chl
        ...
        map.insert("bacteria_staphylococcus_aureus_mechanism_enzyme_16s_rrmt_emergence_rate".to_string(), 0.2            ); // classes: ag
        map.insert("bacteria_staphylococcus_aureus_mechanism_target_site_pbp2a_meca_emergence_rate".to_string(), 0.000_000_2) ; // classes: pen, bli, ceph, carb; driving penicillins ~35-60%
        ...
        map.insert("bacteria_staphylococcus_aureus_mechanism_target_site_erm_b_emergence_rate".to_string(), 0.000_15      ); // classes: mls; macrolides ~40%
        ...
        map.insert("bacteria_staphylococcus_aureus_mechanism_mutation_gyra_primary_emergence_rate".to_string(), 0.02    ); // classes: fq; FQ target ~40%
        map.insert("bacteria_staphylococcus_aureus_mechanism_mutation_gyra_parc_secondary_emergence_rate".to_string(), 0.01     ); // classes: fq; FQ target ~40%
        ...
        map.insert("bacteria_staphylococcus_aureus_mechanism_mutation_folate_pathway_emergence_rate".to_string(), 0.003    ); // classes: sulf; trim/sulf target 35%
        ...
        map.insert("bacteria_staphylococcus_aureus_mechanism_protection_tet_m_emergence_rate".to_string(), 0.002    ); // classes: tet; tet target 20-30%
        map.insert("bacteria_staphylococcus_aureus_mechanism_enzyme_aac_aph_emergence_rate".to_string(), 0.2   ); // classes: ag; AG 40%
        map.insert("bacteria_staphylococcus_aureus_mechanism_enzyme_bla_z_emergence_rate".to_string(), 0.000_000_5 ); // classes: pen; blaZ
        ...
        map.insert("bacteria_streptococcus_pneumoniae_mechanism_target_site_pbp2a_meca_emergence_rate".to_string(), 0.000_000_03); // classes: pen, bli, ceph, carb
        ...
        map.insert("bacteria_streptococcus_pneumoniae_mechanism_enzyme_bla_z_emergence_rate".to_string(), 0.000_000_03 ); // classes: pen
        ...
        map.insert("bacteria_streptococcus_pneumoniae_mechanism_mutation_pbp_mosaic_emergence_rate".to_string(), 0.000_000_03    ); // classes: pen, bli, ceph, mono; PBP mosaic remains the primary pen-R lever, but was strongly overcalled
        ...
        map.insert("bacteria_enterococcus_faecalis_mechanism_target_site_pbp2a_meca_emergence_rate".to_string(), 0.000_005  ); // classes: pen, bli, ceph, carb; pen 29% vs target 10%
        ...
        map.insert("bacteria_enterococcus_faecalis_mechanism_global_efflux_pump_emergence_rate".to_string(), 0.001   ); // classes: fq, mls, tet, chl; cuts FQ+tet+chlor
        ...
        map.insert("bacteria_enterococcus_faecalis_mechanism_protection_tet_m_emergence_rate".to_string(), 0.004    ); // classes: tet; tet 70% vs target 15%
        ...
        map.insert("bacteria_enterococcus_faecium_mechanism_target_site_cfr_emergence_rate".to_string(),  0.005    ); // classes: oxa, mls, chl
        map.insert("bacteria_enterococcus_faecium_mechanism_mutation_gyra_primary_emergence_rate".to_string(),   0.015    ); // classes: fq
        map.insert("bacteria_enterococcus_faecium_mechanism_mutation_gyra_parc_secondary_emergence_rate".to_string(),   0.015   ) ; // classes: fq
        ...
        map.insert("bacteria_enterococcus_faecium_mechanism_global_efflux_pump_emergence_rate".to_string(), 0.015   ); // classes: fq, mls, tet, chl
        ...
        map.insert("bacteria_enterococcus_faecium_mechanism_mutation_mpr_f_emergence_rate".to_string(), 0.03   ); // classes: other (daptomycin)
        map.insert("bacteria_enterococcus_faecium_mechanism_mutation_rpo_b_emergence_rate".to_string(),   0.3  ); // classes: other (rifampicin, fidaxomicin)
        map.insert("bacteria_enterococcus_faecium_mechanism_protection_fus_b_emergence_rate".to_string(),  0.012  ); // classes: other (fusidic acid)
        map.insert("bacteria_enterococcus_faecium_mechanism_protection_tet_m_emergence_rate".to_string(),  0.01    ); // classes: tet
        map.insert("bacteria_enterococcus_faecium_mechanism_enzyme_aac_aph_emergence_rate".to_string(), 0.1     ); // classes: ag
        ...
        map.insert("bacteria_enterococcus_faecium_mechanism_mutation_23s_rrna_emergence_rate".to_string(), 0.002    ); // classes: mls; rare but not impossible
        ...
        map.insert("bacteria_enterococcus_faecium_mechanism_efflux_mtr_cde_emergence_rate".to_string(), 0.001_2  ); // classes: pen, mls, tet, chl; mtrCDE: not relevant (GramPositive group excluded)
        ...
        map.insert("bacteria_bacteroides_fragilis_mechanism_mutation_gyra_primary_emergence_rate".to_string(), 0.03     ); // classes: fq
        map.insert("bacteria_bacteroides_fragilis_mechanism_mutation_gyra_parc_secondary_emergence_rate".to_string(), 0.03      ); // classes: fq
        map.insert("bacteria_bacteroides_fragilis_mechanism_protection_qnr_emergence_rate".to_string(), 0.03     ); // classes: fq
        map.insert("bacteria_bacteroides_fragilis_mechanism_efflux_acrab_tolc_emergence_rate".to_string(), 0.003      ); // classes: fq, tet, chl
        map.insert("bacteria_bacteroides_fragilis_mechanism_efflux_mexxy_oprm_emergence_rate".to_string(), 0.0   ); // tier 0
        map.insert("bacteria_bacteroides_fragilis_mechanism_global_efflux_pump_emergence_rate".to_string(), 0.003     ); // classes: fq, mls, tet, chl
        ...
        map.insert("bacteria_bacteroides_fragilis_mechanism_mutation_folate_pathway_emergence_rate".to_string(), 0.03       ); // classes: sulf
        ...
        map.insert("bacteria_bacteroides_fragilis_mechanism_mutation_pbp_mosaic_emergence_rate".to_string(), 0.000_2   ); // classes: pen, bli, ceph, mono
        ...
        map.insert("bacteria_mycoplasma_genitalium_mechanism_target_site_erm_b_emergence_rate".to_string(), 0.05     ); // classes: mls; lower clindamycin/macrolides without collapsing them completely
        map.insert("bacteria_mycoplasma_genitalium_mechanism_target_site_cfr_emergence_rate".to_string(), 0.05     ); // classes: oxa, mls, chl
        map.insert("bacteria_mycoplasma_genitalium_mechanism_mutation_gyra_primary_emergence_rate".to_string(), 0.7      ); // classes: fq; raise cipro/ofloxacin directly without using broad efflux
        map.insert("bacteria_mycoplasma_genitalium_mechanism_mutation_gyra_parc_secondary_emergence_rate".to_string(), 0.7      ); // classes: fq; primary FQ lever for levo/moxi in this panel
        ...
        map.insert("bacteria_mycoplasma_genitalium_mechanism_mutation_23s_rrna_emergence_rate".to_string(), 0.05   ); // classes: mls; keep macrolides elevated, but closer to the target band
    ...
    map.insert("empiric_therapy_broad_spectrum_bonus".to_string(), 0.85); // Make broad-spectrum empiric choices noticeably less favored than narrow options
        ...
        map.insert("carrier_resistance_inheritance_probability".to_string(), 0.0);  // DEBUG: was 0.50 — set to 0 to verify zero community R at acquisition
        // ══▶▶ CALIBRATION AXIS 5: fraction from human reservoir — CHANGE HERE ◀◀══
        map.insert("community_resistance_dilution_factor".to_string(), 0.0); // DEBUG: was 0.30 — set to 0 to verify zero community R at acquisition
