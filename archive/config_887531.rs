...
*/
    ...
    map.insert("log_odds_microbiome_vs_infection".to_string(), 2.0); // Fallback: modest carriage boost if no bacteria-specific param
        ...
        map.insert("bacteria_enterobacter_cloacae_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_enterobacter_spp._mechanism_enzyme_esbl_ctx_m_emergence_multiplier".to_string(), 30.0);
        ...
        map.insert("bacteria_enterobacter_spp._mechanism_enzyme_kpc_emergence_multiplier".to_string(), 60.0);
        ...
        map.insert("bacteria_enterobacter_spp._mechanism_modification_mcr_1_emergence_multiplier".to_string(), 300.0);
        ...
        map.insert("bacteria_enterobacter_spp._mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_enterococcus_faecalis_mechanism_target_site_erm_b_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_enterococcus_faecalis_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_staphylococcus_epidermidis_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_streptococcus_pyogenes_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_vibrio_cholerae_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_clostridioides_difficile_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_yersinia_enterocolitica_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_treponema_pallidum_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_mdr_mycobacterium_tuberculosis_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_haemophilus_influenzae_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
       ...
       // L1/L2 are intrinsic, but we model them as high emergence for "acquisition" logic if not present
        ...
        map.insert("bacteria_stenotrophomonas_maltophilia_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_neisseria_gonorrhoeae_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_neisseria_meningitidis_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_klebsiella_pneumoniae_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_listeria_monocytogenes_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_moraxella_catarrhalis_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_mycoplasma_genitalium_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_mycoplasma_pneumoniae_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_legionella_pneumophila_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_burkholderia_cepacia_complex_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_morganella_spp._mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);

        // Serratia spp. chronically express chromosomal AmpC and acquire porin/efflux changes in hospitals
        map.insert("bacteria_serratia_spp._mechanism_mutation_gyra_primary_emergence_multiplier".to_string(), 800.0);
        map.insert("bacteria_serratia_spp._mechanism_efflux_acrab_tolc_emergence_multiplier".to_string(), 800.0);
        map.insert("bacteria_serratia_spp._mechanism_porin_loss_ompk35_36_emergence_multiplier".to_string(), 800.0);
        map.insert("bacteria_serratia_spp._mechanism_protection_qnr_emergence_multiplier".to_string(), 800.0);
        map.insert("bacteria_serratia_spp._mechanism_enzyme_esbl_ctx_m_emergence_multiplier".to_string(), 800.0);
        map.insert("bacteria_serratia_spp._mechanism_enzyme_ampc_cmy_emergence_multiplier".to_string(), 800.0);
        map.insert("bacteria_serratia_spp._mechanism_enzyme_kpc_emergence_multiplier".to_string(), 800.0);
        map.insert("bacteria_serratia_spp._mechanism_enzyme_16s_rrmt_emergence_multiplier".to_string(), 800.0);
        ...
        map.insert("bacteria_serratia_spp._mechanism_modification_mcr_1_emergence_multiplier".to_string(), 800.0);
        ...
        map.insert("bacteria_serratia_spp._mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);

        // Pseudomonas aeruginosa typically requires prolonged ICU pressure before high-level mechanisms appear
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_mutation_gyra_primary_emergence_multiplier".to_string(), 0.5  );
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_efflux_acrab_tolc_emergence_multiplier".to_string(), 0.5  );
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_porin_loss_ompk35_36_emergence_multiplier".to_string(), 0.5  );
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_protection_qnr_emergence_multiplier".to_string(), 0.5  );
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_enzyme_esbl_ctx_m_emergence_multiplier".to_string(), 0.5  );
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_enzyme_ampc_cmy_emergence_multiplier".to_string(), 0.5  );
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_enzyme_kpc_emergence_multiplier".to_string(), 0.5  );
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_enzyme_16s_rrmt_emergence_multiplier".to_string(), 0.5  );
        ...
        map.insert("bacteria_pseudomonas_aeruginosa_mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_proteus_spp._mechanism_enzyme_vim_emergence_multiplier".to_string(), 1.0e-10);
        ...
        map.insert("bacteria_p_stuartii_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_salmonella_enterica_serovar_typhi_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_salmonella_enterica_serovar_paratyphi_a_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_shigella_spp._mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_staphylococcus_aureus_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_streptococcus_pneumoniae_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_streptococcus_agalactiae_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_invasive_non-typhoidal_salmonella_spp._mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);

        // Enterococcus faecium readily acquires van genes and mutational resistance under drug pressure.
        map.insert("bacteria_enterococcus_faecium_mechanism_target_site_van_a_emergence_multiplier".to_string(), 0.0000000005);
        map.insert("bacteria_enterococcus_faecium_mechanism_mutation_gyra_primary_emergence_multiplier".to_string(), 0.0000000005);
        map.insert("bacteria_enterococcus_faecium_mechanism_efflux_acrab_tolc_emergence_multiplier".to_string(), 0.0000000005);
        map.insert("bacteria_enterococcus_faecium_mechanism_porin_loss_ompk35_36_emergence_multiplier".to_string(), 0.0000000005);
        ...
        map.insert("bacteria_enterococcus_faecium_mechanism_target_site_erm_b_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_enterococcus_faecium_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);

        // Acinetobacter baumannii
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_kpc_emergence_multiplier".to_string(), 0.6);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_esbl_ctx_m_emergence_multiplier".to_string(),  2.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_ampc_cmy_emergence_multiplier".to_string(),  5.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_efflux_acrab_tolc_emergence_multiplier".to_string(),  5.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_porin_loss_ompk35_36_emergence_multiplier".to_string(),  5.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_mutation_gyra_primary_emergence_multiplier".to_string(),  5.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_protection_qnr_emergence_multiplier".to_string(),  5.0);
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_16s_rrmt_emergence_multiplier".to_string(),  5.0);
        ...
        map.insert("bacteria_acinetobacter_baumannii_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_bacteroides_fragilis_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_bordetella_pertussis_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_campylobacter_jejuni_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_helicobacter_pylori_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_chlamydia_trachomatis_mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
        ...
        map.insert("bacteria_citrobacter_spp._mechanism_enzyme_vim_emergence_multiplier".to_string(), 0.0);
