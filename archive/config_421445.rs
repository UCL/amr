...
lazy_static! {
    ...
    map.insert("random_drug_cessation_probability_if_no_active_infection".to_string(), 0.15); // Higher probability if no active infection
        ...
        //
        // 1. Environmental / waterborne organisms (dilution 0.20–0.30):
        ...
        //    Raised again to keep rare hospital-linked resistance from dying out immediately
        //    when seeded back into community acquisition.
        map.insert("acinetobacter_baumannii_community_resistance_dilution_factor".to_string(), 0.30);
        map.insert("pseudomonas_aeruginosa_community_resistance_dilution_factor".to_string(), 0.30);
        map.insert("stenotrophomonas_maltophilia_community_resistance_dilution_factor".to_string(), 0.30);
        map.insert("burkholderia_cepacia_complex_community_resistance_dilution_factor".to_string(), 0.30);
        map.insert("legionella_pneumophila_community_resistance_dilution_factor".to_string(), 0.20);
        map.insert("vibrio_cholerae_community_resistance_dilution_factor".to_string(), 0.20);
        //
        // 2. Foodborne / animal-reservoir organisms (dilution 0.35–0.50):
        ...
        //    Raised again because these organisms still need stronger feedback from the
        //    human-resistant pool to avoid immediate dilution to zero.
        map.insert("campylobacter_jejuni_community_resistance_dilution_factor".to_string(), 0.40);
        map.insert("salmonella_enterica_serovar_typhi_community_resistance_dilution_factor".to_string(), 0.45);
        map.insert("salmonella_enterica_serovar_paratyphi_a_community_resistance_dilution_factor".to_string(), 0.45);
        map.insert("invasive_non-typhoidal_salmonella_spp._community_resistance_dilution_factor".to_string(), 0.40);
        map.insert("yersinia_enterocolitica_community_resistance_dilution_factor".to_string(), 0.35);
        map.insert("listeria_monocytogenes_community_resistance_dilution_factor".to_string(), 0.35);
        map.insert("shigella_spp._community_resistance_dilution_factor".to_string(), 0.50);
        //
        // 3. Healthcare-associated organisms that also colonise community (dilution 0.55–0.70):
        ...
        //    Raised again because these organisms were still too prone to extinction once the
        //    model stopped using continuous EWMA memory.
        map.insert("clostridioides_difficile_community_resistance_dilution_factor".to_string(), 0.55);
        map.insert("enterobacter_spp._community_resistance_dilution_factor".to_string(), 0.60);
        map.insert("enterobacter_cloacae_community_resistance_dilution_factor".to_string(), 0.60);
        map.insert("citrobacter_spp._community_resistance_dilution_factor".to_string(), 0.60);
        map.insert("serratia_spp._community_resistance_dilution_factor".to_string(), 0.60);
        map.insert("morganella_spp._community_resistance_dilution_factor".to_string(), 0.60);
        map.insert("proteus_spp._community_resistance_dilution_factor".to_string(), 0.60);
        map.insert("p_stuartii_community_resistance_dilution_factor".to_string(), 0.60);
        map.insert("klebsiella_pneumoniae_community_resistance_dilution_factor".to_string(), 0.70);
        map.insert("enterococcus_faecium_community_resistance_dilution_factor".to_string(), 0.65);
        map.insert("enterococcus_faecalis_community_resistance_dilution_factor".to_string(), 0.70);
        map.insert("staphylococcus_epidermidis_community_resistance_dilution_factor".to_string(), 0.60);
        //
        // 4. Endogenous flora / high-carriage human commensals (dilution 0.65–0.80):
        ...
        map.insert("escherichia_coli_community_resistance_dilution_factor".to_string(), 0.75);
        map.insert("staphylococcus_aureus_community_resistance_dilution_factor".to_string(), 0.75);
        map.insert("bacteroides_fragilis_community_resistance_dilution_factor".to_string(), 0.65);
        map.insert("haemophilus_influenzae_community_resistance_dilution_factor".to_string(), 0.65);
        map.insert("moraxella_catarrhalis_community_resistance_dilution_factor".to_string(), 0.65);
        map.insert("streptococcus_pneumoniae_community_resistance_dilution_factor".to_string(), 0.80);
        map.insert("streptococcus_pyogenes_community_resistance_dilution_factor".to_string(), 0.80);
        map.insert("streptococcus_agalactiae_community_resistance_dilution_factor".to_string(), 0.80);
        map.insert("helicobacter_pylori_community_resistance_dilution_factor".to_string(), 0.75);
        //
        // 5. Obligate human pathogens / STIs (dilution 0.85–1.0):
        //    Exclusively human-to-human transmission; community resistance pool IS human ecology.
        map.insert("neisseria_gonorrhoeae_community_resistance_dilution_factor".to_string(), 1.0);
        map.insert("neisseria_meningitidis_community_resistance_dilution_factor".to_string(), 0.85);
        map.insert("chlamydia_trachomatis_community_resistance_dilution_factor".to_string(), 1.0);
        map.insert("mycoplasma_genitalium_community_resistance_dilution_factor".to_string(), 1.0);
        map.insert("mycoplasma_pneumoniae_community_resistance_dilution_factor".to_string(), 0.85);
        map.insert("treponema_pallidum_community_resistance_dilution_factor".to_string(), 1.0);
        map.insert("bordetella_pertussis_community_resistance_dilution_factor".to_string(), 0.85);
    ...
    // Extreme debug stress test: push all organisms above 10,000 while preserving the
    // existing relative ranking of the explicitly overridden hospital-enriched taxa.
    map.insert("hospital_resistance_concentration_factor".to_string(), 10001.0);
    //
    // Tier 1 — Nosocomial opportunists.
    map.insert("acinetobacter_baumannii_hospital_resistance_concentration_factor".to_string(), 15000.0);
    map.insert("pseudomonas_aeruginosa_hospital_resistance_concentration_factor".to_string(), 15000.0);
    map.insert("stenotrophomonas_maltophilia_hospital_resistance_concentration_factor".to_string(), 15000.0);
    map.insert("burkholderia_cepacia_complex_hospital_resistance_concentration_factor".to_string(), 15000.0);
    //
    // Tier 2 — Hospital-enriched Gram-negatives.
    map.insert("klebsiella_pneumoniae_hospital_resistance_concentration_factor".to_string(), 13000.0);
    map.insert("enterobacter_spp._hospital_resistance_concentration_factor".to_string(), 13000.0);
    map.insert("enterobacter_cloacae_hospital_resistance_concentration_factor".to_string(), 13000.0);
    map.insert("citrobacter_spp._hospital_resistance_concentration_factor".to_string(), 13000.0);
    map.insert("serratia_spp._hospital_resistance_concentration_factor".to_string(), 13000.0);
    map.insert("morganella_spp._hospital_resistance_concentration_factor".to_string(), 13000.0);
    map.insert("proteus_spp._hospital_resistance_concentration_factor".to_string(), 13000.0);
    map.insert("p_stuartii_hospital_resistance_concentration_factor".to_string(), 13000.0);
    map.insert("invasive_non-typhoidal_salmonella_spp._hospital_resistance_concentration_factor".to_string(), 13000.0);
    map.insert("staphylococcus_epidermidis_hospital_resistance_concentration_factor".to_string(), 13000.0);
    //
    // Tier 3 — Hospital-enriched Gram-positives.
    map.insert("staphylococcus_aureus_hospital_resistance_concentration_factor".to_string(), 12000.0);
    map.insert("enterococcus_faecium_hospital_resistance_concentration_factor".to_string(), 12000.0);
    map.insert("enterococcus_faecalis_hospital_resistance_concentration_factor".to_string(), 12000.0);
    map.insert("clostridioides_difficile_hospital_resistance_concentration_factor".to_string(), 12000.0);
        //
