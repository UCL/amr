...
lazy_static! {
    pub static ref PARAMETERS: HashMap<String, f64> = {
        ...
        map.insert("reserve_drug_score_penalty".to_string(), 0.8); // Reserve agents get 80% score haircut to keep total usage under stewardship targets
